...
def validate_synchronization_aggregation_trainable(synchronization, aggregation, trainable, name): # -> tuple[Unknown, Unknown, Unknown]:
...
class _EagerVariableStore(tf.Module):
    ...
    def get_variable(self, name, shape=..., dtype=..., initializer=..., regularizer=..., reuse=..., trainable=..., collections=..., caching_device=..., partitioner=..., validate_shape=..., use_resource=..., custom_getter=..., constraint=..., synchronization=..., aggregation=...):
