...
class Dense(keras_layers.Dense, base.Layer):
    ...
    @end_compatibility
    """
    def __init__(self, units, activation=..., use_bias=..., kernel_initializer=..., bias_initializer=..., kernel_regularizer=..., bias_regularizer=..., activity_regularizer=..., kernel_constraint=..., bias_constraint=..., trainable=..., name=..., **kwargs) -> None:
        ...
...
@keras_export(v1=["keras.__internal__.legacy.layers.dense"])
@tf_export(v1=["layers.dense"])
def dense(inputs, units, activation=..., use_bias=..., kernel_initializer=..., bias_initializer=..., kernel_regularizer=..., bias_regularizer=..., activity_regularizer=..., kernel_constraint=..., bias_constraint=..., trainable=..., name=..., reuse=...):
...
class Dropout(keras_layers.Dropout, base.Layer):
    ...
    @end_compatibility
    """
    def __init__(self, rate=..., noise_shape=..., seed=..., name=..., **kwargs) -> None:
        ...
...
@keras_export(v1=["keras.__internal__.legacy.layers.dropout"])
@tf_export(v1=["layers.dropout"])
def dropout(inputs, rate=..., noise_shape=..., seed=..., training=..., name=...):
    """Applies Dropout to the input.
...
@keras_export(v1=["keras.__internal__.legacy.layers.flatten"])
@tf_export(v1=["layers.flatten"])
def flatten(inputs, name=..., data_format=...):
    """Flattens an input tensor while preserving the batch axis (axis 0).
