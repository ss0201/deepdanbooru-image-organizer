...
from keras.utils import generic_utils, version_utils
...
class ProgbarLogger(Callback):
    ...
    """
    def __init__(self, count_mode: str = ..., stateful_metrics=...) -> None:
        ...
...
class ModelCheckpoint(Callback):
    ...
    Args:
        ...
        **kwargs: Additional arguments for backwards compatibility. Possible key
          is `period`.
    """
    def __init__(self, filepath, monitor: str = ..., verbose: int = ..., save_best_only: bool = ..., save_weights_only: bool = ..., mode: str = ..., save_freq=..., options=..., initial_value_threshold=..., **kwargs) -> None:
        ...
...
class BackupAndRestore(Callback):
    ...
    Args:
        ...
        delete_checkpoint: Boolean, default to True. This `BackupAndRestore`
          ...
          for future usage.
    """
    def __init__(self, backup_dir, save_freq=..., delete_checkpoint=...) -> None:
        ...
...
class EarlyStopping(Callback):
    ...
    def get_monitor_value(self, logs): # -> Any | None:
        ...
...
def keras_model_summary(name, data, step=...): # -> Literal[False]:
