...
class _WorkerContext:
    ...
    def session_creator(self, scaffold=..., config=..., checkpoint_dir=..., checkpoint_filename_with_path=..., max_wait_secs=...):
