...
def load_data(path=..., num_words=..., skip_top=..., maxlen=..., seed=..., start_char=..., oov_char=..., index_from=..., **kwargs): # -> tuple[tuple[ndarray[Unknown, Unknown], Unknown], tuple[ndarray[Unknown, Unknown], Unknown]]:
