...
def load_data(path=..., num_words=..., skip_top=..., maxlen=..., test_split=..., seed=..., start_char=..., oov_char=..., index_from=..., **kwargs): # -> tuple[tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown]], tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown]]]:
