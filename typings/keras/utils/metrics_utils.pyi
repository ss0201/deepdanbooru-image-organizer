...
def weakmethod(method): # -> (*args: Unknown, **kwargs: Unknown) -> Unknown:
...
def parse_init_thresholds(thresholds, default_threshold=...): # -> list[Unknown] | list[float | Unknown]:
    ...
...
def ragged_assert_compatible_and_get_flat_values(values, mask=...): # -> tuple[Unknown | list[Unknown], Unknown | None]:
...
def sparse_top_k_categorical_matches(y_true, y_pred, k=...):
