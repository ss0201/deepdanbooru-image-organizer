...
def text_dataset_from_directory(directory, labels=..., label_mode=..., class_names=..., batch_size=..., max_length=..., shuffle=..., seed=..., validation_split=..., subset=..., follow_links=...): # -> list[Unknown]:
