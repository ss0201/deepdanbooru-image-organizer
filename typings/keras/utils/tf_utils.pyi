...
def convert_shapes(input_shape, to_tuples=...): # -> tuple[Unknown, ...]:
...
def validate_axis(axis, input_shape): # -> list[int] | list[Unknown]:
...
def convert_inner_node_data(nested, wrap=...): # -> ListWrapper | Unknown:
...
def shape_type_conversion(fn): # -> (instance: Unknown, input_shape: Unknown) -> (tuple[Unknown, ...] | Unknown):
...
def is_tensor_or_extension_type(x): # -> bool:
...
def get_tensor_spec(t, dynamic_batch=..., name=...): # -> Unknown | None:
