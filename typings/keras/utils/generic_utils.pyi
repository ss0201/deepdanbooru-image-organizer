...
@keras_export("keras.utils.custom_object_scope", "keras.utils.CustomObjectScope")
class CustomObjectScope:
    ...
    def __enter__(self): # -> Self@CustomObjectScope:
        ...
...
def get_custom_objects(): # -> dict[Unknown, Unknown]:
...
class SharedObjectLoadingScope:
    ...
    """
    def __enter__(self): # -> NoopLoadingScope | Self@SharedObjectLoadingScope:
        ...
...
class SharedObjectSavingScope:
    ...
    def __enter__(self): # -> Any | Self@SharedObjectSavingScope | None:
        ...
...
def serialize_keras_class_and_config(cls_name, cls_config, obj=..., shared_object_id=...): # -> Any | dict[str, Unknown]:
    """Returns the serialization of the class with the given config."""
    ...

@keras_export("keras.utils.register_keras_serializable")
def register_keras_serializable(package=..., name=...): # -> (arg: Unknown) -> Unknown:
...
def get_registered_object(name, custom_objects=..., module_objects=...): # -> Any | None:
...
def serialize_keras_object(instance): # -> Any | dict[str, Unknown] | None:
...
def class_and_config_for_serialized_keras_object(config, module_objects=..., custom_objects=..., printable_module_name=...): # -> tuple[Unknown, list[Unknown]] | tuple[Unknown, Unknown]:
...
def func_dump(func): # -> tuple[str, Unknown, tuple[Unknown, ...] | None]:
...
def make_batches(size, batch_size): # -> list[tuple[Unknown, Unknown]]:
...
def slice_arrays(arrays, start=..., stop=...): # -> list[None] | list[Unknown | None]:
