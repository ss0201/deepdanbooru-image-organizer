...
def normalize_tuple(value, n, name, allow_zero=...): # -> tuple[Unknown, ...]:
...
def normalize_data_format(value): # -> LiteralString:
    ...

def normalize_padding(value): # -> list[Unknown] | tuple[Unknown, ...]:
    ...

def conv_kernel_mask(input_shape, kernel_shape, strides, padding): # -> ndarray[Unknown, Unknown]:
...
def conv_kernel_idxs(input_shape, kernel_shape, strides, padding, filters_in, filters_out, data_format): # -> Generator[tuple[intp, intp], None, None]:
...
def conv_connected_inputs(input_shape, kernel_shape, output_position, strides, padding): # -> list[Unknown]:
...
def conv_output_shape(input_shape, kernel_shape, strides, padding): # -> tuple[Unknown | int | None, ...]:
