...
WEIGHTS_PATH_NO_TOP = ...
layers = ...
@keras_export("keras.applications.inception_v3.InceptionV3", "keras.applications.InceptionV3")
def InceptionV3(include_top=..., weights=..., input_tensor=..., input_shape=..., pooling=..., classes=..., classifier_activation=...):
...
def conv2d_bn(x, filters, num_row, num_col, padding=..., strides=..., name=...): # -> Any:
