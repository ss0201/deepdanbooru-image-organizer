...
"""Keras estimator API."""
_model_to_estimator_usage_gauge = ...
@keras_export(v1=["keras.estimator.model_to_estimator"])
def model_to_estimator(keras_model=..., keras_model_path=..., custom_objects=..., model_dir=..., config=..., checkpoint_format=..., metric_names_map=..., export_outputs=...): # -> EstimatorV2 | Estimator:
...
def model_to_estimator_v2(keras_model=..., keras_model_path=..., custom_objects=..., model_dir=..., config=..., checkpoint_format=..., metric_names_map=..., export_outputs=...): # -> EstimatorV2 | Estimator:
    """Constructs an `Estimator` instance from given keras model.
