...
from keras.engine import sequential, training
...
def clone_model(model, input_tensors=..., clone_function=...): # -> Sequential | Model:
...
def clone_and_build_model(model, input_tensors=..., target_tensors=..., custom_objects=..., compile_clone=..., in_place_reset=..., optimizer_iterations=..., optimizer_config=...): # -> Sequential | Model:
