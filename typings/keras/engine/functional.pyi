...
from keras.engine import base_layer, input_spec, training as training_lib
...
def reconstruct_from_config(config, custom_objects=..., created_layers=...): # -> tuple[Unknown, Unknown, Unknown | OrderedDict[Unknown, Unknown]]:
...
def get_network_config(network, serialize_layer_fn=..., config=...): # -> dict[Any, Any]:
