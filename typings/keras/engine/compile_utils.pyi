...
class LossesContainer(Container):
    ...
    """
    def __init__(self, losses, loss_weights=..., output_names=..., total_loss_mean=...) -> None:
        ...
    ...
    @classmethod
    def from_config(cls, config): # -> Self@LossesContainer:
        """Returns the `LossesContainer` instance given the `config`."""
        ...
    
    @property
    def metrics(self): # -> list[Unknown | Mean]:
...
def match_dtype_and_rank(y_t, y_p, sw): # -> tuple[Unknown, Unknown, Unknown]:
