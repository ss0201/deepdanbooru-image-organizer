...
def train_on_batch(model, inputs, targets, sample_weights=..., output_loss_metrics=...): # -> dict[str, Unknown]:
...
def test_on_batch(model, inputs, targets, sample_weights=..., output_loss_metrics=...): # -> dict[str, Unknown]:
