...
from keras.utils import generic_utils, traceback_utils, version_utils
...
class Model(base_layer.Layer, version_utils.ModelVersionSelector):
    ...
    def __reduce__(self): # -> tuple[(serialized_model: Unknown) -> (Unknown | Any | None), tuple[ndarray[Unknown, Unknown]]]:
        ...
    ...
    @traceback_utils.filter_traceback
    def compile(self, optimizer=..., loss=..., metrics=..., loss_weights=..., weighted_metrics=..., run_eagerly=..., steps_per_execution=..., jit_compile=..., **kwargs): # -> None:
    ...
    def compute_metrics(self, x, y, y_pred, sample_weight): # -> dict[Unknown, Unknown]:
    ...
    def make_train_function(self, force=...): # -> ((it: Unknown) -> Unknown) | ((iterator: Unknown) -> Unknown):
    ...
    @traceback_utils.filter_traceback
    def fit(self, x=..., y=..., batch_size=..., epochs=..., verbose=..., callbacks=..., validation_split=..., validation_data=..., shuffle=..., class_weight=..., sample_weight=..., initial_epoch=..., steps_per_epoch=..., validation_steps=..., validation_batch_size=..., validation_freq=..., max_queue_size=..., workers=..., use_multiprocessing=...):
    ...
    def make_test_function(self, force=...): # -> ((it: Unknown) -> Unknown) | ((iterator: Unknown) -> Unknown):
    ...
    @traceback_utils.filter_traceback
    def evaluate(self, x=..., y=..., batch_size=..., verbose=..., sample_weight=..., steps=..., callbacks=..., max_queue_size=..., workers=..., use_multiprocessing=..., return_dict=..., **kwargs): # -> list[Unknown]:
    ...
    def predict_step(self, data): # -> None:
    ...
    def make_predict_function(self, force=...): # -> (iterator: Unknown) -> Unknown:
    ...
    @traceback_utils.filter_traceback
    def predict(self, x, batch_size=..., verbose=..., steps=..., callbacks=..., max_queue_size=..., workers=..., use_multiprocessing=...):
    ...
    def train_on_batch(self, x, y=..., sample_weight=..., class_weight=..., reset_metrics=..., return_dict=...): # -> list[Unknown]:
    ...
    def test_on_batch(self, x, y=..., sample_weight=..., reset_metrics=..., return_dict=...): # -> list[Unknown]:
    ...
    def fit_generator(self, generator, steps_per_epoch=..., epochs=..., verbose=..., callbacks=..., validation_data=..., validation_steps=..., validation_freq=..., class_weight=..., max_queue_size=..., workers=..., use_multiprocessing=..., shuffle=..., initial_epoch=...):
    ...
    @doc_controls.do_not_generate_docs
    def evaluate_generator(self, generator, steps=..., callbacks=..., max_queue_size=..., workers=..., use_multiprocessing=..., verbose=...): # -> list[Unknown]:
    ...
    @doc_controls.do_not_generate_docs
    def predict_generator(self, generator, steps=..., callbacks=..., max_queue_size=..., workers=..., use_multiprocessing=..., verbose=...):
    ...
    @traceback_utils.filter_traceback
    def load_weights(self, filepath, by_name=..., skip_mismatch=..., options=...): # -> None:
    ...
    @property
    @doc_controls.do_not_generate_docs
    def state_updates(self): # -> Any | list[Unknown]:
    ...
    def summary(self, line_length=..., positions=..., print_fn=..., expand_nested=..., show_trainable=..., layer_range=...): # -> None:
    ...
    def get_layer(self, name=..., index=...): # -> Layer | Any:
    ...
    def get_weight_paths(self): # -> dict[Unknown, Unknown]:
    ...
    def save_spec(self, dynamic_batch=...): # -> None:
