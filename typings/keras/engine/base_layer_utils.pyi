...
_call_context = ...
def create_mean_metric(value, name=...): # -> tuple[Mean, Unknown]:
    ...

def make_variable(name, shape=..., dtype=..., initializer=..., trainable=..., caching_device=..., validate_shape=..., constraint=..., use_resource=..., collections=..., synchronization=..., aggregation=..., partitioner=..., layout=...):
...
def unnest_if_single_tensor(input_tensors): # -> dict[Unknown, Unknown]:
    ...
