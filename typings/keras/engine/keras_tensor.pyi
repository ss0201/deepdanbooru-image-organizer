...
class KerasTensor:
    ...
    **Automatically converting TF APIs to layers**:
    ...
    @classmethod
    def from_tensor(cls, tensor): # -> KerasTensor | Self@KerasTensor:
        """Convert a traced (composite)tensor to a representative
        KerasTensor."""
        ...
    
    @classmethod
    def from_type_spec(cls, type_spec, name=...): # -> Self@KerasTensor:
        ...
...
class UserRegisteredTypeKerasTensor(KerasTensor):
    ...
    @classmethod
    def from_tensor(cls, tensor): # -> Self@UserRegisteredTypeKerasTensor:
        ...
...
class _KerasTensorIterator:
    ...
    def __iter__(self): # -> Self@_KerasTensorIterator:
        ...
