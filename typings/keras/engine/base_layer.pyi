...
keras_models_gauge = ...
keras_api_gauge = ...
keras_premade_model_gauge = ...
_is_name_scope_on_model_declaration_enabled = ...
_name_scope_unnester_stack = ...
...
class Layer(tf.Module, version_utils.LayerVersionSelector):
    ...
    * `get_config(self)`: Returns a dictionary containing the configuration used
    ...
    @doc_controls.for_subclass_implementers
    def add_weight(self, name=..., shape=..., dtype=..., initializer=..., regularizer=..., trainable=..., constraint=..., use_resource=..., synchronization=..., aggregation=..., **kwargs):
...
class BaseRandomLayer(Layer):
    ...
    @tf.__internal__.tracking.no_automatic_dependency_tracking
    def __init__(self, seed=..., force_generator=..., rng_type=..., **kwargs) -> None:
