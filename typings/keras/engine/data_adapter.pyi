...
def broadcast_sample_weight_modes(target_structure, sample_weight_modes): # -> dict[Unknown, str] | list[str]:
...
class DataHandler:
    ...
    def steps(self): # -> Generator[int | Unknown, None, None]:
...
def train_validation_split(arrays, validation_split): # -> tuple[Unknown, Unknown]:
