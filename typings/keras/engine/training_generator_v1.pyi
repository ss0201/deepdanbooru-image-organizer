...
evaluate_generator = ...
predict_generator = ...
def convert_to_generator_like(data, batch_size=..., steps_per_epoch=..., epochs=..., shuffle=...): # -> tuple[Sequence | tuple[Unknown, ...] | Unknown, int | Unknown | None] | tuple[Unknown, Unknown | None] | tuple[Generator[Unknown, None, None], int]:
