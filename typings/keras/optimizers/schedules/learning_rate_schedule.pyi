...
class LearningRateSchedule:
    ...
    @classmethod
    def from_config(cls, config): # -> Self@LearningRateSchedule:
...
@keras_export("keras.optimizers.schedules.CosineDecay", "keras.experimental.CosineDecay")
...
@keras_export("keras.optimizers.schedules.CosineDecayRestarts", "keras.experimental.CosineDecayRestarts")
...
class NoisyLinearCosineDecay(LearningRateSchedule):
    ...
    Returns:
      ...
      type as `initial_learning_rate`.
    """
    def __init__(self, initial_learning_rate, decay_steps, initial_variance=..., variance_decay=..., num_periods=..., alpha=..., beta=..., seed=..., name=...) -> None:
...
def serialize(learning_rate_schedule): # -> Any | dict[str, Unknown] | None:
