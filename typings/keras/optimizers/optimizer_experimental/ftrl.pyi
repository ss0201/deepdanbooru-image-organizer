...
class Ftrl(optimizer.Optimizer):
    ...
    """
    def __init__(self, learning_rate=..., learning_rate_power=..., initial_accumulator_value=..., l1_regularization_strength=..., l2_regularization_strength=..., l2_shrinkage_regularization_strength=..., beta=..., clipnorm=..., clipvalue=..., global_clipnorm=..., use_ema=..., ema_momentum=..., ema_overwrite_frequency=..., jit_compile=..., name=..., **kwargs) -> None:
        ...
