...
def make_gradient_clipnorm_fn(clipnorm): # -> ((grads_and_vars: Unknown) -> Unknown) | ((grads_and_vars: Unknown) -> list[tuple[Unknown, Unknown]]):
    """Creates a gradient transformation function for clipping by norm."""
    ...

def make_global_gradient_clipnorm_fn(clipnorm): # -> ((grads_and_vars: Unknown) -> Unknown) | ((grads_and_vars: Unknown) -> list[tuple[Unknown, Unknown]]):
    """Creates a gradient transformation function for clipping by norm."""
    ...

def make_gradient_clipvalue_fn(clipvalue): # -> ((grads_and_vars: Unknown) -> Unknown) | ((grads_and_vars: Unknown) -> list[tuple[Unknown, Unknown]]):
