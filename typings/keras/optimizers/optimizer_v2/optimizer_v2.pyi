...
def name_scope_only_in_function_or_graph(name): # -> NullContextmanager:
...
class OptimizerV2(tf.__internal__.tracking.Trackable):
    ...
    def minimize(self, loss, var_list, grad_loss=..., name=..., tape=...):
    ...
    def get_updates(self, loss, params): # -> list[Unknown]:
        ...
    
    def __getattribute__(self, name): # -> LearningRateSchedule:
    ...
    def add_slot(self, var, slot_name, initializer=..., shape=...):
    ...
    def add_weight(self, name, shape, dtype=..., initializer=..., trainable=..., synchronization=..., aggregation=...):
        ...
