...
class Regularizer:
    ...
    @classmethod
    def from_config(cls, config): # -> Self@Regularizer:
...
class OrthogonalRegularizer(Regularizer):
    ...
    """
    def __init__(self, factor=..., mode=...) -> None:
        ...
...
def serialize(regularizer): # -> Any | dict[str, Unknown] | None:
    ...
...
def get(identifier): # -> L1L2 | Any | None:
