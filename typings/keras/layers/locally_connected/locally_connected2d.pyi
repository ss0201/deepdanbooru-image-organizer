...
class LocallyConnected2D(Layer):
    ...
    @tf_utils.shape_type_conversion
    def compute_output_shape(self, input_shape): # -> tuple[Unknown, Unknown, Unknown | int | None, Unknown | int | None] | tuple[Unknown, Unknown | int | None, Unknown | int | None, Unknown] | None:
        ...
