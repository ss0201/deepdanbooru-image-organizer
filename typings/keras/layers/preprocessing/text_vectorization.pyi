...
class TextVectorization(base_preprocessing_layer.PreprocessingLayer):
    ...
    """
    def __init__(self, max_tokens=..., standardize=..., split=..., ngrams=..., output_mode=..., output_sequence_length=..., pad_to_max_tokens=..., vocabulary=..., idf_weights=..., sparse=..., ragged=..., **kwargs) -> None:
        ...
