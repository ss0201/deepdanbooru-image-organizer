...
class RNNCell(base_layer.Layer):
    ...
    def get_initial_state(self, inputs=..., batch_size=..., dtype=...): # -> Any:
        ...
    
    def zero_state(self, batch_size, dtype): # -> Any:
...
class LayerRNNCell(RNNCell):
    ...
    """
    def __call__(self, inputs, state, scope=..., *args, **kwargs):
        """Run this RNN cell on inputs, starting from the given state.
...
class BasicRNNCell(LayerRNNCell):
    ...
    def call(self, inputs, state): # -> tuple[Unknown | Any, Unknown | Any]:
...
class BasicLSTMCell(LayerRNNCell):
    ...
    def call(self, inputs, state): # -> tuple[Unknown, LSTMStateTuple | Unknown]:
...
class MultiRNNCell(RNNCell):
    ...
    def zero_state(self, batch_size, dtype): # -> tuple[Unknown, ...] | Any:
        ...
    ...
    def call(self, inputs, state): # -> tuple[Unknown, tuple[Unknown, ...] | Unknown]:
