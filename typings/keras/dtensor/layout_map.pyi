...
_LAYOUT_MAP = ...
def get_current_layout_map(): # -> Any | None:
    ...
...
class LayoutMap(collections.abc.MutableMapping):
    ...
    def get_default_mesh(self): # -> None:
    ...
    def scope(self): # -> _GeneratorContextManager[None]:
...
@deprecated(None, "use tf.keras.dtensor.experimental.LayoutMap.scope() instead.")
