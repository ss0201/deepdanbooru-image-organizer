...
from keras.initializers import initializers_v1, initializers_v2
from keras.utils import generic_utils, tf_inspect as inspect
...
def serialize(initializer): # -> Any | dict[str, Unknown] | None:
    ...
