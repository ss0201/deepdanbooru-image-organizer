...
class _DynamicLossScaleState(tf.__internal__.tracking.Trackable):
    ...
    def update(self, grads): # -> tuple[Unknown, Unknown]:
...
class LossScaleOptimizerMetaclass(type):
    ...
    type of `opt`.
    """
    def __call__(cls, inner_optimizer, *args, **kwargs): # -> Any | LossScaleOptimizer | LossScaleOptimizerV3:
        ...
...
class LossScaleOptimizer(tf.__internal__.tracking.DelegatingTrackableMixin, optimizer_v2.OptimizerV2, BaseLossScaleOptimizer):
    ...
    def get_unscaled_gradients(self, grads): # -> list[Unknown | None]:
        ...
    
    def get_gradients(self, loss, params): # -> list[Unknown | None]:
        ...
    
    def apply_gradients(self, grads_and_vars, name=..., experimental_aggregate_gradients=...):
        ...
    ...
    def __getattribute__(self, name): # -> Any | LearningRateSchedule:
        ...
...
class LossScaleOptimizerV3(tf.__internal__.tracking.DelegatingTrackableMixin, optimizer_experimental.Optimizer, BaseLossScaleOptimizer):
    """An optimizer that applies loss scaling to prevent numeric underflow.
    ...
    def compute_gradients(self, loss, var_list, tape=...): # -> list[tuple[Unknown | None, Unknown]]:
        ...
    ...
    @classmethod
    def from_config(cls, config, custom_objects=...): # -> Self@LossScaleOptimizerV3:
        ...
