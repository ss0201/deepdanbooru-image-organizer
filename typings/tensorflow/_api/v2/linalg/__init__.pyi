...
from tensorflow.python.ops.gen_linalg_ops import cholesky, log_matrix_determinant as slogdet, lu, matrix_determinant as det, matrix_inverse as inv, matrix_logarithm as logm, matrix_solve as solve, matrix_square_root as sqrtm, qr
from tensorflow.python.ops.gen_math_ops import cross
from tensorflow.python.ops.linalg.linalg_impl import adjoint, banded_triangular_solve, eigh_tridiagonal, logdet, lu_matrix_inverse, lu_reconstruct, lu_solve, matrix_exponential as expm, matrix_rank, pinv, tridiagonal_matmul, tridiagonal_solve
