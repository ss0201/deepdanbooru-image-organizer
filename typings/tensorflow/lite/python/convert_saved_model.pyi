...
def get_inputs_outputs(signature_def): # -> tuple[list[Unknown], list[Unknown]]:
...
def freeze_saved_model(saved_model_dir, input_arrays, input_shapes, output_arrays, tag_set, signature_key): # -> tuple[Unknown | GraphDef | Any, list[Unknown | Tensor | Operation | None], list[Unknown | Tensor | Operation | None], Unknown]:
