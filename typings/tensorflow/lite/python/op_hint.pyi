...
class OpHint:
  ...
  class OpHintArgumentTracker:
    ...
    def add(self, arg, tag=..., name=..., aggregate=..., index_override=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def add_input(self, *args, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def add_output(self, *args, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def add_inputs(self, *args, **kwargs): # -> list[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
  ...
  def add_outputs(self, *args, **kwargs): # -> list[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
...
class _LiteFuncCall:
  ...
  def flattened_inputs_and_outputs(self): # -> tuple[list[Unknown], list[Unknown]]:
...
def find_all_hinted_output_nodes(session=..., graph_def=...): # -> list[Unknown]:
...
@_deprecation.deprecated(None, "Please follow instructions under " "https://www.tensorflow.org/lite/convert/operation_fusion for operation" "fusion in tflite.")
def convert_op_hints_to_stubs(session=..., graph_def=..., write_callback=...): # -> GraphDef:
