...
class _Compatible:
  ...
  def __get__(self, instance, cls): # -> Self@_Compatible:
  ...
  def get_compatibility_log(self): # -> list[Unknown]:
...
def compatible(target=..., converter_target_spec=..., **kwargs): # -> ((target: Unknown) -> _Compatible) | _Compatible:
