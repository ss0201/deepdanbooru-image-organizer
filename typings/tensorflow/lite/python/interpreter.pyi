...
if notos.path.splitext(__file__)[0].endswith(os.path.join('tflite_runtime', 'interpreter')):
  ...
else:
  ...
class Delegate:
...
class SignatureRunner:
  ...
  def __call__(self, **kwargs): # -> dict[Unknown, Unknown]:
  ...
  def get_input_details(self): # -> dict[Unknown, Unknown]:
  ...
  def get_output_details(self): # -> dict[Unknown, Unknown]:
...
class Interpreter:
  ...
  """
  def __init__(self, model_path=..., model_content=..., experimental_delegates=..., num_threads=..., experimental_op_resolver_type=..., experimental_preserve_all_tensors=...) -> None:
    """Constructor.
  ...
  def get_tensor_details(self): # -> list[Unknown]:
  ...
  def get_input_details(self): # -> list[dict[str, Unknown]]:
  ...
  def get_output_details(self): # -> list[dict[str, Unknown]]:
  ...
  def get_tensor(self, tensor_index, subgraph_index=...):
  ...
  def tensor(self, tensor_index): # -> () -> Unknown:
