...
class QuantizationMode:
  ...
  def __init__(self, optimizations, target_spec, representative_dataset, graph_def, disable_per_channel=..., experimental_new_dynamic_range_quantizer=..., experimental_low_bit_qat=..., full_integer_quantization_bias_type=...) -> None:
    ...
  
  def is_post_training_int8_only_quantization(self): # -> bool:
    ...
  
  def is_post_training_int8_quantization_with_float_fallback(self): # -> Literal[False]:
    ...
  ...
  def is_post_training_dynamic_range_quantization(self): # -> Literal[False]:
    ...
  ...
  def converter_flags(self, inference_ty=..., inference_input_ty=...): # -> dict[str, Unknown]:
...
class TFLiteConverterBaseV2(TFLiteConverterBase):
  ...
  def convert(self, graph_def, input_tensors, output_tensors): # -> bytes | Any:
...
class TFLiteConverterV2(TFLiteFrozenGraphConverterV2):
  ...
  @classmethod
  def from_concrete_functions(cls, funcs, trackable_obj=...): # -> Self@TFLiteConverterV2:
  ...
  @classmethod
  def from_saved_model(cls, saved_model_dir, signature_keys=..., tags=...): # -> TFLiteSavedModelConverter | TFLiteConverter | TFLiteSavedModelConverterV2 | Self@TFLiteConverterV2:
...
class TFLiteConverterBaseV1(TFLiteConverterBase):
  ...
  def get_input_arrays(self): # -> list[Unknown | str] | list[Unknown]:
...
class TFLiteConverter(TFLiteFrozenGraphConverter):
  ...
  @classmethod
  def from_session(cls, sess, input_tensors, output_tensors): # -> Self@TFLiteConverter:
  ...
  @classmethod
  def from_frozen_graph(cls, graph_def_file, input_arrays, output_arrays, input_shapes=...): # -> Self@TFLiteConverter:
  ...
  @classmethod
  def from_saved_model(cls, saved_model_dir, input_arrays=..., input_shapes=..., output_arrays=..., tag_set=..., signature_key=...): # -> TFLiteSavedModelConverter | Self@TFLiteConverter:
