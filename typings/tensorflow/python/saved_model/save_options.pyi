...
class SaveOptions:
  ...
  """
  __slots__ = ...
  def __init__(self, namespace_whitelist=..., save_debug_info=..., function_aliases=..., experimental_io_device=..., experimental_variable_policy=..., experimental_custom_gradients=...) -> None:
