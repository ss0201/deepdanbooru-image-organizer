...
class _AugmentedGraphView(graph_view.ObjectGraphView):
  ...
  def list_children(self, obj): # -> Generator[TrackableReference, None, None]:
  ...
  def list_dependencies(self, obj): # -> Generator[tuple[Unknown, Trackable], None, None]:
...
class _SaveableView:
  ...
  def map_resources(self): # -> tuple[ObjectIdentityDictionary, dict[Unknown, Unknown], _AssetInfo]:
  ...
  def get_concrete_resource_initializers(self): # -> list[Unknown]:
    ...
...
def save(obj, export_dir, signatures=..., options=...): # -> None:
...
def save_and_return_nodes(obj, export_dir, signatures=..., options=..., experimental_skip_checkpoint=...): # -> tuple[list[Unknown], Unknown]:
...
def export_meta_graph(obj, filename, signatures=..., options=...): # -> None:
