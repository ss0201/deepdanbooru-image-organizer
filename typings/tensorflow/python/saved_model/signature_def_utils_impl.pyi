...
def build_signature_def(inputs=..., outputs=..., method_name=...): # -> SignatureDef:
...
def regression_signature_def(examples, predictions): # -> SignatureDef:
...
def classification_signature_def(examples, classes, scores): # -> SignatureDef:
...
def predict_signature_def(inputs, outputs): # -> SignatureDef:
...
def supervised_train_signature_def(inputs, loss, predictions=..., metrics=...): # -> SignatureDef:
  ...

def supervised_eval_signature_def(inputs, loss, predictions=..., metrics=...): # -> SignatureDef:
  ...
...
def op_signature_def(op, key): # -> SignatureDef:
...
def load_op_from_signature_def(signature_def, key, import_scope=...): # -> Tensor | Operation | None:
