...
"""
_LOADER_LABEL = ...
def parse_saved_model_with_debug_info(export_dir): # -> tuple[SavedModel, GraphDebugInfo]:
...
def parse_saved_model(export_dir): # -> SavedModel:
...
def get_asset_tensors(export_dir, meta_graph_def_to_load, import_scope=...): # -> dict[Unknown, Unknown]:
...
def get_init_op(meta_graph_def, import_scope=...): # -> Tensor | Operation | None:
  ...

def get_train_op(meta_graph_def, import_scope=...): # -> Tensor | Operation | None:
  ...
...
@deprecation.deprecated(None, "This function will only be available through the v1 compatibility " "library as tf.compat.v1.saved_model.loader.load or " "tf.compat.v1.saved_model.load. There will be a new function for importing " "SavedModels in Tensorflow 2.0.")
def load(sess, tags, export_dir, import_scope=..., **saver_kwargs):
...
class SavedModelLoader:
  ...
  @property
  def saved_model(self): # -> SavedModel:
  ...
  def load_graph(self, graph, tags, import_scope=..., **saver_kwargs): # -> tuple[Saver | None, Unknown]:
  ...
  def load(self, sess, tags, import_scope=..., **saver_kwargs):
