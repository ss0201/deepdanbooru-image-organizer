...
class Loader:
  ...
  def adjust_debug_info_func_names(self, debug_info): # -> GraphDebugInfo:
...
def load_partial(export_dir, filters, tags=..., options=...): # -> dict[Unknown, Unknown | None] | dict[str, Unknown | AutoTrackable | None]:
