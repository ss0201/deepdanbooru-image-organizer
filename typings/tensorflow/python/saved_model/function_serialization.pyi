...
def serialize_concrete_function(concrete_function, node_ids): # -> SavedConcreteFunction:
  """Build a SavedConcreteFunction."""
  ...

def serialize_bare_concrete_function(concrete_function): # -> SavedBareConcreteFunction:
  """Build a SavedBareConcreteFunction."""
  ...

def serialize_function(function, concrete_functions): # -> SavedFunction:
