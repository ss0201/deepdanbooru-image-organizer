...
class Topology:
  ...
  @property
  def mesh_shape(self): # -> ndarray[Unknown, Unknown]:
  ...
  @property
  def device_coordinates(self): # -> ndarray[Unknown, Unknown] | ndarray[Any, Unknown]:
  ...
  @property
  def missing_devices(self): # -> ndarray[Unknown, Unknown]:
  ...
  def cpu_device_name_at_coordinates(self, device_coordinates, job=...): # -> Any | LiteralString:
