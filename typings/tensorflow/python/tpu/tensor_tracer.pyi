...
def read_tensor_tracer_event_file(event_file): # -> list[Unknown]:
...
class TensorTracer:
  ...
  def report_proto(self): # -> TensorTracerReport:
  ...
  def host_call_deps_and_fn(self): # -> dict[Unknown, Unknown]:
    ...
  
  def get_traced_op_names(self): # -> set[Unknown]:
    """Returns the set of traced op names."""
    ...
  
  def trace_tpu(self, graph, tensor_fetches, op_fetches=..., num_replicas=..., num_replicas_per_host=..., num_hosts=...): # -> tuple[Unknown, ...] | list[Unknown]:
  ...
  def trace_cpu(self, graph, tensor_fetches, op_fetches=...): # -> tuple[Unknown, ...] | list[Unknown]:
