...
class TTParameters:
  ...
  @staticmethod
  def match_next_flag(flags, pos): # -> tuple[Match[str], Literal[True]] | tuple[Match[str], Literal[False]] | tuple[None, Literal[False]]:
  ...
  def get_signature_to_agg_fn_map(self): # -> dict[str, Unknown]:
