...
"""Operations for TPUs."""
def all_to_all(x, concat_dimension, split_dimension, split_count, group_assignment=..., name=...):
...
def cross_replica_sum(x, group_assignment=..., name=...):
...
def send_tpu_embedding_gradients(inputs, config, learning_rates=..., name=...): # -> None:
...
def enqueue_tpu_embedding_integer_batch(batch, device_ordinal, mode_override=..., name=...): # -> None:
...
def enqueue_tpu_embedding_sparse_batch(sample_indices, embedding_indices, aggregation_weights, device_ordinal, combiners=..., mode_override=..., name=...): # -> None:
  """A placeholder op for enqueueing embedding IDs to the TPU.
...
def enqueue_tpu_embedding_sparse_tensor_batch(sample_indices, embedding_indices, aggregation_weights, table_ids, device_ordinal, max_sequence_lengths=..., num_features=..., combiners=..., mode_override=..., name=...): # -> None:
  """A placeholder op for enqueueing embedding IDs to the TPU.
...
def enqueue_tpu_embedding_ragged_tensor_batch(sample_splits, embedding_indices, aggregation_weights, table_ids, device_ordinal, max_sequence_lengths=..., num_features=..., combiners=..., mode_override=..., name=...): # -> None:
  """A placeholder op for enqueueing embedding IDs to the TPU.
...
def enqueue_tpu_embedding_arbitrary_tensor_batch(sample_indices_or_row_splits, embedding_indices, aggregation_weights, device_ordinal, combiners=..., mode_override=..., name=...): # -> None:
  """A placeholder op for enqueueing embedding IDs to the TPU.
