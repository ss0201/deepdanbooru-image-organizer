...
def shared_embedding_columns(categorical_columns, dimension, combiner=..., initializer=..., shared_embedding_collection_name=..., max_sequence_lengths=..., learning_rate_fn=..., use_safe_embedding_lookup=...): # -> list[Unknown]:
...
class _TPUEmbeddingColumn(_TPUBaseEmbeddingColumn, fc._EmbeddingColumn):
  ...
  def __new__(cls, categorical_column, dimension, combiner=..., layer_creator=..., ckpt_to_load_from=..., tensor_name_in_ckpt=..., max_norm=..., trainable=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=..., bypass_scope_validation=...): # -> _EmbeddingColumn:
    ...
...
class _TPUSharedEmbeddingColumn(_TPUBaseEmbeddingColumn, fc._SharedEmbeddingColumn):
  ...
  def __new__(cls, categorical_column, dimension, combiner=..., initializer=..., shared_embedding_collection_name=..., ckpt_to_load_from=..., tensor_name_in_ckpt=..., max_norm=..., trainable=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=...): # -> _SharedEmbeddingColumn:
    ...
...
def split_sequence_columns(feature_columns): # -> tuple[list[Unknown], list[Unknown]]:
