...
def shared_embedding_columns_v2(categorical_columns, dimension, combiner=..., initializer=..., shared_embedding_collection_name=..., max_sequence_lengths=..., learning_rate_fn=..., embedding_lookup_device=..., tensor_core_shape=..., use_safe_embedding_lookup=...): # -> list[Unknown]:
...
class _TPUEmbeddingColumnV2(_TPUBaseEmbeddingColumn, fc_lib.EmbeddingColumn):
  ...
  def __new__(cls, categorical_column, dimension, combiner=..., initializer=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=..., bypass_scope_validation=...): # -> EmbeddingColumn:
    ...
  
  def __getnewargs__(self): # -> tuple[Unknown, Unknown, Unknown, Unknown, int, Unknown | None, Unknown, bool]:
    ...
  ...
  def get_embedding_table_size(self): # -> tuple[Unknown, Unknown]:
  ...
  def get_dense_tensor(self, transformation_cache, state_manager): # -> Any | SparseTensor | IndexedSlices | Tensor | object:
    ...
...
class _TPUSharedEmbeddingColumnV2(_TPUBaseEmbeddingColumn, fc_lib.SharedEmbeddingColumn):
  ...
  def __new__(cls, categorical_column, shared_embedding_column_creator, combiner=..., initializer=..., shared_embedding_collection_name=..., max_sequence_length=..., learning_rate_fn=..., use_safe_embedding_lookup=...): # -> SharedEmbeddingColumn:
    ...
  
  def __getnewargs__(self): # -> tuple[Unknown, Unknown, Unknown, Unknown | None, Unknown | None, int, Unknown | None]:
    ...
...
def split_sequence_columns_v2(feature_columns): # -> tuple[list[Unknown], list[Unknown]]:
...
def pad_sparse_embedding_lookup_indices(sparse_indices, padded_size): # -> tuple[Unknown | _dispatcher_for_scatter_nd | object, Unknown | _dispatcher_for_scatter_nd | object]:
...
class _TPUDeviceSpecificEmbeddingColumnV2(_TPUEmbeddingColumnV2):
  ...
  def __new__(cls, *args, **kwargs): # -> EmbeddingColumn:
    ...
...
class _TPUSharedDeviceSpecificEmbeddingColumnV2(_TPUSharedEmbeddingColumnV2):
  ...
  def __new__(cls, *args, **kwargs): # -> SharedEmbeddingColumn:
    ...
