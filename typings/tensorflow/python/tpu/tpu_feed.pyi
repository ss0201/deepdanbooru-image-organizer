...
"""
def partition_or_replicate_on_host(tensor, dims): # -> repeat[Unknown] | list[Unknown] | list[None]:
...
def tag_sharding_attribute_for_dequeued_tensors(dequeues, dims): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class InfeedQueue:
  ...
  @property
  def tuple_types(self): # -> list[DType | Unknown] | None:
  ...
  def generate_dequeue_op(self, tpu_device=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def generate_enqueue_ops(self, sharded_inputs, tpu_ordinal_function=..., placement_function=...): # -> list[Unknown | None]:
  ...
  def split_inputs_and_generate_enqueue_ops(self, inputs, device_assignment=..., placement_function=..., tpu_ordinal_function=...): # -> list[Unknown | None]:
...
class _PartitionedInfeedQueue(InfeedQueue):
  ...
  def generate_enqueue_ops(self, sharded_inputs): # -> list[Unknown]:
