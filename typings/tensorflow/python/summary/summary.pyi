...
def scalar(name, tensor, collections=..., family=...):
...
def image(name, tensor, max_outputs=..., collections=..., family=...):
...
def histogram(name, values, collections=..., family=...):
...
def audio(name, tensor, sample_rate, max_outputs=..., collections=..., family=...):
...
def text(name, tensor, collections=...):
...
def tensor_summary(name, tensor, summary_description=..., collections=..., summary_metadata=..., family=..., display_name=...):
...
def merge(inputs, collections=..., name=...):
  """Merges summaries.
...
def merge_all(key=..., scope=..., name=...): # -> None:
...
def get_summary_description(node_def): # -> SummaryDescription:
