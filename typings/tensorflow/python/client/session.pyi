...
class _ElementFetchMapper(_FetchMapper):
  ...
  def unique_fetches(self): # -> list[Unknown]:
    ...
...
class _ListFetchMapper(_FetchMapper):
  ...
  def build_results(self, values): # -> tuple[Unknown, ...] | Any | list[Unknown]:
    ...
...
class _DictFetchMapper(_FetchMapper):
  ...
  def build_results(self, values): # -> defaultdict[Unknown, Unknown]:
    ...
...
class _FetchHandler:
  ...
  def build_results(self, session, tensor_values): # -> tuple[Unknown, ...] | Any | defaultdict[Unknown, Unknown] | list[Unknown] | None:
...
class _DeviceAttributes:
  ...
  @property
  def device_type(self): # -> Unknown:
    ...
  
  @property
  def memory_limit_bytes(self): # -> Unknown:
    ...
  
  @property
  def incarnation(self): # -> Unknown:
    ...
...
class BaseSession(SessionInterface):
  ...
  def list_devices(self): # -> list[Unknown]:
  ...
  def run(self, fetches, feed_dict=..., options=..., run_metadata=...): # -> tuple[Unknown, ...] | Any | defaultdict[Unknown, Unknown] | list[Unknown] | None:
  ...
  def partial_run(self, handle, fetches, feed_dict=...): # -> tuple[Unknown, ...] | Any | defaultdict[Unknown, Unknown] | list[Unknown] | None:
  ...
  def make_callable(self, fetches, feed_list=..., accept_options=...): # -> ((*feed_args: Unknown, **kwargs: Unknown) -> (tuple[Unknown, ...] | Any | Unknown | defaultdict[Unknown, Unknown] | list[Unknown] | None)) | partial[Unknown | None] | (() -> None):
