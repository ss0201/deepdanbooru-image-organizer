...
class _ChromeTraceFormatter:
  ...
  def __init__(self, show_memory=...) -> None:
  ...
  def format_to_string(self, pretty=...): # -> str:
...
class Timeline:
  ...
  def analyze_step_stats(self, show_dataflow=..., show_memory=..., op_time=...): # -> StepStatsAnalysis:
  ...
  def generate_chrome_trace_format(self, show_dataflow=..., show_memory=..., op_time=...):
