...
from tensorflow.python.ops import default_gradient, gen_array_ops
...
def make_attr(attr_type, value): # -> DType | list[DType | Unknown] | TensorShapeProto | list[TensorShapeProto] | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
...
class _MockOp:
  ...
  def get_attr(self, attr): # -> DType | list[DType | Unknown] | TensorShapeProto | list[TensorShapeProto] | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
...
def implicit_val_and_grad(f): # -> (*args: Unknown, **kwds: Unknown) -> tuple[Unknown, list[tuple[Unknown, Unknown]]]:
...
def implicit_grad(f): # -> (*args: Unknown, **kwds: Unknown) -> list[tuple[Unknown, Unknown]]:
  """Returns a function which differentiates f with respect to variables.
...
def gradients_function(f, params=...): # -> (*args: Unknown, **kwds: Unknown) -> Unknown:
...
def val_and_grad_function(f, params=...): # -> (*args: Unknown, **kwds: Unknown) -> tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, Unknown]:
...
def make_vjp(f, params=..., persistent=...): # -> (*args: Unknown, **kwds: Unknown) -> tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, (dy: Unknown | None = None) -> Unknown]:
...
def flatten_nested_indexed_slices(grad): # -> IndexedSlices:
  ...

def aggregate_indexed_slices_gradients(grads): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor | IndexedSlices | None:
  """Aggregates gradients containing `IndexedSlices`s."""
  ...

_default_vspace = imperative_grad.VSpace(num_elements_fn=_num_elements, aggregate_fn=_aggregate_grads, zeros_fn=_zeros, ones_fn=_ones, zeros_like_fn=default_gradient.zeros_like, ones_like_fn=default_gradient.ones_like, graph_shape_fn=gen_array_ops.shape)
...
class GradientTape:
  ...
  def __enter__(self): # -> Self@GradientTape:
  ...
  def watched_variables(self): # -> tuple[()]:
    """Returns variables watched by this tape in order of construction."""
    ...
  
  def gradient(self, target, sources, output_gradients=..., unconnected_gradients=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def jacobian(self, target, sources, unconnected_gradients=..., parallel_iterations=..., experimental_use_pfor=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
