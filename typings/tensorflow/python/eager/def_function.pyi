...
class UnliftedInitializerVariable(resource_variable_ops.UninitializedVariable):
  ...
  """
  def __init__(self, initial_value=..., trainable=..., caching_device=..., name=..., dtype=..., constraint=..., add_initializers_to=..., lifted_initializer_graph=..., synchronization=..., aggregation=..., shape=..., **unused_kwargs) -> None:
    """Creates a variable.
...
def experimental_functions_run_eagerly(): # -> Literal[False]:
...
class Function(core.GenericFunction, trackable.Trackable):
  ...
  """
  def __init__(self, python_function, name, input_signature=..., autograph=..., jit_compile=..., reduce_retracing=..., experimental_implements=..., experimental_autograph_options=..., experimental_follow_type_hints=...) -> None:
  ...
  def experimental_get_tracing_count(self): # -> Any | Literal[0]:
  ...
  def experimental_get_compiler_ir(self, *args, **kwargs): # -> (stage: str = "hlo", device_name: Unknown | None = None) -> Unknown:
    ...
  ...
  def get_initialization_function(self, *args, **kwargs): # -> Any:
  ...
  def get_concrete_function(self, *args, **kwargs): # -> Any | None:
    ...
  
  def __get__(self, instance, owner): # -> MethodType | Self@Function:
...
def function(func=..., input_signature=..., autograph=..., jit_compile=..., reduce_retracing=..., experimental_implements=..., experimental_autograph_options=..., experimental_relax_shapes=..., experimental_compile=..., experimental_follow_type_hints=...) -> core.GenericFunction:
