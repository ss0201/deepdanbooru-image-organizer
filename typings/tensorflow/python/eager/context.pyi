...
is_tfrt_enabled = ...
_RUN_EAGER_OP_AS_FUNCTION_ENABLED = ...
...
def run_eager_op_as_function_enabled(): # -> bool:
  ...
...
class LogicalDeviceConfiguration(collections.namedtuple("LogicalDeviceConfiguration", ["memory_limit", "experimental_priority", "experimental_device_ordinal"])):
  ...
  """
  def __new__(cls, memory_limit=..., experimental_priority=..., experimental_device_ordinal=...): # -> Self@LogicalDeviceConfiguration:
    ...
...
class Context:
  ...
  def configure_coordination_service(self, service_type, service_leader=..., enable_health_check=..., cluster_register_timeout_in_ms=..., heartbeat_timeout_in_ms=..., coordinated_jobs=...): # -> None:
    """Enable distributed coordination service with specified configs."""
    ...
  
  @property
  def coordination_service(self): # -> CoordinationServiceConfig | None:
    ...
  ...
  @property
  def config(self): # -> ConfigProto:
    """Return the ConfigProto with all runtime deltas applied."""
    ...
  
  @property
  def function_call_options(self): # -> FunctionCallOptions:
  ...
  def get_function_def(self, name): # -> FunctionDef:
  ...
  def list_function_names(self): # -> set[Unknown]:
  ...
  def list_physical_devices(self, device_type=...): # -> list[Unknown] | list[PhysicalDevice]:
  ...
  def list_logical_devices(self, device_type=...): # -> list[Unknown]:
  ...
  def get_compiler_ir(self, device_name, function_name, args, stage=...):
    ...
  ...
  def get_optimizer_experimental_options(self): # -> dict[Unknown, Unknown]:
  ...
  @property
  def run_eager_op_as_function(self): # -> bool:
    ...
  
  @run_eager_op_as_function.setter
  def run_eager_op_as_function(self, enable): # -> None:
    ...
  ...
  @property
  def use_tfrt_distributed_runtime(self): # -> bool | None:
    ...
  ...
  def export_run_metadata(self): # -> RunMetadata | None:
...
def collect_graphs(optimized=...): # -> Generator[list[Unknown], None, None]:
