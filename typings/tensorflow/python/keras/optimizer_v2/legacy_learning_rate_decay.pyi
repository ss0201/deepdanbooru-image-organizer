...
def exponential_decay(learning_rate, global_step, decay_steps, decay_rate, staircase=..., name=...): # -> partial[Unknown]:
...
def piecewise_constant(x, boundaries, values, name=...): # -> partial[Unknown]:
...
def polynomial_decay(learning_rate, global_step, decay_steps, end_learning_rate=..., power=..., cycle=..., name=...): # -> partial[Unknown]:
...
def natural_exp_decay(learning_rate, global_step, decay_steps, decay_rate, staircase=..., name=...): # -> partial[Unknown]:
...
def inverse_time_decay(learning_rate, global_step, decay_steps, decay_rate, staircase=..., name=...): # -> partial[Unknown]:
...
def cosine_decay(learning_rate, global_step, decay_steps, alpha=..., name=...): # -> partial[Unknown]:
...
def cosine_decay_restarts(learning_rate, global_step, first_decay_steps, t_mul=..., m_mul=..., alpha=..., name=...): # -> partial[Unknown]:
...
def linear_cosine_decay(learning_rate, global_step, decay_steps, num_periods=..., alpha=..., beta=..., name=...): # -> partial[Unknown]:
...
def noisy_linear_cosine_decay(learning_rate, global_step, decay_steps, initial_variance=..., variance_decay=..., num_periods=..., alpha=..., beta=..., name=...): # -> partial[Unknown]:
