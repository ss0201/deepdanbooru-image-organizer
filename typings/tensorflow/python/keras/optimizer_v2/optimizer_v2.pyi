...
class OptimizerV2(trackable.Trackable):
  ...
  def minimize(self, loss, var_list, grad_loss=..., name=..., tape=...): # -> _dispatcher_for_no_op | object | None:
  ...
  def get_updates(self, loss, params): # -> list[Unknown | _dispatcher_for_no_op | object | None]:
    ...
  ...
  @classmethod
  def from_config(cls, config, custom_objects=...): # -> Self@OptimizerV2:
