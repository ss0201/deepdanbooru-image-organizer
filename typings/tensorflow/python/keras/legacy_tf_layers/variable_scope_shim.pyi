...
class _EagerVariableStore:
  ...
  def get_variable(self, name, shape=..., dtype=..., initializer=..., regularizer=..., reuse=..., trainable=..., collections=..., caching_device=..., partitioner=..., validate_shape=..., use_resource=..., custom_getter=..., constraint=..., synchronization=..., aggregation=...): # -> Variable:
...
class VariableAndLossTracker(module.Module):
  ...
  def get_regularization_losses(self): # -> dict[Unknown, Unknown]:
    ...
