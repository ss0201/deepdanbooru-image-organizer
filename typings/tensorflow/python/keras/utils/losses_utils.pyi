...
def remove_squeezable_dimensions(labels, predictions, expected_rank_diff=..., name=...): # -> tuple[Unknown | Tensor | Any | RaggedTensor, Unknown | Tensor | Any | RaggedTensor] | tuple[Any | Unknown | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy | Tensor | RaggedTensor, Any | Unknown | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy | Tensor | RaggedTensor]:
...
def squeeze_or_expand_dimensions(y_pred, y_true=..., sample_weight=...): # -> tuple[Unknown | Tensor | Any | RaggedTensor | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy, Unknown | Tensor | Any | RaggedTensor | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy | None] | tuple[Unknown | Tensor | Any | RaggedTensor | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy, Unknown | Tensor | Any | RaggedTensor | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy | None, Unknown] | tuple[Unknown | Tensor | Any | RaggedTensor | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy, Unknown | Tensor | Any | RaggedTensor | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy | None, Any | Unknown | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy]:
...
def compute_weighted_loss(losses, sample_weight=..., reduction=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
def cast_losses_to_common_dtype(losses): # -> list[Unknown | SparseTensor | IndexedSlices | Tensor | Any]:
