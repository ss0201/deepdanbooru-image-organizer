...
def map_structure_with_atomic(is_atomic_fn, map_fn, nested): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def get_shapes(tensors): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  """Gets shapes from tensors."""
  ...

def convert_shapes(input_shape, to_tuples=...): # -> tuple[int | None, ...] | TensorShape | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class ListWrapper:
  ...
  def as_list(self): # -> Unknown:
    ...
  


def convert_inner_node_data(nested, wrap=...): # -> ListWrapper | Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def shape_type_conversion(fn): # -> (instance: Unknown, input_shape: Unknown) -> (tuple[int | None, ...] | TensorShape | defaultdict[Unknown, Unknown] | Any | list[Unknown] | Unknown | ObjectProxy):
...
def is_tensor_or_variable(x): # -> Any | bool:
  ...
...
def dataset_is_infinite(dataset): # -> Any | bool:
  """True if the passed dataset is infinite."""
  ...

def get_tensor_spec(t, dynamic_batch=..., name=...): # -> TypeSpec | None:
  """Returns a `TensorSpec` given a single `Tensor` or `TensorSpec`."""
  ...

def sync_to_numpy_or_python_type(tensors): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
