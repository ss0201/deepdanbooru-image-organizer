...
def get_pool_class(use_multiprocessing): # -> ((processes: int | None = ..., initializer: ((...) -> object) | None = ..., initargs: Iterable[Any] = ...) -> Any) | ((processes: int | None = ..., initializer: ((...) -> object) | None = ..., initargs: Iterable[Any] = ..., maxtasksperchild: int | None = ...) -> Pool):
  ...

def get_worker_id_queue(): # -> Queue[Unknown]:
