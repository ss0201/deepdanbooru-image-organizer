...
@dispatch.add_dispatch_support
def selu(x): # -> _dispatcher_for_selu | object:
...
@dispatch.add_dispatch_support
def swish(x): # -> tuple[Unknown, (dy: Unknown) -> Unknown]:
...
@dispatch.add_dispatch_support
def serialize(activation): # -> str | Any | dict[str, Unknown] | None:
...
@dispatch.add_dispatch_support
def get(identifier): # -> ((x: Unknown) -> Unknown) | Any | None:
  """Returns function.
