...
def unwrap_values(distribution_strategy, grouped_inputs, grouped_outputs, grouped_updates=..., grouped_session_args=..., with_loss_tensor=...): # -> tuple[list[Unknown], list[Unknown], list[Unknown] | None, dict[Unknown, Unknown]]:
...
def unwrap_output_dict(strategy, grouped_outputs, mode): # -> list[Unknown] | dict[str, Unknown]:
  """Unwrap the list of outputs contained in the PerReplica parameters."""
  ...

def unwrap_outputs(distribution_strategy, grouped_outputs, with_loss_tensor=...): # -> list[Unknown]:
  """Unwrap the list of outputs contained in the PerReplica parameters.
...
def flatten_per_replica_values(distribution_strategy, per_replica_values): # -> list[Unknown]:
...
def validate_distributed_dataset_inputs(distribution_strategy, x, y, sample_weights=...): # -> tuple[list[Unknown], list[Unknown] | None, list[Unknown] | None]:
...
def validate_per_replica_inputs(distribution_strategy, x): # -> list[Unknown]:
...
def process_batch_and_step_size(strategy, inputs, batch_size, steps_per_epoch, mode, validation_split=...): # -> tuple[Unknown | int, Any | Unknown]:
  """Process the batch size and step size based on input and dist strategy."""
  ...

def get_input_params(distribution_strategy, num_samples, steps, batch_size, mode=...): # -> tuple[Any | Unknown, Unknown | int]:
...
def filter_distributed_callbacks(callbacks_list, model): # -> list[Unknown | Any]:
...
def concat_along_batch_dimension(outputs): # -> SparseTensor | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
