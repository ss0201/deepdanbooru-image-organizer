...
class Optimizer:
  ...
  def get_gradients(self, loss, params): # -> list[IndexedSlices | Unknown | _dispatcher_for_maximum | object] | list[IndexedSlices | Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
  ...
  @classmethod
  def from_config(cls, config): # -> Self@Optimizer:
    ...
