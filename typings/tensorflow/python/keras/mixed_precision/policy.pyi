...
class PolicyV1(Policy):
  ...
  @classmethod
  def from_config(cls, config, custom_objects=...): # -> Self@PolicyV1:
    ...
  


_global_policy = ...
@keras_export('keras.mixed_precision.global_policy', 'keras.mixed_precision.experimental.global_policy', v1=[])
...
@keras_export('keras.mixed_precision.set_global_policy', 'keras.mixed_precision.experimental.set_global_policy', v1=[])
