...
class _DynamicLossScaleState(trackable.Trackable):
  ...
  @property
  def current_loss_scale(self): # -> variable:
    """Returns the current loss scale as a float32 `tf.Variable`."""
    ...
  
  @property
  def counter(self): # -> variable:
  ...
  def update(self, grads): # -> tuple[Any | Unknown | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy, Unknown | Any]:
...
class LossScaleOptimizer(base_delegate.DelegatingTrackableMixin, optimizer_v2.OptimizerV2):
  ...
  @property
  def loss_scale(self): # -> Tensor | Any:
    """The current loss scale as a float32 scalar tensor."""
    ...
  
  @property
  def dynamic_counter(self): # -> variable | None:
  ...
  def get_scaled_loss(self, loss): # -> () -> Unknown:
  ...
  def get_unscaled_gradients(self, grads): # -> list[IndexedSlices | Unknown | None]:
  ...
  def get_gradients(self, loss, params): # -> list[IndexedSlices | Unknown | None]:
    ...
  
  def apply_gradients(self, grads_and_vars, name=..., experimental_aggregate_gradients=...): # -> _dispatcher_for_no_op | object | None:
    ...
  ...
  @classmethod
  def from_config(cls, config, custom_objects=...): # -> Self@LossScaleOptimizer:
    ...
  ...
  def __getattribute__(self, name): # -> Any | LearningRateSchedule | SparseTensor | IndexedSlices | Tensor:
    ...
  ...
  @property
  def learning_rate(self): # -> Any | LearningRateSchedule | SparseTensor | IndexedSlices | Tensor:
    ...
  ...
  @property
  def lr(self): # -> Any | LearningRateSchedule | SparseTensor | IndexedSlices | Tensor:
    ...
...
class LossScaleOptimizerV1(LossScaleOptimizer):
  ...
  @classmethod
  def from_config(cls, config, custom_objects=...): # -> Self@LossScaleOptimizerV1:
    ...
