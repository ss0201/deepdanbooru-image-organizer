...
class BaseDenseAttention(Layer):
  ...
  def call(self, inputs, mask=..., training=..., return_attention_scores=...): # -> tuple[Unknown, Any | Unknown | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy]:
    ...
  
  def compute_mask(self, inputs, mask=...): # -> Tensor | Any | None:
    ...
