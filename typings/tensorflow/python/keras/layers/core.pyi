...
class Dropout(Layer):
  ...
  def call(self, inputs, training=...): # -> Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy:
    ...
...
class RepeatVector(Layer):
  ...
  def call(self, inputs): # -> _dispatcher_for_tile | object:
    ...
...
class Lambda(Layer):
  ...
  def compute_output_shape(self, input_shape): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | tuple[int | None, ...] | TensorShape:
    ...
...
class Dense(Layer):
  ...
  def call(self, inputs): # -> SparseTensor | IndexedSlices | Tensor | Any | object:
    ...
...
class KerasOpDispatcher(dispatch.GlobalOpDispatcher):
  ...
  def handle(self, op, args, kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | ((func: Unknown | None = None) -> (... | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown))) | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown) | object:
...
class TFClassMethodDispatcher(dispatch.OpDispatcher):
  ...
  def handle(self, args, kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | ((func: Unknown | None = None) -> (... | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown))) | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown) | object:
    """Handle the specified operation with the specified arguments."""
    ...
