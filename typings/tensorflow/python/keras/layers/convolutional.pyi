...
class Conv2DTranspose(Conv2D):
  ...
  def call(self, inputs): # -> _dispatcher_for_batch_to_space_nd | object:
    ...
...
class UpSampling1D(Layer):
  ...
  def call(self, inputs): # -> SparseTensor | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
...
class UpSampling2D(Layer):
  ...
  def call(self, inputs): # -> Tensor | Any:
    ...
