...
class LeakyReLU(Layer):
  ...
  def call(self, inputs): # -> IndexedSlices | _dispatcher_for_maximum | object:
    ...
...
class ELU(Layer):
  ...
  def call(self, inputs): # -> _dispatcher_for_elu | object:
    ...
...
class Softmax(Layer):
  ...
  def call(self, inputs, mask=...): # -> tuple[Unknown, ...]:
    ...
