...
class StackedRNNCells(Layer):
  ...
  def call(self, inputs, states, constants=..., training=..., **kwargs): # -> tuple[Unknown, Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
    ...
...
class RNN(Layer):
  ...
  @property
  def states(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | list[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
    ...
  ...
  def compute_output_shape(self, input_shape): # -> list[None] | list[Unknown | TensorShape | None] | TensorShape | None:
    ...
  ...
  def get_initial_state(self, inputs): # -> list[Any | Unknown | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy]:
    ...
  
  def __call__(self, inputs, initial_state=..., constants=..., **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | ((func: Unknown | None = None) -> (... | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown))) | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
    ...
  
  def call(self, inputs, mask=..., training=..., initial_state=..., constants=...): # -> list[Unknown] | Any | list[Unknown | _dispatcher_for_reverse_v2 | object | RaggedTensor] | object | RaggedTensor:
    ...
...
class AbstractRNNCell(Layer):
  ...
  def get_initial_state(self, inputs=..., batch_size=..., dtype=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
...
class SimpleRNN(RNN):
  ...
  def call(self, inputs, mask=..., training=..., initial_state=...): # -> list[Unknown] | Any | list[Unknown | _dispatcher_for_reverse_v2 | object | RaggedTensor] | object | RaggedTensor:
    ...
...
class LSTMCell(DropoutRNNCellMixin, Layer):
  ...
  def get_initial_state(self, inputs=..., batch_size=..., dtype=...): # -> list[Unknown | Any]:
    ...
