...
class Loss:
  ...
  * `call()`: Contains the logic for loss calculation using `y_true`, `y_pred`.
  ...
  def __call__(self, y_true, y_pred, sample_weight=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
@dispatch.add_dispatch_support
def categorical_hinge(y_true, y_pred): # -> _dispatcher_for_maximum | object:
  """Computes the categorical hinge loss between `y_true` and `y_pred`.
...
@dispatch.add_dispatch_support
def categorical_crossentropy(y_true, y_pred, from_logits=..., label_smoothing=..., axis=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
@dispatch.add_dispatch_support
def sparse_categorical_crossentropy(y_true, y_pred, from_logits=..., axis=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
