...
class Node:
  ...
  def map_arguments(self, tensor_dict): # -> tuple[tuple[Unknown], dict[Unknown, Unknown]] | tuple[Unknown | Any, Unknown | Any]:
    """Maps Keras Tensors to computed Tensors using `tensor_dict`."""
    ...
  
  def serialize(self, make_node_key, node_conversion_map): # -> ListWrapper | Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    """Serializes `Node` for Functional API's `get_config`."""
    ...
  
  @property
  def input_tensors(self): # -> list[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy] | Any:
    ...
  
  @property
  def output_tensors(self): # -> list[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy] | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
  
  @property
  def input_shapes(self): # -> Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
    ...
  ...
  @property
  def inbound_layers(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
