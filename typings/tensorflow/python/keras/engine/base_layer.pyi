...
class Layer(module.Module, version_utils.LayerVersionSelector):
  ...
  * `get_config(self)`: Returns a dictionary containing the configuration used
  ...
  @doc_controls.for_subclass_implementers
  def compute_output_signature(self, input_signature): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def __call__(self, *args, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | ((func: Unknown | None = None) -> (... | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown))) | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
  ...
  @doc_controls.do_not_doc_inheritable
  def apply(self, inputs, *args, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | ((func: Unknown | None = None) -> (... | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown))) | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
    """Deprecated, do NOT use!
