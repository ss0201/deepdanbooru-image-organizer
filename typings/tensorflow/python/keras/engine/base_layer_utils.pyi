...
_call_context = ...
def create_mean_metric(value, name=...): # -> tuple[Mean, Unknown | Any]:
  ...
...
def collect_previous_mask(input_tensors): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def unnest_if_single_tensor(input_tensors): # -> dict[Unknown, Unknown] | None:
  ...
...
def mark_as_return(outputs, acd): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class TrackableWeightHandler:
  ...
  def get_tensors(self): # -> list[Any | Unknown]:
    ...
