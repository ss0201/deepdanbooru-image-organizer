...
class Model(training_lib.Model):
  ...
  def compile(self, optimizer=..., loss=..., metrics=..., loss_weights=..., sample_weight_mode=..., weighted_metrics=..., target_tensors=..., distribute=..., **kwargs):
  ...
  @property
  def metrics_names(self): # -> list[Unknown] | list[str]:
  ...
  def predict(self, x, batch_size=..., verbose=..., steps=..., callbacks=..., max_queue_size=..., workers=..., use_multiprocessing=...): # -> Any | list[Unknown]:
  ...
  def train_on_batch(self, x, y=..., sample_weight=..., class_weight=..., reset_metrics=...): # -> list[Unknown]:
  ...
  def test_on_batch(self, x, y=..., sample_weight=..., reset_metrics=...): # -> list[Unknown]:
  ...
  def predict_on_batch(self, x): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | ((func: Unknown | None = None) -> (... | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown))) | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
  ...
  def predict_generator(self, generator, steps=..., callbacks=..., max_queue_size=..., workers=..., use_multiprocessing=..., verbose=...): # -> Any | list[Unknown]:
  ...
  @property
  def sample_weights(self): # -> list[Unknown]:
    ...
...
class _TrainingEndpoint:
  ...
  @property
  def output(self): # -> Unknown:
    ...
  
  @property
  def output_name(self): # -> Unknown:
    ...
  
  @property
  def shape(self): # -> tuple[Unknown, ...] | None:
    ...
  
  @property
  def loss_fn(self): # -> Unknown:
    ...
  ...
  @property
  def feed_output_shape(self): # -> tuple[Unknown | Literal[1], ...] | tuple[Unknown, ...] | None:
