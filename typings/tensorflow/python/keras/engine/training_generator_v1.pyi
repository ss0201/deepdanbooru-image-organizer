...
evaluate_generator = ...
predict_generator = ...
def convert_to_generator_like(data, batch_size=..., steps_per_epoch=..., epochs=..., shuffle=...): # -> tuple[Sequence | tuple[Unknown, ...] | Unknown | IteratorBase, int | Unknown | None] | tuple[Unknown | OwnedIterator | Iterator, Unknown | None] | tuple[Generator[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, None, None], int]:
