...
class TensorLikeDataAdapter(DataAdapter):
  ...
  def slice_inputs(self, indices_dataset, inputs): # -> _OptionsDataset:
  ...
  def get_dataset(self): # -> MapDataset | ParallelMapDataset | _OptionsDataset:
    ...
...
class CompositeTensorDataAdapter(DataAdapter):
  ...
  def get_dataset(self): # -> BatchDataset | ParallelBatchDataset:
    ...
...
class GeneratorDataAdapter(DataAdapter):
  ...
  def get_dataset(self): # -> FlatMapDataset | PrefetchDataset | DatasetV1Adapter:
    ...
...
def broadcast_sample_weight_modes(target_structure, sample_weight_modes): # -> dict[Unknown, str] | list[str] | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class DataHandler:
  ...
  def enumerate_epochs(self): # -> Generator[tuple[int, Unknown], None, None]:
  ...
  def steps(self): # -> Generator[Unknown | Literal[0], None, None]:
  ...
  @property
  def inferred_steps(self): # -> int | None:
...
def expand_1d(data): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  """Expands 1-dimensional `Tensor`s into 2-dimensional `Tensor`s."""
  ...

def train_validation_split(arrays, validation_split): # -> tuple[Unknown, Unknown] | tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
...
def unpack_x_y_sample_weight(data): # -> tuple[Unknown, None, None] | tuple[Unknown, Unknown, None] | tuple[Unknown, Unknown, Unknown]:
...
def pack_x_y_sample_weight(x, y=..., sample_weight=...): # -> tuple[Unknown] | tuple[Unknown, Unknown] | tuple[Unknown, Unknown, Unknown]:
