...
def slice_arrays(arrays, indices, contiguous=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | list[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy] | list[None] | list[Unknown | None] | None:
...
def handle_partial_sample_weights(outputs, sample_weights, sample_weight_modes, check_all_flat=...): # -> tuple[None, Literal[False], bool] | tuple[Unknown, Literal[True], Literal[False]] | tuple[tuple[Unknown, ...], Literal[True], Literal[True]]:
...
def get_input_shape_and_dtype(layer): # -> tuple[Unknown, Unknown] | tuple[None, None]:
...
def list_to_tuple(maybe_list): # -> tuple[Unknown, ...]:
