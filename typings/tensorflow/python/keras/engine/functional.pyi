...
class Functional(training_lib.Model):
  ...
  @property
  def input_shape(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  @property
  def output_shape(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def compute_mask(self, inputs, mask): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
  
  @doc_controls.do_not_doc_inheritable
  def call(self, inputs, training=..., mask=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  @classmethod
  def from_config(cls, config, custom_objects=...): # -> Self@Functional:
...
def reconstruct_from_config(config, custom_objects=..., created_layers=...): # -> tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, Unknown | OrderedDict[Unknown, Unknown]]:
...
def get_network_config(network, serialize_layer_fn=...): # -> dict[str, Unknown]:
