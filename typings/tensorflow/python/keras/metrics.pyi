...
class Reduce(Metric):
  ...
  def result(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
...
def accuracy(y_true, y_pred): # -> SparseTensor | IndexedSlices | Tensor | Any:
  ...
...
@dispatch.add_dispatch_support
def categorical_accuracy(y_true, y_pred): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """Calculates how often predictions match one-hot labels.
...
@dispatch.add_dispatch_support
def sparse_categorical_accuracy(y_true, y_pred): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """Calculates how often predictions match integer labels.
...
@dispatch.add_dispatch_support
def top_k_categorical_accuracy(y_true, y_pred, k=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """Computes how often targets are in the top `K` predictions.
...
@dispatch.add_dispatch_support
def sparse_top_k_categorical_accuracy(y_true, y_pred, k=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """Computes how often integer targets are in the top `K` predictions.
...
def clone_metrics(metrics): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
