...
class Encoder(json.JSONEncoder):
  ...
  def default(self, obj): # -> dict[str, Unknown] | Any | int | list[int | None] | dict[Unknown, Unknown] | dict[str, str] | None:
...
def get_json_type(obj): # -> dict[str, Unknown] | Any | int | list[int | None] | dict[Unknown, Unknown] | dict[str, str] | None:
