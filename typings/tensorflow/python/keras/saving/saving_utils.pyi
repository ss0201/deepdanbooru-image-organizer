...
def extract_model_metrics(model): # -> dict[Unknown, Unknown] | None:
...
def model_input_signature(model, keep_original_batch_size=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | list[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy] | None:
...
def model_metadata(model, include_optimizer=..., require_config=...): # -> dict[str, str | dict[str, Unknown]]:
...
def compile_args_from_training_config(training_config, custom_objects=...): # -> dict[str, Unknown | None]:
