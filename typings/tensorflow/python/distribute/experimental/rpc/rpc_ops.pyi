...
class StatusOrResult:
  ...
  def get_error(self): # -> tuple[Unknown | _dispatcher_for_rpc_check_status | None, Unknown | _dispatcher_for_rpc_check_status | None]:
  ...
  def get_value(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | None:
