...
pick_unused_port = ...
def create_in_process_cluster(num_workers, num_ps, has_chief=..., has_eval=..., rpc_layer=...): # -> dict[Unknown, Unknown]:
...
class MultiProcessCluster:
  ...
  @property
  def cluster_resolver(self): # -> Unknown:
    ...
...
def create_cluster_spec(has_chief=..., num_workers=..., num_ps=..., has_eval=...): # -> dict[Unknown, Unknown]:
...
class MultiWorkerTestBase(test.TestCase):
  ...
  @contextlib.contextmanager
  def session(self, graph=..., config=..., target=...): # -> Generator[Unknown, None, None]:
  ...
  @contextlib.contextmanager
  def cached_session(self, graph=..., config=..., target=...): # -> Generator[Session | Any, None, None]:
    """Create a test session with master target set to the testing cluster.
...
class MockOsEnv(collections_abc.Mapping):
  ...
  def __iter__(self): # -> Generator[Unknown | Any, None, None]:
    ...
...
class IndependentWorkerTestBase(test.TestCase):
  ...
  def run_multiple_tasks_in_threads(self, task_fn, cluster_spec, *args, **kwargs): # -> dict[Unknown, Unknown]:
    ...
...
class MultiWorkerMultiProcessTest(test.TestCase):
  ...
  def run_multiple_tasks_in_processes(self, cmd_args, cluster_spec): # -> dict[Unknown, Unknown]:
