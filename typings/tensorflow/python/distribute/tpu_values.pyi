...
class TPUSyncOnReadVariable(TPUVariableMixin, values.SyncOnReadVariable):
  ...
  def assign_sub(self, *args, **kwargs): # -> _dispatcher_for_no_op | object | None:
    ...
  
  def assign_add(self, *args, **kwargs): # -> _dispatcher_for_no_op | object | None:
    ...
  
  def assign(self, *args, **kwargs): # -> _dispatcher_for_no_op | object | None:
    ...
...
class TPUOnReadPolicy(values.OnReadPolicy):
  ...
  scope.
  """
  def assign_sub(self, var, *args, **kwargs): # -> _dispatcher_for_no_op | object | None:
    ...
  
  def assign_add(self, var, *args, **kwargs): # -> _dispatcher_for_no_op | object | None:
    ...
  
  def assign(self, var, *args, **kwargs): # -> _dispatcher_for_no_op | object | None:
    ...
