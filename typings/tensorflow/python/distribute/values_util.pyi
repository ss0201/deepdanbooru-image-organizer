...
def get_on_write_saveable(var, primary_var, name): # -> tuple[() -> (Unknown | None), list[SaveSpec]]:
  """Return saveable spec for AUTO and ON_WRITE variables."""
  ...

def get_on_write_restore_ops(var, tensor): # -> _dispatcher_for_no_op | object | None:
  """Return restore ops for AUTO and ON_WRITE variables."""
  ...

def get_on_read_saveable(var, primary_var, name): # -> tuple[() -> Unknown, list[SaveSpec]]:
  """Return saveables for ON_READ variable."""
  ...

def get_on_read_restore_ops(var, tensor, aggregation): # -> _dispatcher_for_no_op | object | None:
...
def assign_on_each_device(var, assign_func, value, read_value): # -> _dispatcher_for_no_op | object | None:
  """Update the variable on each replica with the given assign_func and value."""
  ...

def on_read_assign_sub_cross_replica(var, value, read_value=...): # -> _dispatcher_for_no_op | object | None:
  ...

def on_read_assign_add_cross_replica(var, value, read_value=...): # -> _dispatcher_for_no_op | object | None:
  ...

def on_read_assign_cross_replica(var, value, read_value=...): # -> _dispatcher_for_no_op | object | None:
...
def get_current_replica_id_as_int(): # -> Any | int | None:
