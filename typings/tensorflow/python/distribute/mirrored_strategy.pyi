...
class MirroredExtended(distribute_lib.StrategyExtendedV1):
  ...
  def value_container(self, val): # -> DistributedVariable:
    ...
  
  @property
  def worker_devices(self): # -> tuple[Unknown | LiteralString | str, ...] | tuple[Unknown, ...]:
    ...
  
  @property
  def worker_devices_by_replica(self): # -> list[list[Unknown | str]]:
    ...
  
  @property
  def parameter_devices(self): # -> tuple[Unknown | LiteralString | str, ...] | tuple[Unknown, ...]:
    ...
  ...
  def non_slot_devices(self, var_list): # -> tuple[Unknown | LiteralString | str, ...] | tuple[Unknown, ...]:
    ...
