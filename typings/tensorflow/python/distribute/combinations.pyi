...
class DistributionParameter(combinations_lib.ParameterModifier):
  ...
  `strategy` property.
  """
  def modified_arguments(self, kwargs, requested_parameters): # -> dict[Unknown, Unknown]:
    ...
...
class DistributionCombination(combinations_lib.TestCombination):
  ...
  def should_execute_combination(self, kwargs): # -> tuple[Literal[False], Literal['n/a: skipping strategy combination with no_xla=Tru…']] | tuple[Literal[True], None]:
    ...
  
  def parameter_modifiers(self): # -> list[Unknown]:
    ...
...
class GPUCombination(combinations_lib.TestCombination):
  ...
  if sys.argv:
    GPU_TEST = ...
  def should_execute_combination(self, kwargs): # -> tuple[Literal[False], Literal['Test that doesn\'t require GPUs.']] | tuple[Literal[False], LiteralString] | tuple[Literal[True], None]:
    ...
...
tf_function = ...
no_tf_function = ...
def concat(*combined): # -> list[Unknown]:
  """Concats combinations."""
  ...

@tf_export("__internal__.distribute.combinations.generate", v1=[])
def generate(combinations, test_combinations=...): # -> (test_method_or_class: Unknown) -> (type | _ParameterizedTestIter):
...
def in_main_process(): # -> Literal[True]:
