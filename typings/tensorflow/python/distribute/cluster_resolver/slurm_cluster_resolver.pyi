...
def expand_hostlist(hostlist): # -> list[Unknown]:
...
def expand_tasks_per_node(tasks_per_node): # -> list[Unknown]:
...
class SlurmClusterResolver(ClusterResolver):
  ...
  def num_accelerators(self, task_type=..., task_id=..., config_proto=...): # -> dict[str, int | Unknown]:
    ...
