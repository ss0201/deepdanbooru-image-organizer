...
def get_accelerator_devices(master, config_proto): # -> list[Unknown]:
...
class ClusterResolver:
  ...
  def num_accelerators(self, task_type=..., task_id=..., config_proto=...): # -> defaultdict[Unknown, int]:
...
class SimpleClusterResolver(ClusterResolver):
  ...
  def num_accelerators(self, task_type=..., task_id=..., config_proto=...): # -> dict[Unknown, Unknown]:
    """Returns the number of accelerator cores per worker.
