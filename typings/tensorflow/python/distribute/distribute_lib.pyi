...
class _CurrentDistributionContext:
  ...
  """
  def __init__(self, strategy, var_creator_scope, var_scope=..., resource_creator_scope=..., default_device=...) -> None:
    ...
...
class RunOptions(collections.namedtuple("RunOptions", ["experimental_enable_dynamic_batch_size", "experimental_bucketizing_dynamic_shape", "experimental_xla_options"])):
  ...
  """
  def __new__(cls, experimental_enable_dynamic_batch_size=..., experimental_bucketizing_dynamic_shape=..., experimental_xla_options=...): # -> Self@RunOptions:
    ...
...
class InputOptions(collections.namedtuple("InputOptions", ["experimental_fetch_to_device", "experimental_replication_mode", "experimental_place_dataset_on_device", "experimental_per_replica_buffer_size"])):
  ...
  """
  def __new__(cls, experimental_fetch_to_device=..., experimental_replication_mode=..., experimental_place_dataset_on_device=..., experimental_per_replica_buffer_size=...): # -> Self@InputOptions:
    ...
...
class StrategyBase:
  ...
  * If you are writing a custom training loop, you will need to call a few more
  ...
  def reduce(self, reduce_op, value, axis): # -> _dispatcher_for_real_div | object:
  ...
  def __deepcopy__(self, memo): # -> Self@StrategyBase:
    ...
...
class StrategyExtendedV2:
  ...
  * _How to update a distributed variable_
  ...
  def colocate_vars_with(self, colocate_with_variable): # -> Generator[None, None, None]:
  ...
  def batch_reduce_to(self, reduce_op, value_destination_pairs, options=...): # -> list[Unknown]:
...
class ReplicaContextBase:
  ...
  def merge_call(self, merge_fn, args=..., kwargs=...): # -> Any | ((func: Unknown | None = None) -> (... | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown))) | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
  ...
  def all_reduce(self, reduce_op, value, options=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class ReplicaContext(ReplicaContextBase):
  __doc__ = ...
  def all_gather(self, value, axis, options=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class _DefaultDistributionExtended(StrategyExtendedV1):
  ...
  def colocate_vars_with(self, colocate_with_variable): # -> Generator[None, None, None] | NullContextmanager:
  ...
  def read_var(self, replica_local_var): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
  ...
  class DefaultInputIterator:
    ...
    def initialize(self): # -> list[Unknown]:
    ...
    @property
    def initializer(self): # -> list[Unknown]:
