...
class WorkerPreemptionHandler:
  ...
  def wait_on_failure(self, on_failure_fn=..., on_transient_failure_fn=..., on_recovery_fn=..., worker_device_name=...): # -> Generator[None, None, None]:
...
class ClusterCoordinator:
  ...
  """
  def __new__(cls, strategy): # -> Self@ClusterCoordinator:
    ...
  ...
  @property
  def strategy(self): # -> ParameterServerStrategyV2:
  ...
  def fetch(self, val): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
