...
class ShardedVariableMixin(trackable.Trackable):
  ...
  def __getitem__(self, slice_spec): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | None:
  ...
  @property
  def variables(self): # -> list[UninitializedVariable] | Unknown:
  ...
  def assign(self, value, use_locking=..., name=..., read_value=...): # -> Self@ShardedVariableMixin:
    ...
  
  def assign_add(self, delta, use_locking=..., name=..., read_value=...): # -> Self@ShardedVariableMixin:
    ...
  
  def assign_sub(self, delta, use_locking=..., name=..., read_value=...): # -> Self@ShardedVariableMixin:
    ...
  
  def scatter_add(self, sparse_delta, use_locking=..., name=...): # -> Self@ShardedVariableMixin:
    """Implements tf.Variable.scatter_add."""
    ...
  
  def scatter_div(self, sparse_delta, use_locking=..., name=...): # -> Self@ShardedVariableMixin:
    """Implements tf.Variable.scatter_div."""
    ...
  
  def scatter_max(self, sparse_delta, use_locking=..., name=...): # -> Self@ShardedVariableMixin:
    """Implements tf.Variable.scatter_max."""
    ...
  
  def scatter_min(self, sparse_delta, use_locking=..., name=...): # -> Self@ShardedVariableMixin:
    """Implements tf.Variable.scatter_min."""
    ...
  
  def scatter_mul(self, sparse_delta, use_locking=..., name=...): # -> Self@ShardedVariableMixin:
    """Implements tf.Variable.scatter_mul."""
    ...
  
  def scatter_sub(self, sparse_delta, use_locking=..., name=...): # -> Self@ShardedVariableMixin:
    """Implements tf.Variable.scatter_sub."""
    ...
  
  def scatter_update(self, sparse_delta, use_locking=..., name=...): # -> Self@ShardedVariableMixin:
    """Implements tf.Variable.scatter_update."""
    ...
  
  def batch_scatter_update(self, sparse_delta, use_locking=..., name=...): # -> Self@ShardedVariableMixin:
    """Implements tf.Variable.batch_scatter_update."""
    ...
  
  def sparse_read(self, indices, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def embedding_lookup(params, ids, partition_strategy=..., name=..., validate_indices=..., max_norm=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | IndexedSlices:
  ...
