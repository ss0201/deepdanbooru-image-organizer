...
def aggregate_gradients_using_nccl(replica_grads): # -> list[tuple[Unknown]]:
  """Aggregate gradients using nccl allreduce."""
  ...

def aggregate_gradients_using_hierarchical_copy(avail_devices, replica_grads): # -> list[tuple[Unknown]]:
...
def aggregate_single_gradient_using_copy(grad_and_vars, use_mean, check_inf_nan): # -> tuple[tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor, Unknown], Unknown] | tuple[tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor, Unknown], None]:
...
class CollectiveKeys:
  ...
  *Instance key*: an integer key to identify the set of same counterpart of
  ...
  def get_group_key(self, devices): # -> int:
...
def aggregate_tensors_or_indexed_slices(values, accumulation_fn=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor | IndexedSlices | None:
...
def copy_tensor_or_indexed_slices_to_device(value, device): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def split_by_sparsity(values): # -> tuple[list[Unknown], list[Unknown], list[Unknown], list[Unknown]]:
...
def group_by_size(input_tensors, bytes_per_pack): # -> list[Unknown]:
