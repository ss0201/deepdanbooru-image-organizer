...
class DistributedVariableTraceType(trace.TraceType):
  ...
  def most_specific_common_supertype(self, others): # -> Self@DistributedVariableTraceType | None:
    ...
...
class DistributedVariable(DistributedDelegate, variables_lib.Variable, core.Tensor):
  ...
  def __deepcopy__(self, memo): # -> Self@DistributedVariable:
  ...
  def is_initialized(self, name=...): # -> _dispatcher_for_logical_and | object:
  ...
  @property
  def initializer(self): # -> _dispatcher_for_no_op | object | None:
    ...
  ...
  def __tf_experimental_restore_capture__(self, concrete_function, internal_capture): # -> Self@DistributedVariable:
    ...
...
class SyncOnReadVariable(DistributedVariable):
  ...
  def assign_sub(self, value, use_locking=..., name=..., read_value=...): # -> _dispatcher_for_no_op | object | None:
    ...
  
  def assign_add(self, value, use_locking=..., name=..., read_value=...): # -> _dispatcher_for_no_op | object | None:
    ...
  
  def assign(self, value, use_locking=..., name=..., read_value=...): # -> _dispatcher_for_no_op | object | None:
    ...
...
class OnReadPolicy(VariablePolicy):
  ...
  def assign_sub(self, var, value, use_locking=..., name=..., read_value=...): # -> _dispatcher_for_no_op | object | None:
    """Subtracts a value from this variable."""
    ...
  
  def assign_add(self, var, value, use_locking=..., name=..., read_value=...): # -> _dispatcher_for_no_op | object | None:
    """Adds a value to this variable."""
    ...
  
  def assign(self, var, value, use_locking=..., name=..., read_value=...): # -> _dispatcher_for_no_op | object | None:
    ...
  ...
  def get_saveable(self, var, primary_var, name): # -> tuple[() -> Unknown, list[SaveSpec]]:
    """Create a saveable object for the given variable."""
    ...
  
  def get_restore_ops(self, var, tensor): # -> _dispatcher_for_no_op | object | None:
    """Restore the same value into all variables."""
    ...
...
class OnWritePolicy(VariablePolicy):
  ...
  def get_saveable(self, var, primary_var, name): # -> tuple[() -> (Unknown | None), list[SaveSpec]]:
