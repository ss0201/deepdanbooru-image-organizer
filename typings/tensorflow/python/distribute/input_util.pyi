...
def get_distributed_dataset(dataset, input_workers, strategy, num_replicas_in_sync=..., input_context=..., options=..., build=...): # -> DistributedDataset | DistributedDatasetV1:
...
def get_distributed_datasets_from_function(dataset_fn, input_workers, input_contexts, strategy, options=..., build=...): # -> DistributedDatasetsFromFunction | DistributedDatasetsFromFunctionV1:
