...
def reduce_non_distributed_value(reduce_op, value, destinations, num_replicas_in_graph, canonicalize_devices=...): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica | Literal[0]:
  """Reduce a non-DistributedValue `value` to `destinations`."""
  ...

def get_devices_from(destinations, canonicalize_devices=...): # -> tuple[Unknown, ...] | tuple[Unknown | LiteralString | str]:
  ...

def simple_broadcast(value, destinations, always_mirrored=..., canonicalize_devices=...): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica:
...
class CrossDeviceOps:
  ...
  * `tf.distribute.HierarchicalCopyAllReduce`
  ...
  def reduce(self, reduce_op, per_replica_value, destinations, options=...): # -> list[Unknown] | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica:
  ...
  def batch_reduce(self, reduce_op, value_destination_pairs, options=...): # -> list[list[Unknown] | Unknown | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica]:
  ...
  def broadcast(self, tensor, destinations): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica:
  ...
  @doc_controls.for_subclass_implementers
  def broadcast_implementation(self, tensor, destinations): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica:
...
class ReductionToOneDevice(CrossDeviceOps):
  ...
  def reduce_implementation(self, reduce_op, per_replica_value, destinations, options): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica:
    ...
  
  def batch_reduce_implementation(self, reduce_op, value_destination_pairs, options): # -> list[IndexedSlices | Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica]:
    ...
...
class _ConcatAndSplitPacker:
  ...
  def pack(self, grouped_grads_and_vars): # -> list[Unknown]:
    """Pack tensors."""
    ...
  
  def unpack(self, summed_device_grad_packs): # -> list[Unknown]:
    """Reverse the pack."""
    ...
...
class AllReduceCrossDeviceOps(CrossDeviceOps):
  ...
  def reduce_implementation(self, reduce_op, per_replica_value, destinations, options): # -> list[Unknown] | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica | None:
    ...
  
  def batch_reduce_implementation(self, reduce_op, value_destination_pairs, options): # -> list[None] | list[list[Unknown] | Unknown | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica | None]:
    ...
...
class CollectiveAllReduce(CrossDeviceOps):
  ...
  def reduce_implementation(self, reduce_op, per_replica_value, destinations, options): # -> list[Unknown] | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica:
    ...
  
  def batch_reduce_implementation(self, reduce_op, value_destination_pairs, options): # -> list[Unknown | list[Unknown] | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica]:
    ...
