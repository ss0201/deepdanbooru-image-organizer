...
class TPUStrategyV2(distribute_lib.Strategy):
  ...
  def experimental_assign_to_logical_device(self, tensor, logical_device_id): # -> _dispatcher_for_xla_sharding | object:
  ...
  def experimental_split_to_logical_devices(self, tensor, partition_dimensions): # -> _dispatcher_for_xla_sharding | object:
  ...
  def experimental_replicate_to_logical_devices(self, tensor): # -> _dispatcher_for_xla_sharding | object:
...
class TPUExtended(distribute_lib.StrategyExtendedV1):
  ...
  def read_var(self, var): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
  ...
  def tpu_run(self, fn, args, kwargs, options=...): # -> list[Unknown] | tuple[Unknown, ...] | Mapping[Unknown, Unknown] | DistributedVariable | PerReplica | None:
    ...
...
class _TPUReplicaContext(distribute_lib.ReplicaContext):
  ...
  @property
  def devices(self): # -> tuple[Text] | tuple[Unknown]:
    ...
  ...
  def all_gather(self, value, axis, experimental_hints=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
