...
def getnamespace(f): # -> dict[str, Any]:
...
def getqualifiedname(namespace, object_, max_depth=..., visited=...): # -> LiteralString | None:
...
def getmethodclass(m): # -> type | Any | None:
...
def getfutureimports(entity): # -> tuple[Unknown, ...]:
