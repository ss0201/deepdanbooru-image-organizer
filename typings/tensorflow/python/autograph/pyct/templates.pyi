...
class ReplaceTransformer(gast.NodeTransformer):
  ...
  def visit_keyword(self, node): # -> AST | list[AST | Unknown] | list[Unknown] | tuple[Unknown, ...]:
    ...
  ...
  def visit_Name(self, node): # -> Name | list[AST | Unknown] | list[Unknown] | tuple[Unknown, ...] | AST:
    ...
