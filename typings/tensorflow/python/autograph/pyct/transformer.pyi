...
class _StateStack:
  ...
  def __enter__(self): # -> Self@_StateStack:
    ...
...
class NodeStateTracker:
  ...
  def visit_block(self, nodes, before_visit=..., after_visit=...): # -> list[Unknown] | None:
...
class Base(NodeStateTracker, gast.NodeTransformer):
  ...
  def visit(self, node): # -> AST | list[Unknown] | tuple[Unknown, ...] | Any:
    ...
