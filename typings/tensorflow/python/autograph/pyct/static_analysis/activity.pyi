...
class Scope:
  ...
  @property
  def enclosing_scope(self): # -> Self@Scope:
    ...
  
  @property
  def referenced(self): # -> set[Unknown]:
    ...
  
  @property
  def free_vars(self): # -> set[Unknown]:
    ...
  ...
  @classmethod
  def copy_of(cls, other): # -> Self@Scope:
    ...
...
def resolve(node, context, parent_scope=...): # -> AST | list[Unknown] | tuple[Unknown, ...] | Any:
  ...
