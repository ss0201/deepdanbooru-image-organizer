...
def new_list(iterable=...): # -> list[Unknown]:
...
def tf_tensor_list_new(elements, element_dtype=..., element_shape=...):
  """Overload of new_list that stages a Tensor list creation."""
  ...

def list_append(list_, x): # -> TensorArray:
...
def list_pop(list_, i, opts): # -> tuple[Unknown, Unknown]:
...
def list_stack(list_, opts): # -> Tensor | Any:
