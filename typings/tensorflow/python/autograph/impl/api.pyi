...
class _ErrorMetadata(error_utils.ErrorMetadataBase):
  ...
  def create_exception(self, source_error): # -> OpError | Any | MultilineMessageKeyError | StagingError:
    ...
...
class PyToTF(transpiler.PyToPy):
  ...
  def get_extra_locals(self): # -> dict[str, Unknown]:
    ...
  
  def get_caching_key(self, ctx):
    ...
  
  def initial_analysis(self, node, ctx): # -> AST | list[Unknown] | tuple[Unknown, ...] | Any:
    ...
  
  def transform_ast(self, node, ctx): # -> AST | list[Unknown] | tuple[Unknown, ...] | Any:
    ...
...
def tf_convert(f, ctx, convert_by_default=..., user_requested=...): # -> MethodType | ((func: Unknown | None = None) -> (... | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown))) | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
...
def call_with_unspecified_conversion_status(func): # -> MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
  """Decorator that resets the conversion context to the unspecified status."""
  ...

@tf_export('autograph.experimental.do_not_convert')
def do_not_convert(func=...): # -> ((func: Unknown | None = None) -> ...) | MethodType | ((*args: Unknown, **kwargs: Unknown) -> Unknown):
...
def convert(recursive=..., optional_features=..., user_requested=..., conversion_ctx=...): # -> (f: Unknown) -> (MethodType | Unknown):
