...
class Cluster:
  ...
  @property
  def tf_cluster(self): # -> None:
    ...
  
  def ListDevices(self): # -> list[Unknown]:
  ...
  def MeasureCosts(self, item): # -> tuple[list[Unknown], Unknown, Unknown]:
...
def Provision(allow_soft_placement=..., disable_detailed_stats=..., disable_timeline=..., devices=...): # -> Generator[Cluster, None, None]:
  ...
