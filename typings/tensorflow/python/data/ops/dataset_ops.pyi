...
class DatasetV2(collections_abc.Iterable, tracking_base.Trackable, composite_tensor.CompositeTensor):
  ...
  **Component**: The leaf in the nested structure of an element.
  ...
  def as_numpy_iterator(self): # -> _NumpyIterator:
  ...
  @staticmethod
  def from_tensors(tensors, name=...): # -> TensorDataset:
  ...
  @staticmethod
  def from_tensor_slices(tensors, name=...): # -> TensorSliceDataset:
  ...
  class _GeneratorState:
    ...
    def get_next_id(self, *args): # -> ndarray[Unknown, Unknown]:
      ...
  ...
  def from_generator(generator, output_types=..., output_shapes=..., args=..., output_signature=..., name=...): # -> FlatMapDataset | DatasetV1Adapter:
  ...
  @staticmethod
  def range(*args, **kwargs): # -> RangeDataset:
  ...
  @staticmethod
  def zip(datasets, name=...): # -> ZipDataset:
  ...
  def concatenate(self, dataset, name=...): # -> ConcatenateDataset:
  ...
  def prefetch(self, buffer_size, name=...): # -> Self@DatasetV2 | PrefetchDataset:
  ...
  @staticmethod
  def list_files(file_pattern, shuffle=..., seed=..., name=...): # -> DatasetV1Adapter | ShuffleDataset | TensorSliceDataset:
  ...
  def repeat(self, count=..., name=...): # -> RepeatDataset:
  ...
  def enumerate(self, start=..., name=...): # -> ZipDataset | DatasetV1Adapter:
  ...
  def shuffle(self, buffer_size, seed=..., reshuffle_each_iteration=..., name=...): # -> ShuffleDataset:
  ...
  def cache(self, filename=..., name=...): # -> CacheDataset:
  ...
  def take(self, count, name=...): # -> TakeDataset:
  ...
  def skip(self, count, name=...): # -> SkipDataset:
  ...
  def shard(self, num_shards, index, name=...): # -> ShardDataset:
  ...
  def batch(self, batch_size, drop_remainder=..., num_parallel_calls=..., deterministic=..., name=...): # -> BatchDataset | ParallelBatchDataset:
  ...
  def padded_batch(self, batch_size, padded_shapes=..., padding_values=..., drop_remainder=..., name=...): # -> PaddedBatchDataset:
  ...
  def map(self, map_func, num_parallel_calls=..., deterministic=..., name=...): # -> MapDataset | ParallelMapDataset:
...
name=None))
  ...
  def flat_map(self, map_func, name=...): # -> FlatMapDataset:
  ...
  def interleave(self, map_func, cycle_length=..., block_length=..., num_parallel_calls=..., deterministic=..., name=...): # -> InterleaveDataset | ParallelInterleaveDataset:
  ...
  def filter(self, predicate, name=...): # -> FilterDataset:
  ...
  def window(self, size, shift=..., stride=..., drop_remainder=..., name=...): # -> WindowDataset:
  ...
  def reduce(self, initial_state, reduce_func, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def get_single_element(self, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def unbatch(self, name=...): # -> _UnbatchDataset:
  ...
  def with_options(self, options, name=...): # -> _OptionsDataset:
  ...
  def group_by_window(self, key_func, reduce_func, window_size=..., window_size_func=..., name=...): # -> _GroupByWindowDataset:
  ...
  def bucket_by_sequence_length(self, element_length_func, bucket_boundaries, bucket_batch_sizes, padded_shapes=..., padding_values=..., pad_to_bucket_boundary=..., no_padding=..., drop_remainder=..., name=...): # -> _GroupByWindowDataset:
  ...
  @staticmethod
  def random(seed=..., name=...): # -> RandomDataset:
  ...
  def snapshot(self, path, compression=..., reader_func=..., shard_func=..., name=...): # -> MapDataset | ParallelMapDataset | _SnapshotDataset:
  ...
  def scan(self, initial_state, scan_func, name=...): # -> _ScanDataset:
  ...
  def take_while(self, predicate, name=...): # -> _TakeWhileDataset:
  ...
  def unique(self, name=...): # -> _UniqueDataset:
  ...
  def rejection_resample(self, class_func, target_dist, initial_dist=..., seed=..., name=...): # -> MapDataset | ParallelMapDataset | PrefetchDataset | _DirectedInterleaveDataset:
  ...
  @staticmethod
  def sample_from_datasets(datasets, weights=..., seed=..., stop_on_empty_dataset=...): # -> _DirectedInterleaveDataset:
  ...
  @staticmethod
  def choose_from_datasets(datasets, choice_dataset, stop_on_empty_dataset=...): # -> _DirectedInterleaveDataset:
...
class DatasetV1(DatasetV2):
  ...
  def make_one_shot_iterator(self): # -> OwnedIterator | Iterator:
    """Creates an iterator for elements of this dataset.
  ...
  def make_initializable_iterator(self, shared_name=...): # -> Iterator:
    """Creates an iterator for elements of this dataset.
  ...
  def zip(datasets, name=...): # -> DatasetV1Adapter:
    ...
  ...
  def map(self, map_func, num_parallel_calls=..., deterministic=..., name=...): # -> DatasetV1Adapter:
    ...
  
  @deprecation.deprecated(None, "Use `tf.data.Dataset.map()")
  def map_with_legacy_function(self, map_func, num_parallel_calls=..., deterministic=...): # -> DatasetV1Adapter:
    """Maps `map_func` across the elements of this dataset.
  ...
  def filter_with_legacy_function(self, predicate): # -> FilterDataset:
    """Filters this dataset according to `predicate`.
...
def make_one_shot_iterator(dataset): # -> OwnedIterator | Iterator:
...
def make_initializable_iterator(dataset, shared_name=...): # -> Iterator:
  """Creates an iterator for elements of `dataset`.
...
def get_legacy_output_classes(dataset_or_iterator): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def get_legacy_output_shapes(dataset_or_iterator): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def get_legacy_output_types(dataset_or_iterator): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  """Returns the output shapes for elements of the input dataset / iterator.
...
class _NumpyIterator:
  ...
  def __iter__(self): # -> Self@_NumpyIterator:
    ...
...
class TensorDataset(DatasetSource):
  ...
  @property
  def element_spec(self): # -> TypeSpec | defaultdict[Unknown, Unknown] | Mapping[Unknown, Unknown] | Any | tuple[Unknown, ...]:
    ...
...
class SparseTensorSliceDataset(DatasetSource):
  ...
  @property
  def element_spec(self): # -> tuple[TypeSpec, TypeSpec, TypeSpec]:
    ...
...
class ShuffleDataset(UnaryUnchangedStructureDataset):
  ...
  def __init__(self, input_dataset, buffer_size, seed=..., reshuffle_each_iteration=..., name=...) -> None:
...
class MapDataset(UnaryDataset):
  ...
  def __init__(self, input_dataset, map_func, use_inter_op_parallelism=..., preserve_cardinality=..., use_legacy_function=..., name=...) -> None:
...
class ParallelMapDataset(UnaryDataset):
  ...
  def __init__(self, input_dataset, map_func, num_parallel_calls, deterministic, use_inter_op_parallelism=..., preserve_cardinality=..., use_legacy_function=..., name=...) -> None:
    """See `Dataset.map()` for details."""
    ...
...
class WindowDataset(UnaryDataset):
  ...
  @property
  def element_spec(self): # -> DatasetSpec | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    ...
...
def normalize_to_dense(dataset): # -> _RestructuredDataset:
