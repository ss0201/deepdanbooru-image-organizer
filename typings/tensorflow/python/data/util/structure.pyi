...
def normalize_element(element, element_signature=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def convert_legacy_structure(output_types, output_shapes, output_classes): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def from_compatible_tensor_list(element_spec, tensor_list): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def from_tensor_list(element_spec, tensor_list): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  """Returns an element constructed from the given spec and tensor list.
...
def get_flat_tensor_specs(element_spec): # -> list[Unknown]:
...
def get_flat_tensor_shapes(element_spec): # -> list[Unknown]:
...
def get_flat_tensor_types(element_spec): # -> list[Unknown]:
...
def to_batched_tensor_list(element_spec, element): # -> list[Unknown]:
...
def to_tensor_list(element_spec, element): # -> list[Unknown]:
  """Returns a tensor list representation of the element.
...
def type_spec_from_value(element, use_fallback=...): # -> TypeSpec | defaultdict[Unknown, Unknown] | Mapping[Unknown, Unknown] | Any | tuple[Unknown, ...]:
...
class NoneTensorSpec(type_spec.BatchableTypeSpec):
  ...
  def most_specific_compatible_shape(self, other): # -> Self@NoneTensorSpec:
    ...
