...
def map_structure(func, *structure, **check_types_dict): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def flatten_up_to(shallow_tree, input_tree): # -> list[Unknown]:
...
def map_structure_up_to(shallow_tree, func, *inputs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
