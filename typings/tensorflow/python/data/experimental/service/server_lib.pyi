...
class DispatcherConfig(collections.namedtuple("DispatcherConfig", ["port", "protocol", "work_dir", "fault_tolerant_mode", "worker_addresses", "job_gc_check_interval_ms", "job_gc_timeout_ms"])):
  ...
  """
  def __new__(cls, port=..., protocol=..., work_dir=..., fault_tolerant_mode=..., worker_addresses=..., job_gc_check_interval_ms=..., job_gc_timeout_ms=...): # -> Self@DispatcherConfig:
    ...
...
class WorkerConfig(collections.namedtuple("WorkerConfig", ["dispatcher_address", "worker_address", "port", "protocol", "heartbeat_interval_ms", "dispatcher_timeout_ms"])):
  """Configuration class for tf.data service dispatchers.
  ...
  """
  def __new__(cls, dispatcher_address, worker_address=..., port=..., protocol=..., heartbeat_interval_ms=..., dispatcher_timeout_ms=...): # -> Self@WorkerConfig:
    ...
