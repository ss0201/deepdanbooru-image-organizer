...
def dense_to_ragged_batch(batch_size, drop_remainder=..., row_splits_dtype=...): # -> (dataset: Unknown) -> BatchDataset:
...
def dense_to_sparse_batch(batch_size, row_shape): # -> (dataset: Unknown) -> _DenseToSparseBatchDataset:
...
def map_and_batch_with_legacy_function(map_func, batch_size, num_parallel_batches=..., drop_remainder=..., num_parallel_calls=...): # -> (dataset: Unknown) -> _MapAndBatchDataset:
...
def map_and_batch(map_func, batch_size, num_parallel_batches=..., drop_remainder=..., num_parallel_calls=...): # -> (dataset: Unknown) -> _MapAndBatchDataset:
  """Fused implementation of `map` and `batch`.
...
def unbatch(): # -> (dataset: Unknown) -> Unknown:
...
class _DenseToRaggedDataset(dataset_ops.UnaryDataset):
  ...
  * Any other elements are left as-is.
  """
  def __init__(self, input_dataset, row_splits_dtype) -> None:
