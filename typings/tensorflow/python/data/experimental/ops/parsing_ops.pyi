...
class _ParseExampleDataset(dataset_ops.UnaryDataset):
  ...
  @property
  def element_spec(self): # -> dict[Unknown, Unknown]:
    ...
  


@tf_export("data.experimental.parse_example_dataset")
def parse_example_dataset(features, num_parallel_calls=..., deterministic=...): # -> (dataset: Unknown) -> (MapDataset | ParallelMapDataset | _ParseExampleDataset):
