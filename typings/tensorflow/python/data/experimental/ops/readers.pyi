...
def make_tf_record_dataset(file_pattern, batch_size, parser_fn=..., num_epochs=..., shuffle=..., shuffle_buffer_size=..., shuffle_seed=..., prefetch_buffer_size=..., num_parallel_reads=..., num_parallel_parser_calls=..., drop_final_batch=...): # -> DatasetV1Adapter:
...
def make_csv_dataset_v2(file_pattern, batch_size, column_names=..., column_defaults=..., label_name=..., select_columns=..., field_delim=..., use_quote_delim=..., na_value=..., header=..., num_epochs=..., shuffle=..., shuffle_buffer_size=..., shuffle_seed=..., prefetch_buffer_size=..., num_parallel_reads=..., sloppy=..., num_rows_for_inference=..., compression_type=..., ignore_errors=...):
...
class CsvDatasetV2(dataset_ops.DatasetSource):
  ...
  @property
  def element_spec(self): # -> tuple[TypeSpec, ...]:
    ...
...
def make_batched_features_dataset_v2(file_pattern, batch_size, features, reader=..., label_key=..., reader_args=..., num_epochs=..., shuffle=..., shuffle_buffer_size=..., shuffle_seed=..., prefetch_buffer_size=..., reader_num_threads=..., parser_num_threads=..., sloppy_ordering=..., drop_final_batch=...): # -> MapDataset | PrefetchDataset | ParallelMapDataset | DatasetV1Adapter | DatasetV2:
