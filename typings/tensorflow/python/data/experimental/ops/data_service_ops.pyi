...
def distribute(processing_mode, service, job_name=..., consumer_index=..., num_consumers=..., max_outstanding_requests=..., data_transfer_protocol=..., compression=..., cross_trainer_cache=..., target_workers=...): # -> (dataset: Unknown) -> (_OptionsDataset | DatasetV1Adapter | _DataServiceDatasetV2 | _DataServiceDatasetV1):
...
def register_dataset(service, dataset, compression=..., dataset_id=...):
...
def from_dataset_id(processing_mode, service, dataset_id, element_spec=..., job_name=..., consumer_index=..., num_consumers=..., max_outstanding_requests=..., data_transfer_protocol=..., cross_trainer_cache=..., target_workers=...): # -> _OptionsDataset | DatasetV1Adapter | _DataServiceDatasetV2 | _DataServiceDatasetV1:
