...
def parallel_interleave(map_func, cycle_length, block_length=..., sloppy=..., buffer_output_elements=..., prefetch_input_elements=...): # -> (dataset: Unknown) -> ParallelInterleaveDataset:
...
def sample_from_datasets_v2(datasets, weights=..., seed=..., stop_on_empty_dataset=...): # -> _DirectedInterleaveDataset:
...
def choose_from_datasets_v2(datasets, choice_dataset, stop_on_empty_dataset=...): # -> _DirectedInterleaveDataset:
