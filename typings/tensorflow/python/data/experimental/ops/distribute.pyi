...
class _RebatchDataset(dataset_ops.UnaryDataset):
  ...
  ```
  """
  def __init__(self, input_dataset, batch_sizes, drop_remainder=...) -> None:
...
def replicate(dataset, devices): # -> dict[Unknown, Unknown]:
...
def batch_sizes_for_worker(global_batch_size, num_workers, num_replicas_per_worker, worker_index): # -> Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
