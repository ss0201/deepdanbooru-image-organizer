...
def prefetch_to_device(device, buffer_size=...): # -> (dataset: Unknown) -> Unknown:
...
def copy_to_device(target_device, source_device=...): # -> (dataset: Unknown) -> _CopyToDeviceDataset:
...
def map_on_gpu(map_func): # -> (dataset: Unknown) -> _MapOnGpuDataset:
