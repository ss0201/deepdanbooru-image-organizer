...
def composite_tensor_to_variants(value, type_spec=..., name=...):
...
def composite_tensor_from_variant(encoded, type_spec, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
