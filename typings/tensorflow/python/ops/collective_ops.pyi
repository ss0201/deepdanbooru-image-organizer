...
def all_reduce(t, group_size, group_key, instance_key, merge_op=..., final_op=..., subdiv_offsets=..., communication_hint=..., timeout=...):
...
def assign_group_v2(group_assignment, device_index, base_key): # -> tuple[Unknown, Unknown]:
...
def all_reduce_v2(t, group_size, group_key, instance_key, merge_op=..., final_op=..., communication_hint=..., timeout=..., ordering_token=..., max_subdivs_per_device=..., name=...):
  """Reduces tensors collectively, across devices.
...
def all_gather(t, group_size, group_key, instance_key, communication_hint=..., timeout=...):
...
def all_gather_v2(t, group_size, group_key, instance_key, communication_hint=..., timeout=..., ordering_token=..., name=...):
  """Accumulates tensors collectively, across devices, along first dimension.
...
def broadcast_send(t, shape, dtype, group_size, group_key, instance_key, communication_hint=..., timeout=...):
...
def broadcast_send_v2(t, group_size, group_key, instance_key, communication_hint=..., timeout=...):
  """Broadcasts one tensor to a group of others, across devices.
...
def broadcast_recv(shape, dtype, group_size, group_key, instance_key, communication_hint=..., timeout=...):
...
def broadcast_recv_v2(shape, dtype, group_size, group_key, instance_key, communication_hint=..., timeout=...):
  """Receives a broadcasts tensor, across devices.
...
def initialize_communicator(group_key, rank, group_size, communication_hint=..., timeout_seconds=...):
...
def all_reduce_v3(communicator, t, reduction=..., group_assignment=..., timeout_seconds=...):
...
def all_to_all_v3(communicator, t, group_assignment=..., timeout_seconds=...):
