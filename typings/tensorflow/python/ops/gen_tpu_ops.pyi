...
"""
def all_to_all(input, group_assignment, concat_dimension, split_dimension, split_count, name=...):
...
def assign_variable_xla_concat_nd_eager_fallback(resource, inputs, num_concats, paddings, name, ctx): # -> None:
  ...

def collective_permute(input, source_target_pairs, name=...):
...
def configure_distributed_tpu(embedding_config=..., tpu_embedding_config=..., is_global_init=..., enable_whole_mesh_compilations=..., compilation_failure_closes_chips=..., tpu_cancellation_closes_chips=..., name=...):
...
def configure_tpu_embedding_eager_fallback(config, name, ctx): # -> None:
  ...

def cross_replica_sum(input, group_assignment, name=...):
...
def dynamic_enqueue_tpu_embedding_arbitrary_tensor_batch_eager_fallback(sample_indices_or_row_splits, embedding_indices, aggregation_weights, mode_override, device_ordinal, combiners, name, ctx): # -> None:
  ...

def enqueue_tpu_embedding_arbitrary_tensor_batch(sample_indices_or_row_splits, embedding_indices, aggregation_weights, mode_override, device_ordinal=..., combiners=..., name=...): # -> None:
  r"""Eases the porting of code that uses tf.nn.embedding_lookup_sparse().
...
def enqueue_tpu_embedding_arbitrary_tensor_batch_eager_fallback(sample_indices_or_row_splits, embedding_indices, aggregation_weights, mode_override, device_ordinal, combiners, name, ctx): # -> None:
  ...

def enqueue_tpu_embedding_integer_batch(batch, mode_override, device_ordinal=..., name=...): # -> None:
...
def enqueue_tpu_embedding_integer_batch_eager_fallback(batch, mode_override, device_ordinal, name, ctx): # -> None:
  ...

def enqueue_tpu_embedding_ragged_tensor_batch(sample_splits, embedding_indices, aggregation_weights, mode_override, table_ids, device_ordinal=..., combiners=..., max_sequence_lengths=..., num_features=..., name=...): # -> None:
...
def enqueue_tpu_embedding_ragged_tensor_batch_eager_fallback(sample_splits, embedding_indices, aggregation_weights, mode_override, table_ids, device_ordinal, combiners, max_sequence_lengths, num_features, name, ctx): # -> None:
  ...

def enqueue_tpu_embedding_sparse_batch(sample_indices, embedding_indices, aggregation_weights, mode_override, device_ordinal=..., combiners=..., name=...): # -> None:
...
def enqueue_tpu_embedding_sparse_batch_eager_fallback(sample_indices, embedding_indices, aggregation_weights, mode_override, device_ordinal, combiners, name, ctx): # -> None:
  ...

def enqueue_tpu_embedding_sparse_tensor_batch(sample_indices, embedding_indices, aggregation_weights, mode_override, table_ids, device_ordinal=..., combiners=..., max_sequence_lengths=..., num_features=..., name=...): # -> None:
  r"""Eases the porting of code that uses tf.nn.embedding_lookup_sparse().
...
def enqueue_tpu_embedding_sparse_tensor_batch_eager_fallback(sample_indices, embedding_indices, aggregation_weights, mode_override, table_ids, device_ordinal, combiners, max_sequence_lengths, num_features, name, ctx): # -> None:
  ...

def infeed_dequeue(dtype, shape, name=...):
...
def infeed_dequeue_tuple(dtypes, shapes, name=...):
...
def infeed_enqueue(input, shape=..., layout=..., device_ordinal=..., name=...): # -> None:
...
InfeedEnqueue = ...
def infeed_enqueue_eager_fallback(input, shape, layout, device_ordinal, name, ctx): # -> None:
  ...

def infeed_enqueue_prelinearized_buffer(input, device_ordinal=..., name=...): # -> None:
...
def infeed_enqueue_prelinearized_buffer_eager_fallback(input, device_ordinal, name, ctx): # -> None:
  ...

def infeed_enqueue_tuple(inputs, shapes, layouts=..., device_ordinal=..., name=...): # -> None:
...
InfeedEnqueueTuple = ...
def infeed_enqueue_tuple_eager_fallback(inputs, shapes, layouts, device_ordinal, name, ctx): # -> None:
  ...

def is_tpu_embedding_initialized(config=..., name=...):
...
def load_tpu_embedding_adam_parameters(parameters, momenta, velocities, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_adam_parameters_eager_fallback(parameters, momenta, velocities, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_adadelta_parameters(parameters, accumulators, updates, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_adadelta_parameters_eager_fallback(parameters, accumulators, updates, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_adagrad_momentum_parameters(parameters, accumulators, momenta, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_adagrad_momentum_parameters_eager_fallback(parameters, accumulators, momenta, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_adagrad_parameters(parameters, accumulators, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_adagrad_parameters_eager_fallback(parameters, accumulators, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_centered_rms_prop_parameters(parameters, ms, mom, mg, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_centered_rms_prop_parameters_eager_fallback(parameters, ms, mom, mg, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_ftrl_parameters(parameters, accumulators, linears, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_ftrl_parameters_eager_fallback(parameters, accumulators, linears, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_frequency_estimator_parameters(parameters, last_hit_step, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_frequency_estimator_parameters_eager_fallback(parameters, last_hit_step, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_mdl_adagrad_light_parameters(parameters, accumulators, weights, benefits, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_mdl_adagrad_light_parameters_eager_fallback(parameters, accumulators, weights, benefits, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_momentum_parameters(parameters, momenta, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_momentum_parameters_eager_fallback(parameters, momenta, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_proximal_adagrad_parameters(parameters, accumulators, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_proximal_adagrad_parameters_eager_fallback(parameters, accumulators, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_proximal_yogi_parameters(parameters, v, m, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
  r"""TODO: add doc.
...
def load_tpu_embedding_proximal_yogi_parameters_eager_fallback(parameters, v, m, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_rms_prop_parameters(parameters, ms, mom, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_rms_prop_parameters_eager_fallback(parameters, ms, mom, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def load_tpu_embedding_stochastic_gradient_descent_parameters(parameters, num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> None:
...
def load_tpu_embedding_stochastic_gradient_descent_parameters_eager_fallback(parameters, num_shards, shard_id, table_id, table_name, config, name, ctx): # -> None:
  ...

def outfeed_dequeue(dtype, shape, device_ordinal=..., name=...):
...
def outfeed_dequeue_tuple(dtypes, shapes, device_ordinal=..., name=...):
...
def outfeed_dequeue_tuple_v2(device_ordinal, dtypes, shapes, name=...):
...
def outfeed_dequeue_v2(device_ordinal, dtype, shape, name=...):
...
OutfeedEnqueue = ...
def outfeed_enqueue_eager_fallback(input, name, ctx): # -> None:
  ...
...
def prelinearize(input, shape=..., layout=..., name=...):
...
def prelinearize_tuple(inputs, shapes, layouts=..., name=...):
...
def read_variable_xla_split_nd(resource, T, N, num_splits, paddings=..., name=...):
...
def recv_tpu_embedding_activations(num_outputs, config, name=...):
...
def retrieve_tpu_embedding_adam_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingADAMParameters:
...
def retrieve_tpu_embedding_adam_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingADAMParameters:
  ...

_RetrieveTPUEmbeddingAdadeltaParametersOutput = ...
def retrieve_tpu_embedding_adadelta_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingAdadeltaParameters:
...
def retrieve_tpu_embedding_adadelta_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingAdadeltaParameters:
  ...

_RetrieveTPUEmbeddingAdagradMomentumParametersOutput = ...
def retrieve_tpu_embedding_adagrad_momentum_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingAdagradMomentumParameters:
...
def retrieve_tpu_embedding_adagrad_momentum_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingAdagradMomentumParameters:
  ...

_RetrieveTPUEmbeddingAdagradParametersOutput = ...
def retrieve_tpu_embedding_adagrad_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingAdagradParameters:
...
def retrieve_tpu_embedding_adagrad_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingAdagradParameters:
  ...

_RetrieveTPUEmbeddingCenteredRMSPropParametersOutput = ...
def retrieve_tpu_embedding_centered_rms_prop_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingCenteredRMSPropParameters:
...
def retrieve_tpu_embedding_centered_rms_prop_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingCenteredRMSPropParameters:
  ...

_RetrieveTPUEmbeddingFTRLParametersOutput = ...
def retrieve_tpu_embedding_ftrl_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingFTRLParameters:
...
def retrieve_tpu_embedding_ftrl_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingFTRLParameters:
  ...

_RetrieveTPUEmbeddingFrequencyEstimatorParametersOutput = ...
def retrieve_tpu_embedding_frequency_estimator_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingFrequencyEstimatorParameters:
...
def retrieve_tpu_embedding_frequency_estimator_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingFrequencyEstimatorParameters:
  ...

_RetrieveTPUEmbeddingMDLAdagradLightParametersOutput = ...
def retrieve_tpu_embedding_mdl_adagrad_light_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingMDLAdagradLightParameters:
...
def retrieve_tpu_embedding_mdl_adagrad_light_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingMDLAdagradLightParameters:
  ...

_RetrieveTPUEmbeddingMomentumParametersOutput = ...
def retrieve_tpu_embedding_momentum_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingMomentumParameters:
...
def retrieve_tpu_embedding_momentum_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingMomentumParameters:
  ...

_RetrieveTPUEmbeddingProximalAdagradParametersOutput = ...
def retrieve_tpu_embedding_proximal_adagrad_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingProximalAdagradParameters:
...
def retrieve_tpu_embedding_proximal_adagrad_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingProximalAdagradParameters:
  ...

_RetrieveTPUEmbeddingProximalYogiParametersOutput = ...
def retrieve_tpu_embedding_proximal_yogi_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingProximalYogiParameters:
  r"""TODO: add doc.
...
def retrieve_tpu_embedding_proximal_yogi_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingProximalYogiParameters:
  ...

_RetrieveTPUEmbeddingRMSPropParametersOutput = ...
def retrieve_tpu_embedding_rms_prop_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...): # -> RetrieveTPUEmbeddingRMSPropParameters:
...
def retrieve_tpu_embedding_rms_prop_parameters_eager_fallback(num_shards, shard_id, table_id, table_name, config, name, ctx): # -> RetrieveTPUEmbeddingRMSPropParameters:
  ...

def retrieve_tpu_embedding_stochastic_gradient_descent_parameters(num_shards, shard_id, table_id=..., table_name=..., config=..., name=...):
...
def send_tpu_embedding_gradients_eager_fallback(inputs, learning_rates, config, name, ctx): # -> None:
  ...
...
def tpu_compilation_result(name=...):
...
def tpu_embedding_activations(embedding_variable, sliced_activations, table_id, lookup_id, name=...):
...
def tpu_partitioned_call(args, device_ordinal, Tout, f, autotuner_thresh=..., name=...):
...
def tpu_replicate_metadata(num_replicas, num_cores_per_replica=..., topology=..., use_tpu=..., device_assignment=..., computation_shape=..., host_compute_core=..., padding_map=..., step_marker_location=..., allow_soft_placement=..., use_spmd_for_xla_partitioning=..., tpu_compile_options_proto=..., name=...): # -> None:
...
def tpu_replicate_metadata_eager_fallback(num_replicas, num_cores_per_replica, topology, use_tpu, device_assignment, computation_shape, host_compute_core, padding_map, step_marker_location, allow_soft_placement, use_spmd_for_xla_partitioning, tpu_compile_options_proto, name, ctx): # -> None:
  ...

def tpu_replicated_input(inputs, is_mirrored_variable=..., index=..., is_packed=..., name=...):
...
def tpu_replicated_output(input, num_replicas, name=...):
...
def worker_heartbeat(request, name=...):
...
def xla_concat_nd(inputs, num_concats, paddings=..., name=...):
  r"""Concats input tensor across all dimensions.
...
def xla_split_nd(input, N, num_splits, paddings=..., name=...):
