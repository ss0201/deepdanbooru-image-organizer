...
"""
_BlockLSTMOutput = ...
def block_lstm(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, forget_bias=..., cell_clip=..., use_peephole=..., name=...): # -> BlockLSTM:
...
BlockLSTM = ...
def block_lstm_eager_fallback(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, forget_bias, cell_clip, use_peephole, name, ctx): # -> BlockLSTM:
  ...

_BlockLSTMGradOutput = ...
def block_lstm_grad(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, h, cs_grad, h_grad, use_peephole, name=...): # -> BlockLSTMGrad:
...
BlockLSTMGrad = ...
def block_lstm_grad_eager_fallback(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, h, cs_grad, h_grad, use_peephole, name, ctx): # -> BlockLSTMGrad:
  ...

_BlockLSTMGradV2Output = ...
def block_lstm_grad_v2(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, h, cs_grad, h_grad, use_peephole, name=...): # -> BlockLSTMGradV2:
  r"""Computes the LSTM cell backward propagation for the entire time sequence.
...
BlockLSTMGradV2 = ...
def block_lstm_grad_v2_eager_fallback(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, h, cs_grad, h_grad, use_peephole, name, ctx): # -> BlockLSTMGradV2:
  ...

_BlockLSTMV2Output = ...
def block_lstmv2(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, cell_clip=..., use_peephole=..., name=...): # -> BlockLSTMV2:
  r"""Computes the LSTM cell forward propagation for all the time steps.
...
BlockLSTMV2 = ...
def block_lstmv2_eager_fallback(seq_len_max, x, cs_prev, h_prev, w, wci, wcf, wco, b, cell_clip, use_peephole, name, ctx): # -> BlockLSTMV2:
  ...

_GRUBlockCellOutput = ...
def gru_block_cell(x, h_prev, w_ru, w_c, b_ru, b_c, name=...): # -> GRUBlockCell:
...
GRUBlockCell = ...
def gru_block_cell_eager_fallback(x, h_prev, w_ru, w_c, b_ru, b_c, name, ctx): # -> GRUBlockCell:
  ...

_GRUBlockCellGradOutput = ...
def gru_block_cell_grad(x, h_prev, w_ru, w_c, b_ru, b_c, r, u, c, d_h, name=...): # -> GRUBlockCellGrad:
...
GRUBlockCellGrad = ...
def gru_block_cell_grad_eager_fallback(x, h_prev, w_ru, w_c, b_ru, b_c, r, u, c, d_h, name, ctx): # -> GRUBlockCellGrad:
  ...

_LSTMBlockCellOutput = ...
def lstm_block_cell(x, cs_prev, h_prev, w, wci, wcf, wco, b, forget_bias=..., cell_clip=..., use_peephole=..., name=...): # -> LSTMBlockCell:
...
LSTMBlockCell = ...
def lstm_block_cell_eager_fallback(x, cs_prev, h_prev, w, wci, wcf, wco, b, forget_bias, cell_clip, use_peephole, name, ctx): # -> LSTMBlockCell:
  ...

_LSTMBlockCellGradOutput = ...
def lstm_block_cell_grad(x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, cs_grad, h_grad, use_peephole, name=...): # -> LSTMBlockCellGrad:
...
LSTMBlockCellGrad = ...
def lstm_block_cell_grad_eager_fallback(x, cs_prev, h_prev, w, wci, wcf, wco, b, i, cs, f, o, ci, co, cs_grad, h_grad, use_peephole, name, ctx): # -> LSTMBlockCellGrad:
  ...
