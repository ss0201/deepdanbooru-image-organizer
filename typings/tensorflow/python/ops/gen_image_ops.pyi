...
"""
def adjust_contrast(images, contrast_factor, min_value, max_value, name=...):
...
def adjust_contrastv2(images, contrast_factor, name=...):
...
def adjust_hue(images, delta, name=...):
...
def adjust_saturation(images, scale, name=...):
...
def combined_non_max_suppression_eager_fallback(boxes, scores, max_output_size_per_class, max_total_size, iou_threshold, score_threshold, pad_per_class, clip_boxes, name, ctx): # -> CombinedNonMaxSuppression:
  ...

def crop_and_resize(image, boxes, box_ind, crop_size, method=..., extrapolation_value=..., name=...):
...
def crop_and_resize_grad_boxes(grads, image, boxes, box_ind, method=..., name=...):
...
def crop_and_resize_grad_image(grads, boxes, box_ind, image_size, T, method=..., name=...):
...
def decode_and_crop_jpeg(contents, crop_window, channels=..., ratio=..., fancy_upscaling=..., try_recover_truncated=..., acceptable_fraction=..., dct_method=..., name=...):
...
def decode_bmp(contents, channels=..., name=...):
...
def decode_image(contents, channels=..., dtype=..., expand_animations=..., name=...):
...
def decode_jpeg(contents, channels=..., ratio=..., fancy_upscaling=..., try_recover_truncated=..., acceptable_fraction=..., dct_method=..., name=...):
...
def decode_png(contents, channels=..., dtype=..., name=...):
...
def draw_bounding_boxes(images, boxes, name=...):
...
def encode_jpeg(image, format=..., quality=..., progressive=..., optimize_size=..., chroma_downsampling=..., density_unit=..., x_density=..., y_density=..., xmp_metadata=..., name=...):
...
def encode_jpeg_variable_quality(images, quality, name=...):
...
def extract_glimpse(input, size, offsets, centered=..., normalized=..., uniform_noise=..., noise=..., name=...):
...
def extract_glimpse_v2(input, size, offsets, centered=..., normalized=..., uniform_noise=..., noise=..., name=...):
  r"""Extracts a glimpse from the input tensor.
...
def extract_jpeg_shape(contents, output_type=..., name=...):
...
def generate_bounding_box_proposals_eager_fallback(scores, bbox_deltas, image_info, anchors, nms_threshold, pre_nms_topn, min_size, post_nms_topn, name, ctx): # -> GenerateBoundingBoxProposals:
  ...

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('image.hsv_to_rgb')
def hsv_to_rgb(images, name=...): # -> _dispatcher_for_hsv_to_rgb | object:
...
def image_projective_transform_v2(images, transforms, output_shape, interpolation, fill_mode=..., name=...):
...
def image_projective_transform_v3(images, transforms, output_shape, fill_value, interpolation, fill_mode=..., name=...):
  r"""Applies the given transform to each of the images.
...
def non_max_suppression(boxes, scores, max_output_size, iou_threshold=..., name=...):
  r"""Greedily selects a subset of bounding boxes in descending order of score,
...
def non_max_suppression_v2(boxes, scores, max_output_size, iou_threshold, name=...):
  r"""Greedily selects a subset of bounding boxes in descending order of score,
...
def non_max_suppression_v3(boxes, scores, max_output_size, iou_threshold, score_threshold, name=...):
  r"""Greedily selects a subset of bounding boxes in descending order of score,
...
def non_max_suppression_v4(boxes, scores, max_output_size, iou_threshold, score_threshold, pad_to_max_output_size=..., name=...): # -> NonMaxSuppressionV4:
  r"""Greedily selects a subset of bounding boxes in descending order of score,
...
NonMaxSuppressionV4 = ...
def non_max_suppression_v4_eager_fallback(boxes, scores, max_output_size, iou_threshold, score_threshold, pad_to_max_output_size, name, ctx): # -> NonMaxSuppressionV4:
  ...

_NonMaxSuppressionV5Output = ...
def non_max_suppression_v5(boxes, scores, max_output_size, iou_threshold, score_threshold, soft_nms_sigma, pad_to_max_output_size=..., name=...): # -> NonMaxSuppressionV5:
  r"""Greedily selects a subset of bounding boxes in descending order of score,
...
NonMaxSuppressionV5 = ...
def non_max_suppression_v5_eager_fallback(boxes, scores, max_output_size, iou_threshold, score_threshold, soft_nms_sigma, pad_to_max_output_size, name, ctx): # -> NonMaxSuppressionV5:
  ...
...
def quantized_resize_bilinear(images, size, min, max, align_corners=..., half_pixel_centers=..., name=...): # -> QuantizedResizeBilinear:
...
def quantized_resize_bilinear_eager_fallback(images, size, min, max, align_corners, half_pixel_centers, name, ctx): # -> QuantizedResizeBilinear:
  ...

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('image.rgb_to_hsv')
def rgb_to_hsv(images, name=...): # -> _dispatcher_for_rgb_to_hsv | object:
...
def random_crop(image, size, seed=..., seed2=..., name=...):
...
def resize_area(images, size, align_corners=..., name=...):
...
def resize_bicubic(images, size, align_corners=..., half_pixel_centers=..., name=...):
...
def resize_bicubic_grad(grads, original_image, align_corners=..., half_pixel_centers=..., name=...):
...
def resize_bilinear(images, size, align_corners=..., half_pixel_centers=..., name=...):
...
def resize_bilinear_grad(grads, original_image, align_corners=..., half_pixel_centers=..., name=...):
...
def resize_nearest_neighbor(images, size, align_corners=..., half_pixel_centers=..., name=...):
...
def resize_nearest_neighbor_grad(grads, size, align_corners=..., half_pixel_centers=..., name=...):
...
def sample_distorted_bounding_box(image_size, bounding_boxes, seed=..., seed2=..., min_object_covered=..., aspect_ratio_range=..., area_range=..., max_attempts=..., use_image_if_no_bounding_boxes=..., name=...): # -> SampleDistortedBoundingBox:
...
def sample_distorted_bounding_box_eager_fallback(image_size, bounding_boxes, seed, seed2, min_object_covered, aspect_ratio_range, area_range, max_attempts, use_image_if_no_bounding_boxes, name, ctx): # -> SampleDistortedBoundingBox:
  ...

_SampleDistortedBoundingBoxV2Output = ...
def sample_distorted_bounding_box_v2(image_size, bounding_boxes, min_object_covered, seed=..., seed2=..., aspect_ratio_range=..., area_range=..., max_attempts=..., use_image_if_no_bounding_boxes=..., name=...): # -> SampleDistortedBoundingBoxV2:
  r"""Generate a single randomly distorted bounding box for an image.
...
def sample_distorted_bounding_box_v2_eager_fallback(image_size, bounding_boxes, min_object_covered, seed, seed2, aspect_ratio_range, area_range, max_attempts, use_image_if_no_bounding_boxes, name, ctx): # -> SampleDistortedBoundingBoxV2:
  ...

def scale_and_translate(images, size, scale, translation, kernel_type=..., antialias=..., name=...):
  r"""TODO: add doc.
...
def scale_and_translate_grad(grads, original_image, scale, translation, kernel_type=..., antialias=..., name=...):
  r"""TODO: add doc.
...
def stateless_sample_distorted_bounding_box(image_size, bounding_boxes, min_object_covered, seed, aspect_ratio_range=..., area_range=..., max_attempts=..., use_image_if_no_bounding_boxes=..., name=...): # -> StatelessSampleDistortedBoundingBox:
...
def stateless_sample_distorted_bounding_box_eager_fallback(image_size, bounding_boxes, min_object_covered, seed, aspect_ratio_range, area_range, max_attempts, use_image_if_no_bounding_boxes, name, ctx): # -> StatelessSampleDistortedBoundingBox:
  ...
