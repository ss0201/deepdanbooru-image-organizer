...
"""
def variable_op(shape, dtype, name=..., set_shape=..., container=..., shared_name=...):
  """Deprecated. Used variable_op_v2 instead."""
  ...

def variable_op_v2(shape, dtype, name=..., container=..., shared_name=...):
...
def batch_scatter_update(ref, indices, updates, use_locking=..., name=...):
