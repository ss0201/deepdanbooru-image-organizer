...
"""
def empty_tensor_list(element_shape, max_num_elements, element_dtype, name=...):
...
def tensor_list_concat(input_handle, element_dtype, element_shape=..., name=...): # -> TensorListConcat:
...
TensorListConcat = ...
def tensor_list_concat_eager_fallback(input_handle, element_dtype, element_shape, name, ctx): # -> TensorListConcat:
  ...

def tensor_list_concat_lists(input_a, input_b, element_dtype, name=...):
  r"""TODO: add doc.
...
def tensor_list_concat_v2(input_handle, element_shape, leading_dims, element_dtype, name=...): # -> TensorListConcatV2:
  r"""Concats all tensors in the list along the 0th dimension.
...
TensorListConcatV2 = ...
def tensor_list_concat_v2_eager_fallback(input_handle, element_shape, leading_dims, element_dtype, name, ctx): # -> TensorListConcatV2:
  ...

def tensor_list_element_shape(input_handle, shape_type, name=...):
...
def tensor_list_from_tensor(tensor, element_shape, name=...):
...
def tensor_list_gather(input_handle, indices, element_shape, element_dtype, name=...):
...
def tensor_list_get_item(input_handle, index, element_shape, element_dtype, name=...):
...
def tensor_list_length(input_handle, name=...):
...
def tensor_list_pop_back(input_handle, element_shape, element_dtype, name=...): # -> TensorListPopBack:
...
TensorListPopBack = ...
def tensor_list_pop_back_eager_fallback(input_handle, element_shape, element_dtype, name, ctx): # -> TensorListPopBack:
  ...

def tensor_list_push_back(input_handle, tensor, name=...):
...
def tensor_list_push_back_batch(input_handles, tensor, name=...):
  r"""TODO: add doc.
...
def tensor_list_reserve(element_shape, num_elements, element_dtype, name=...):
...
def tensor_list_resize(input_handle, size, name=...):
  r"""Resizes the list.
...
def tensor_list_scatter(tensor, indices, element_shape, name=...):
...
def tensor_list_scatter_into_existing_list(input_handle, tensor, indices, name=...):
...
def tensor_list_scatter_v2(tensor, indices, element_shape, num_elements, name=...):
  r"""Creates a TensorList by indexing into a Tensor.
...
def tensor_list_set_item(input_handle, index, item, name=...):
...
def tensor_list_split(tensor, element_shape, lengths, name=...):
...
def tensor_list_stack(input_handle, element_shape, element_dtype, num_elements=..., name=...):
