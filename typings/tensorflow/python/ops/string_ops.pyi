...
@dispatch.add_dispatch_support
def string_format(template, inputs, placeholder=..., summarize=..., name=...):
...
def reduce_join(inputs, axis=..., keep_dims=..., separator=..., name=..., reduction_indices=..., keepdims=...):
  ...

@tf_export("strings.reduce_join", v1=[])
@dispatch.add_dispatch_support
def reduce_join_v2(inputs, axis=..., keepdims=..., separator=..., name=...):
...
@dispatch.register_unary_elementwise_api
@dispatch.add_dispatch_support
def string_length(input, name=..., unit=...):
...
@dispatch.register_unary_elementwise_api
@dispatch.add_dispatch_support
def string_length_v2(input, unit=..., name=...):
  ...
...
def substr_deprecated(input, pos, len, name=..., unit=...):
  ...

@tf_export(v1=["strings.substr"])
@dispatch.register_unary_elementwise_api
@dispatch.add_dispatch_support
def substr(input, pos, len, name=..., unit=...):
  ...

@tf_export("strings.substr", v1=[])
@dispatch.register_unary_elementwise_api
@dispatch.add_dispatch_support
def substr_v2(input, pos, len, unit=..., name=...):
  ...

@tf_export("strings.to_number", v1=[])
@dispatch.register_unary_elementwise_api
@dispatch.add_dispatch_support
def string_to_number(input, out_type=..., name=...):
...
@dispatch.add_dispatch_support
def string_to_number_v1(string_tensor=..., out_type=..., name=..., input=...):
  ...

@tf_export("strings.to_hash_bucket", v1=[])
@dispatch.register_unary_elementwise_api
@dispatch.add_dispatch_support
def string_to_hash_bucket(input, num_buckets, name=...):
...
@dispatch.register_unary_elementwise_api
@dispatch.add_dispatch_support
def string_to_hash_bucket_v1(string_tensor=..., num_buckets=..., name=..., input=...):
  ...
