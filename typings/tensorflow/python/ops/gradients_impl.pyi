...
def hessians(ys, xs, name=..., colocate_gradients_with_ops=..., gate_gradients=..., aggregation_method=...): # -> list[Unknown]:
...
def HessiansV2(ys, xs, gate_gradients=..., aggregation_method=..., name=...): # -> list[Unknown]:
  """Constructs the Hessian of sum of `ys` with respect to `x` in `xs`.
