...
"""
def boosted_trees_aggregate_stats(node_ids, gradients, hessians, feature, max_splits, num_buckets, name=...):
...
def boosted_trees_bucketize(float_values, bucket_boundaries, name=...):
...
def boosted_trees_calculate_best_feature_split(node_id_range, stats_summary, l1, l2, tree_complexity, min_node_weight, logits_dimension, split_type=..., name=...): # -> BoostedTreesCalculateBestFeatureSplit:
...
def boosted_trees_calculate_best_feature_split_eager_fallback(node_id_range, stats_summary, l1, l2, tree_complexity, min_node_weight, logits_dimension, split_type, name, ctx): # -> BoostedTreesCalculateBestFeatureSplit:
  ...

_BoostedTreesCalculateBestFeatureSplitV2Output = ...
def boosted_trees_calculate_best_feature_split_v2(node_id_range, stats_summaries_list, split_types, candidate_feature_ids, l1, l2, tree_complexity, min_node_weight, logits_dimension, name=...): # -> BoostedTreesCalculateBestFeatureSplitV2:
...
def boosted_trees_calculate_best_feature_split_v2_eager_fallback(node_id_range, stats_summaries_list, split_types, candidate_feature_ids, l1, l2, tree_complexity, min_node_weight, logits_dimension, name, ctx): # -> BoostedTreesCalculateBestFeatureSplitV2:
  ...

_BoostedTreesCalculateBestGainsPerFeatureOutput = ...
def boosted_trees_calculate_best_gains_per_feature(node_id_range, stats_summary_list, l1, l2, tree_complexity, min_node_weight, max_splits, name=...): # -> BoostedTreesCalculateBestGainsPerFeature:
  r"""Calculates gains for each feature and returns the best possible split information for the feature.
...
def boosted_trees_calculate_best_gains_per_feature_eager_fallback(node_id_range, stats_summary_list, l1, l2, tree_complexity, min_node_weight, max_splits, name, ctx): # -> BoostedTreesCalculateBestGainsPerFeature:
  ...

def boosted_trees_center_bias(tree_ensemble_handle, mean_gradients, mean_hessians, l1, l2, name=...):
...
def boosted_trees_create_ensemble_eager_fallback(tree_ensemble_handle, stamp_token, tree_ensemble_serialized, name, ctx): # -> None:
  ...

def boosted_trees_create_quantile_stream_resource(quantile_stream_resource_handle, epsilon, num_streams, max_elements=..., name=...): # -> None:
...
def boosted_trees_create_quantile_stream_resource_eager_fallback(quantile_stream_resource_handle, epsilon, num_streams, max_elements, name, ctx): # -> None:
  ...
...
def boosted_trees_deserialize_ensemble_eager_fallback(tree_ensemble_handle, stamp_token, tree_ensemble_serialized, name, ctx): # -> None:
  ...

def boosted_trees_ensemble_resource_handle_op(container=..., shared_name=..., name=...):
...
def boosted_trees_example_debug_outputs(tree_ensemble_handle, bucketized_features, logits_dimension, name=...):
...
def boosted_trees_flush_quantile_summaries(quantile_stream_resource_handle, num_features, name=...):
...
def boosted_trees_get_ensemble_states(tree_ensemble_handle, name=...): # -> BoostedTreesGetEnsembleStates:
...
def boosted_trees_get_ensemble_states_eager_fallback(tree_ensemble_handle, name, ctx): # -> BoostedTreesGetEnsembleStates:
  ...

def boosted_trees_make_quantile_summaries(float_values, example_weights, epsilon, name=...):
...
def boosted_trees_make_stats_summary(node_ids, gradients, hessians, bucketized_features_list, max_splits, num_buckets, name=...):
...
def boosted_trees_predict(tree_ensemble_handle, bucketized_features, logits_dimension, name=...):
...
def boosted_trees_quantile_stream_resource_add_summaries_eager_fallback(quantile_stream_resource_handle, summaries, name, ctx): # -> None:
  ...
...
def boosted_trees_quantile_stream_resource_deserialize_eager_fallback(quantile_stream_resource_handle, bucket_boundaries, name, ctx): # -> None:
  ...

def boosted_trees_quantile_stream_resource_flush(quantile_stream_resource_handle, num_buckets, generate_quantiles=..., name=...): # -> None:
...
def boosted_trees_quantile_stream_resource_flush_eager_fallback(quantile_stream_resource_handle, num_buckets, generate_quantiles, name, ctx): # -> None:
  ...

def boosted_trees_quantile_stream_resource_get_bucket_boundaries(quantile_stream_resource_handle, num_features, name=...):
...
def boosted_trees_quantile_stream_resource_handle_op(container=..., shared_name=..., name=...):
...
def boosted_trees_serialize_ensemble(tree_ensemble_handle, name=...): # -> BoostedTreesSerializeEnsemble:
...
def boosted_trees_serialize_ensemble_eager_fallback(tree_ensemble_handle, name, ctx): # -> BoostedTreesSerializeEnsemble:
  ...

_BoostedTreesSparseAggregateStatsOutput = ...
def boosted_trees_sparse_aggregate_stats(node_ids, gradients, hessians, feature_indices, feature_values, feature_shape, max_splits, num_buckets, name=...): # -> BoostedTreesSparseAggregateStats:
  r"""Aggregates the summary of accumulated stats for the batch.
...
def boosted_trees_sparse_aggregate_stats_eager_fallback(node_ids, gradients, hessians, feature_indices, feature_values, feature_shape, max_splits, num_buckets, name, ctx): # -> BoostedTreesSparseAggregateStats:
  ...

_BoostedTreesSparseCalculateBestFeatureSplitOutput = ...
def boosted_trees_sparse_calculate_best_feature_split(node_id_range, stats_summary_indices, stats_summary_values, stats_summary_shape, l1, l2, tree_complexity, min_node_weight, logits_dimension, split_type=..., name=...): # -> BoostedTreesSparseCalculateBestFeatureSplit:
  r"""Calculates gains for each feature and returns the best possible split information for the feature.
...
def boosted_trees_sparse_calculate_best_feature_split_eager_fallback(node_id_range, stats_summary_indices, stats_summary_values, stats_summary_shape, l1, l2, tree_complexity, min_node_weight, logits_dimension, split_type, name, ctx): # -> BoostedTreesSparseCalculateBestFeatureSplit:
  ...

_BoostedTreesTrainingPredictOutput = ...
def boosted_trees_training_predict(tree_ensemble_handle, cached_tree_ids, cached_node_ids, bucketized_features, logits_dimension, name=...): # -> BoostedTreesTrainingPredict:
  r"""Runs multiple additive regression ensemble predictors on input instances and
...
def boosted_trees_training_predict_eager_fallback(tree_ensemble_handle, cached_tree_ids, cached_node_ids, bucketized_features, logits_dimension, name, ctx): # -> BoostedTreesTrainingPredict:
  ...
...
def boosted_trees_update_ensemble_eager_fallback(tree_ensemble_handle, feature_ids, node_ids, gains, thresholds, left_node_contribs, right_node_contribs, max_depth, learning_rate, pruning_mode, name, ctx): # -> None:
  ...

def boosted_trees_update_ensemble_v2(tree_ensemble_handle, feature_ids, dimension_ids, node_ids, gains, thresholds, left_node_contribs, right_node_contribs, split_types, max_depth, learning_rate, pruning_mode, logits_dimension=..., name=...): # -> None:
...
def boosted_trees_update_ensemble_v2_eager_fallback(tree_ensemble_handle, feature_ids, dimension_ids, node_ids, gains, thresholds, left_node_contribs, right_node_contribs, split_types, max_depth, learning_rate, pruning_mode, logits_dimension, name, ctx): # -> None:
  ...

def is_boosted_trees_ensemble_initialized(tree_ensemble_handle, name=...):
...
def is_boosted_trees_quantile_stream_resource_initialized(quantile_stream_resource_handle, name=...):
