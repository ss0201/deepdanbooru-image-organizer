...
def ragged_tensor_from_variant(encoded_ragged, input_ragged_rank, output_ragged_rank, Tvalues, Tsplits=..., name=...): # -> RaggedTensorFromVariant:
...
def ragged_tensor_from_variant_eager_fallback(encoded_ragged, input_ragged_rank, output_ragged_rank, Tvalues, Tsplits, name, ctx): # -> RaggedTensorFromVariant:
  ...

_RaggedTensorToSparseOutput = ...
def ragged_tensor_to_sparse(rt_nested_splits, rt_dense_values, name=...): # -> RaggedTensorToSparse:
...
def ragged_tensor_to_sparse_eager_fallback(rt_nested_splits, rt_dense_values, name, ctx): # -> RaggedTensorToSparse:
  ...

def ragged_tensor_to_tensor(shape, values, default_value, row_partition_tensors, row_partition_types, name=...):
...
def ragged_tensor_to_variant(rt_nested_splits, rt_dense_values, batched_input, name=...):
...
def ragged_tensor_to_variant_gradient(encoded_ragged_grad, row_splits, dense_values_shape, Tvalues, name=...):
