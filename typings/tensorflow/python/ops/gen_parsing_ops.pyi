...
"""
def decode_csv(records, record_defaults, field_delim=..., use_quote_delim=..., na_value=..., select_cols=..., name=...):
...
def decode_compressed(bytes, compression_type=..., name=...): # -> _dispatcher_for_decode_compressed | object:
...
def decode_json_example(json_examples, name=...):
...
def decode_padded_raw(input_bytes, fixed_length, out_type, little_endian=..., name=...):
...
def decode_raw(bytes, out_type, little_endian=..., name=...):
  r"""Reinterpret the bytes of a string as a vector of numbers.
...
_ParseExampleOutput = ...
def parse_example(serialized, names, sparse_keys, dense_keys, dense_defaults, sparse_types, dense_shapes, name=...): # -> ParseExample:
...
ParseExample = ...
def parse_example_eager_fallback(serialized, names, sparse_keys, dense_keys, dense_defaults, sparse_types, dense_shapes, name, ctx): # -> ParseExample:
  ...

_ParseExampleV2Output = ...
def parse_example_v2(serialized, names, sparse_keys, dense_keys, ragged_keys, dense_defaults, num_sparse, sparse_types, ragged_value_types, ragged_split_types, dense_shapes, name=...): # -> ParseExampleV2:
...
ParseExampleV2 = ...
def parse_example_v2_eager_fallback(serialized, names, sparse_keys, dense_keys, ragged_keys, dense_defaults, num_sparse, sparse_types, ragged_value_types, ragged_split_types, dense_shapes, name, ctx): # -> ParseExampleV2:
  ...
...
def parse_single_example(serialized, dense_defaults, num_sparse, sparse_keys, dense_keys, sparse_types, dense_shapes, name=...): # -> ParseSingleExample:
...
ParseSingleExample = ...
def parse_single_example_eager_fallback(serialized, dense_defaults, num_sparse, sparse_keys, dense_keys, sparse_types, dense_shapes, name, ctx): # -> ParseSingleExample:
  ...
...
def parse_tensor(serialized, out_type, name=...): # -> _dispatcher_for_parse_tensor | object:
...
def serialize_tensor(tensor, name=...):
...
def string_to_number(string_tensor, out_type=..., name=...):
