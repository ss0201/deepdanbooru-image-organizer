...
def shared_resources(): # -> list[Unknown]:
  """Returns resources visible to all tasks in the cluster."""
  ...

def local_resources(): # -> list[Unknown]:
  """Returns resources intended to be local to this session."""
  ...

def report_uninitialized_resources(resource_list=..., name=...):
...
def initialize_resources(resource_list, name=...): # -> _dispatcher_for_no_op | object | None:
