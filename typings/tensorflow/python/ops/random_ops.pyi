...
def parameterized_truncated_normal(shape, means=..., stddevs=..., minvals=..., maxvals=..., dtype=..., seed=..., name=...):
...
def random_uniform(shape, minval=..., maxval=..., dtype=..., seed=..., name=...):
...
def random_shuffle(value, seed=..., name=...):
...
def random_crop(value, size, seed=..., name=...):
...
@dispatch.add_dispatch_support
def stateless_random_crop(value, size, seed, name=...):
...
def multinomial(logits, num_samples, seed=..., name=..., output_dtype=...):
...
def random_gamma(shape, alpha, beta=..., dtype=..., seed=..., name=...): # -> _dispatcher_for_maximum | object:
...
def random_poisson(lam, shape, dtype=..., seed=..., name=...):
...
@dispatch.add_dispatch_support
def random_poisson_v2(shape, lam, dtype=..., seed=..., name=...):
  """Draws `shape` samples from each of the given Poisson distribution(s).
