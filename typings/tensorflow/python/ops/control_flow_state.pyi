...
class _GradLoopState:
  ...
  @property
  def outer_grad_state(self): # -> Unknown | None:
    """The grad loop state for outer loop."""
    ...
  
  @property
  def forward_context(self): # -> Unknown | None:
  ...
  @property
  def grad_index(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | None:
  ...
  @property
  def history_map(self): # -> dict[Unknown, Unknown]:
    """The map that records all the tensors needed for backprop."""
    ...
  
  @property
  def switch_map(self): # -> dict[Unknown, Unknown]:
    """The map that records all the Switch ops for the while loop."""
    ...
  
  @property
  def unused_exits(self): # -> list[Unknown]:
    """The list of "unused" exits."""
    ...
  
  @property
  def deferred_exits(self): # -> list[Unknown]:
    """The list of "deferred" exits."""
    ...
  
  @property
  def forward_loop_exits(self): # -> list[Unknown]:
  ...
  def AddForwardAccumulator(self, value, dead_branch=...):
  ...
  def AddBackpropAccumulatedValue(self, history_value, value, dead_branch=...):
  ...
  def GetRealValue(self, value): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class _ControlFlowState:
  ...
  def GetGradState(self, op, before): # -> None:
    """Return the grad state for this op if it's in a forward loop context."""
    ...
  
  def ProcessUnusedLoopExits(self, pending_count, to_ops_set): # -> list[Unknown]:
  ...
  def ZerosLikeV1WhileLoop(self, op, index): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | None:
