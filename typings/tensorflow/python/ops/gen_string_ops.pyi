...
def as_string(input, precision=..., scientific=..., shortest=..., width=..., fill=..., name=...):
...
def decode_base64(input, name=...): # -> _dispatcher_for_decode_base64 | object:
...
def encode_base64(input, pad=..., name=...): # -> _dispatcher_for_encode_base64 | object:
...
def reduce_join(inputs, reduction_indices, keep_dims=..., separator=..., name=...):
...
def regex_full_match(input, pattern, name=...):
...
def regex_replace(input, pattern, rewrite, replace_global=..., name=...):
...
def static_regex_full_match(input, pattern, name=...):
  r"""Check if the input matches the regex pattern.
...
def static_regex_replace(input, pattern, rewrite, replace_global=..., name=...):
...
def string_format(inputs, template=..., placeholder=..., summarize=..., name=...):
...
def string_join(inputs, separator=..., name=...):
...
def string_length(input, unit=..., name=...):
...
def string_lower(input, encoding=..., name=...): # -> _dispatcher_for_string_lower | object:
...
_StringNGramsOutput = ...
def string_n_grams(data, data_splits, separator, ngram_widths, left_pad, right_pad, pad_width, preserve_short_sequences, name=...): # -> StringNGrams:
...
StringNGrams = ...
def string_n_grams_eager_fallback(data, data_splits, separator, ngram_widths, left_pad, right_pad, pad_width, preserve_short_sequences, name, ctx): # -> StringNGrams:
  ...

_StringSplitOutput = ...
def string_split(input, delimiter, skip_empty=..., name=...): # -> StringSplit:
...
StringSplit = ...
def string_split_eager_fallback(input, delimiter, skip_empty, name, ctx): # -> StringSplit:
  ...

_StringSplitV2Output = ...
def string_split_v2(input, sep, maxsplit=..., name=...): # -> StringSplitV2:
...
StringSplitV2 = ...
def string_split_v2_eager_fallback(input, sep, maxsplit, name, ctx): # -> StringSplitV2:
  ...
...
def string_strip(input, name=...): # -> _dispatcher_for_string_strip | object:
...
def string_to_hash_bucket(string_tensor, num_buckets, name=...):
...
def string_to_hash_bucket_fast(input, num_buckets, name=...): # -> _dispatcher_for_string_to_hash_bucket_fast | object:
  r"""Converts each string in the input Tensor to its hash mod by a number of buckets.
...
def string_to_hash_bucket_strong(input, num_buckets, key, name=...): # -> _dispatcher_for_string_to_hash_bucket_strong | object:
  r"""Converts each string in the input Tensor to its hash mod by a number of buckets.
...
def string_upper(input, encoding=..., name=...): # -> _dispatcher_for_string_upper | object:
...
def substr(input, pos, len, unit=..., name=...):
...
def unicode_decode(input, input_encoding, errors=..., replacement_char=..., replace_control_characters=..., Tsplits=..., name=...): # -> UnicodeDecode:
...
UnicodeDecode = ...
def unicode_decode_eager_fallback(input, input_encoding, errors, replacement_char, replace_control_characters, Tsplits, name, ctx): # -> UnicodeDecode:
  ...

_UnicodeDecodeWithOffsetsOutput = ...
def unicode_decode_with_offsets(input, input_encoding, errors=..., replacement_char=..., replace_control_characters=..., Tsplits=..., name=...): # -> UnicodeDecodeWithOffsets:
  r"""Decodes each string in `input` into a sequence of Unicode code points.
...
def unicode_decode_with_offsets_eager_fallback(input, input_encoding, errors, replacement_char, replace_control_characters, Tsplits, name, ctx): # -> UnicodeDecodeWithOffsets:
  ...

def unicode_encode(input_values, input_splits, output_encoding, errors=..., replacement_char=..., name=...):
...
def unicode_script(input, name=...): # -> _dispatcher_for_unicode_script | object:
...
def unicode_transcode(input, input_encoding, output_encoding, errors=..., replacement_char=..., replace_control_characters=..., name=...):
...
def unsorted_segment_join(inputs, segment_ids, num_segments, separator=..., name=...):
  r"""TODO: add doc.
