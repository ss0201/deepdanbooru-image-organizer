...
class WhileOp:
  ...
  @property
  def pfor_converter(self): # -> Self@WhileOp:
    """Return a converter for the while loop."""
    ...
  
  def __call__(self, pfor_input): # -> list[Unknown]:
...
class PForConfig:
  ...
  def reduce(self, fn, *args): # -> _dispatcher_for_identity_n | tuple[Unknown | _dispatcher_for_identity_n, ...]:
  ...
  def reduce_concat(self, x): # -> _dispatcher_for_identity_n | tuple[Unknown | _dispatcher_for_identity_n, ...]:
  ...
  def reduce_mean(self, x): # -> _dispatcher_for_identity_n | tuple[Unknown | _dispatcher_for_identity_n, ...]:
  ...
  def reduce_sum(self, x): # -> _dispatcher_for_identity_n | tuple[Unknown | _dispatcher_for_identity_n, ...]:
...
class PFor:
  ...
  @property
  def fallback_to_while_loop(self): # -> Unknown:
    ...
