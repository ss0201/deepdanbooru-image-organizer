...
_COND = ...
_CASE = ...
def cond_v2(pred, true_fn, false_fn, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class _CondGradFuncGraph(util.CondBranchFuncGraph):
  ...
  @property
  def wrapped_intermediates(self): # -> list[Unknown]:
    """The optional-wrapped intermediates captured from the forward graph."""
    ...
  
  @property
  def xla_intermediates(self): # -> list[Unknown]:
    """Raw intermediates captured from the forward graph if XLA is enabled."""
    ...
  


def indexed_case(branch_index, branch_fns, name=..., lower_using_switch_merge=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
