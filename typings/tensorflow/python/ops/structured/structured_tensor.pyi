...
from tensorflow.python.framework import extension_type, ops, tensor_shape
...
class StructuredTensor(extension_type.BatchableExtensionType):
  ...
  * A ***structure*** maps each field in the schema to a tensor value (which
  ...
  field.
  """
  _fields: Mapping[str, Union[ops.Tensor, ragged_tensor.RaggedTensor, StructuredTensor, extension_type.ExtensionType]]
  ...
  def __init__(self, fields: Mapping[str, FieldValue], ragged_shape: dynamic_ragged_shape.DynamicRaggedShape) -> None:
    ...
  ...
  @classmethod
  def from_fields(cls, fields, shape=..., nrows=..., row_partitions=..., validate=...): # -> Self@StructuredTensor:
  ...
  @classmethod
  def from_fields_and_rank(cls, fields, rank, validate=...): # -> StructuredTensor:
  ...
  def nrows(self): # -> DynamicRaggedShape | None:
  ...
  def field_value(self, field_name): # -> Self@StructuredTensor | Tensor | RaggedTensor | StructuredTensor | ExtensionType:
  ...
  def __getitem__(self, key): # -> Self@StructuredTensor | StructuredTensor | Any:
  ...
  def to_pyval(self): # -> list[dict[Unknown, Unknown]] | list[Unknown] | dict[Unknown, Unknown]:
  ...
  @classmethod
  def from_pyval(cls, pyval, typespec=...): # -> StructuredTensor | None:
  ...
  def partition_outer_dimension(self, row_partition): # -> RaggedTensor* | StructuredTensor:
  ...
  def merge_dims(self, outer_axis, inner_axis): # -> RaggedTensor | Unknown | StructuredTensor:
