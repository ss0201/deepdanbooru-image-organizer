...
def verify_tensor_all_finite(t=..., msg=..., name=..., x=..., message=...): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
...
@dispatch.add_dispatch_support
def verify_tensor_all_finite_v2(x, message, name=...): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
  """Assert that the tensor does not contain any NaN's or Inf's.
...
def add_check_numerics_ops(): # -> _dispatcher_for_no_op | object | None:
