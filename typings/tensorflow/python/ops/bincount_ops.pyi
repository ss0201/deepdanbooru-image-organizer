...
def validate_dense_weights(values, weights, dtype=...): # -> Tensor:
  """Validates the passed weight tensor or creates an empty one."""
  ...

def validate_sparse_weights(values, weights, dtype=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor:
  """Validates the passed weight tensor or creates an empty one."""
  ...

def validate_ragged_weights(values, weights, dtype=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | RaggedTensor | Unknown:
  """Validates the passed weight tensor or creates an empty one."""
  ...
