...
def encode_resource_handle(resource_handle): # -> ndarray[Unknown, Unknown]:
...
class TensorHandle:
  ...
  def to_numpy_array(self): # -> ndarray[Unknown, Unknown]:
  ...
  def get_raw_handle(self): # -> text_type:
...
def get_session_handle(data, name=...):
...
def get_session_tensor(handle, dtype, name=...): # -> tuple[Unknown, Unknown]:
...
def delete_session_tensor(handle, name=...): # -> tuple[Unknown, Unknown | None]:
