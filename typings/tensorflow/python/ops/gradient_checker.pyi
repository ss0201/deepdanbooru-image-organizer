...
def compute_gradient(x, x_shape, y, y_shape, x_init_value=..., delta=..., init_targets=..., extra_feed_dict=...): # -> list[tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown]]] | tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown]]:
