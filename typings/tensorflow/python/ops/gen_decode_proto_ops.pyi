...
def decode_proto_v2(bytes, message_type, field_names, output_types, descriptor_source=..., message_format=..., sanitize=..., name=...):
...
def decode_proto_v2_eager_fallback(bytes, message_type, field_names, output_types, descriptor_source, message_format, sanitize, name, ctx): # -> DecodeProtoV2:
  ...
