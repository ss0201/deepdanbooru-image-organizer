...
class _GraphTensorArrayV2:
  ...
  def close(self, name=...): # -> _dispatcher_for_no_op | object | None:
    """See TensorArray."""
    ...
...
class _EagerTensorArray:
  ...
  def stack(self, name=...): # -> Tensor | Any:
    """See TensorArray."""
    ...
  
  def gather(self, indices, name=...): # -> Tensor | Any:
    """See TensorArray."""
    ...
  
  def concat(self, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
    """See TensorArray."""
    ...
