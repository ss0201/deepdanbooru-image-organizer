...
"""
def accumulator_apply_gradient(handle, local_step, gradient, name=...):
...
def accumulator_num_accumulated(handle, name=...):
...
def accumulator_set_global_step(handle, new_global_step, name=...):
...
def accumulator_take_gradient(handle, num_required, dtype, name=...):
...
def barrier(component_types, shapes=..., capacity=..., container=..., shared_name=..., name=...):
...
def barrier_close(handle, cancel_pending_enqueues=..., name=...):
...
def barrier_incomplete_size(handle, name=...):
...
def barrier_insert_many(handle, keys, values, component_index, name=...):
...
def barrier_ready_size(handle, name=...):
...
def barrier_take_many(handle, num_elements, component_types, allow_small_batch=..., wait_for_incomplete=..., timeout_ms=..., name=...): # -> BarrierTakeMany:
...
def conditional_accumulator(dtype, shape, container=..., shared_name=..., reduction_type=..., name=...):
...
DeleteSessionTensor = ...
def delete_session_tensor_eager_fallback(handle, name, ctx): # -> None:
  ...

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('dynamic_partition')
def dynamic_partition(data, partitions, num_partitions, name=...): # -> _dispatcher_for_dynamic_partition | object:
...
def dynamic_stitch(indices, data, name=...): # -> _dispatcher_for_dynamic_stitch | object:
...
def fifo_queue(component_types, shapes=..., capacity=..., container=..., shared_name=..., name=...):
...
def fifo_queue_v2(component_types, shapes=..., capacity=..., container=..., shared_name=..., name=...):
  r"""A queue that produces elements in first-in first-out order.
...
def get_session_handle(value, name=...):
...
def get_session_handle_v2(value, name=...):
  r"""Store the input tensor in the state of the current session.
...
def get_session_tensor(handle, dtype, name=...):
...
def map_clear(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...): # -> None:
...
MapClear = ...
def map_clear_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): # -> None:
  ...

def map_incomplete_size(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
...
def map_peek(key, indices, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
...
def map_size(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
...
def map_stage(key, indices, values, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...): # -> None:
...
MapStage = ...
def map_stage_eager_fallback(key, indices, values, dtypes, capacity, memory_limit, container, shared_name, name, ctx): # -> None:
  ...

def map_unstage(key, indices, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
...
def map_unstage_no_key(indices, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...): # -> MapUnstageNoKey:
...
MapUnstageNoKey = ...
def map_unstage_no_key_eager_fallback(indices, dtypes, capacity, memory_limit, container, shared_name, name, ctx): # -> MapUnstageNoKey:
  ...

def ordered_map_clear(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...): # -> None:
  r"""Op removes all elements in the underlying container.
...
OrderedMapClear = ...
def ordered_map_clear_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): # -> None:
  ...

def ordered_map_incomplete_size(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
  r"""Op returns the number of incomplete elements in the underlying container.
...
def ordered_map_peek(key, indices, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
  r"""Op peeks at the values at the specified key.  If the
...
def ordered_map_size(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
  r"""Op returns the number of elements in the underlying container.
...
def ordered_map_stage(key, indices, values, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...): # -> None:
...
OrderedMapStage = ...
def ordered_map_stage_eager_fallback(key, indices, values, dtypes, capacity, memory_limit, container, shared_name, name, ctx): # -> None:
  ...

def ordered_map_unstage(key, indices, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
  r"""Op removes and returns the values associated with the key
...
def ordered_map_unstage_no_key(indices, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...): # -> OrderedMapUnstageNoKey:
...
def ordered_map_unstage_no_key_eager_fallback(indices, dtypes, capacity, memory_limit, container, shared_name, name, ctx): # -> OrderedMapUnstageNoKey:
  ...

def padding_fifo_queue(component_types, shapes=..., capacity=..., container=..., shared_name=..., name=...):
  r"""A queue that produces elements in first-in first-out order.
...
def padding_fifo_queue_v2(component_types, shapes=..., capacity=..., container=..., shared_name=..., name=...):
  r"""A queue that produces elements in first-in first-out order.
...
def parallel_dynamic_stitch(indices, data, name=...):
  r"""Interleave the values from the `data` tensors into a single tensor.
...
def priority_queue(shapes, component_types=..., capacity=..., container=..., shared_name=..., name=...):
...
def priority_queue_v2(shapes, component_types=..., capacity=..., container=..., shared_name=..., name=...):
  r"""A queue that produces elements sorted by the first component value.
...
def queue_close(handle, cancel_pending_enqueues=..., name=...):
...
def queue_close_v2(handle, cancel_pending_enqueues=..., name=...): # -> None:
  r"""Closes the given queue.
...
QueueCloseV2 = ...
def queue_close_v2_eager_fallback(handle, cancel_pending_enqueues, name, ctx): # -> None:
  ...

def queue_dequeue(handle, component_types, timeout_ms=..., name=...):
...
def queue_dequeue_many(handle, n, component_types, timeout_ms=..., name=...):
...
def queue_dequeue_many_v2(handle, n, component_types, timeout_ms=..., name=...):
  r"""Dequeues `n` tuples of one or more tensors from the given queue.
...
def queue_dequeue_up_to(handle, n, component_types, timeout_ms=..., name=...):
  r"""Dequeues `n` tuples of one or more tensors from the given queue.
...
def queue_dequeue_up_to_v2(handle, n, component_types, timeout_ms=..., name=...):
  r"""Dequeues `n` tuples of one or more tensors from the given queue.
...
def queue_dequeue_v2(handle, component_types, timeout_ms=..., name=...):
  r"""Dequeues a tuple of one or more tensors from the given queue.
...
def queue_enqueue(handle, components, timeout_ms=..., name=...):
...
def queue_enqueue_many(handle, components, timeout_ms=..., name=...):
...
def queue_enqueue_many_v2(handle, components, timeout_ms=..., name=...): # -> None:
  r"""Enqueues zero or more tuples of one or more tensors in the given queue.
...
QueueEnqueueManyV2 = ...
def queue_enqueue_many_v2_eager_fallback(handle, components, timeout_ms, name, ctx): # -> None:
  ...

def queue_enqueue_v2(handle, components, timeout_ms=..., name=...): # -> None:
  r"""Enqueues a tuple of one or more tensors in the given queue.
...
QueueEnqueueV2 = ...
def queue_enqueue_v2_eager_fallback(handle, components, timeout_ms, name, ctx): # -> None:
  ...

def queue_is_closed(handle, name=...):
...
def queue_is_closed_v2(handle, name=...):
  r"""Returns true if queue is closed.
...
def random_shuffle_queue(component_types, shapes=..., capacity=..., min_after_dequeue=..., seed=..., seed2=..., container=..., shared_name=..., name=...):
...
def random_shuffle_queue_v2(component_types, shapes=..., capacity=..., min_after_dequeue=..., seed=..., seed2=..., container=..., shared_name=..., name=...):
  r"""A queue that randomizes the order of elements.
...
def record_input(file_pattern, file_random_seed=..., file_shuffle_shift_ratio=..., file_buffer_size=..., file_parallelism=..., batch_size=..., compression_type=..., name=...):
...
def resource_accumulator_apply_gradient_eager_fallback(handle, local_step, gradient, name, ctx): # -> None:
  ...

def resource_accumulator_num_accumulated(handle, name=...):
  r"""Returns the number of gradients aggregated in the given accumulators.
...
def resource_accumulator_set_global_step_eager_fallback(handle, new_global_step, name, ctx): # -> None:
  ...

def resource_accumulator_take_gradient(handle, num_required, dtype, name=...):
  r"""Extracts the average gradient in the given ConditionalAccumulator.
...
def resource_conditional_accumulator(dtype, shape, container=..., shared_name=..., reduction_type=..., name=...):
  r"""A conditional accumulator for aggregating gradients.
...
def sparse_accumulator_apply_gradient(handle, local_step, gradient_indices, gradient_values, gradient_shape, has_known_shape, name=...):
...
def sparse_accumulator_take_gradient(handle, num_required, dtype, name=...): # -> SparseAccumulatorTakeGradient:
...
def sparse_conditional_accumulator(dtype, shape, container=..., shared_name=..., reduction_type=..., name=...):
...
StackCloseV2 = ...
def stack_close_v2_eager_fallback(handle, name, ctx): # -> None:
  ...

def stack_pop(handle, elem_type, name=...):
...
def stack_pop_v2(handle, elem_type, name=...):
...
def stack_push(handle, elem, swap_memory=..., name=...):
...
def stack_push_v2(handle, elem, swap_memory=..., name=...):
...
def stack_v2(max_size, elem_type, stack_name=..., name=...):
...
def stage(values, capacity=..., memory_limit=..., container=..., shared_name=..., name=...): # -> None:
...
Stage = ...
def stage_eager_fallback(values, capacity, memory_limit, container, shared_name, name, ctx): # -> None:
  ...

def stage_clear(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...): # -> None:
  r"""Op removes all elements in the underlying container.
...
StageClear = ...
def stage_clear_eager_fallback(dtypes, capacity, memory_limit, container, shared_name, name, ctx): # -> None:
  ...

def stage_peek(index, dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
...
def stage_size(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
  r"""Op returns the number of elements in the underlying container.
...
def tensor_array(size, dtype, dynamic_size=..., clear_after_read=..., tensor_array_name=..., element_shape=..., name=...):
  r"""TODO: add doc.
...
def tensor_array_close(handle, name=...):
  r"""TODO: add doc.
...
TensorArrayCloseV2 = ...
def tensor_array_close_v2_eager_fallback(handle, name, ctx): # -> None:
  ...
...
TensorArrayCloseV3 = ...
def tensor_array_close_v3_eager_fallback(handle, name, ctx): # -> None:
  ...

_TensorArrayConcatOutput = ...
def tensor_array_concat(handle, flow_in, dtype, element_shape_except0=..., name=...): # -> TensorArrayConcat:
  r"""TODO: add doc.
...
def tensor_array_concat_v2(handle, flow_in, dtype, element_shape_except0=..., name=...): # -> TensorArrayConcatV2:
...
TensorArrayConcatV2 = ...
def tensor_array_concat_v2_eager_fallback(handle, flow_in, dtype, element_shape_except0, name, ctx): # -> TensorArrayConcatV2:
  ...

_TensorArrayConcatV3Output = ...
def tensor_array_concat_v3(handle, flow_in, dtype, element_shape_except0=..., name=...): # -> TensorArrayConcatV3:
...
TensorArrayConcatV3 = ...
def tensor_array_concat_v3_eager_fallback(handle, flow_in, dtype, element_shape_except0, name, ctx): # -> TensorArrayConcatV3:
  ...

def tensor_array_gather(handle, indices, flow_in, dtype, element_shape=..., name=...):
  r"""TODO: add doc.
...
def tensor_array_gather_v2(handle, indices, flow_in, dtype, element_shape=..., name=...):
...
def tensor_array_gather_v3(handle, indices, flow_in, dtype, element_shape=..., name=...):
...
def tensor_array_grad(handle, flow_in, source, name=...):
  r"""TODO: add doc.
...
def tensor_array_grad_v2(handle, flow_in, source, name=...):
...
def tensor_array_grad_v3(handle, flow_in, source, name=...): # -> TensorArrayGradV3:
...
TensorArrayGradV3 = ...
def tensor_array_grad_v3_eager_fallback(handle, flow_in, source, name, ctx): # -> TensorArrayGradV3:
  ...

_TensorArrayGradWithShapeOutput = ...
def tensor_array_grad_with_shape(handle, flow_in, shape_to_prepend, source, name=...): # -> TensorArrayGradWithShape:
...
def tensor_array_grad_with_shape_eager_fallback(handle, flow_in, shape_to_prepend, source, name, ctx): # -> TensorArrayGradWithShape:
  ...

def tensor_array_pack(handle, flow_in, dtype, element_shape=..., name=...):
  r"""TODO: add doc.
...
def tensor_array_read(handle, index, flow_in, dtype, name=...):
  r"""TODO: add doc.
...
def tensor_array_read_v2(handle, index, flow_in, dtype, name=...):
...
def tensor_array_read_v3(handle, index, flow_in, dtype, name=...):
...
def tensor_array_scatter(handle, indices, value, flow_in, name=...):
  r"""TODO: add doc.
...
def tensor_array_scatter_v2(handle, indices, value, flow_in, name=...):
...
def tensor_array_scatter_v3(handle, indices, value, flow_in, name=...):
...
def tensor_array_size(handle, flow_in, name=...):
  r"""TODO: add doc.
...
def tensor_array_size_v2(handle, flow_in, name=...):
...
def tensor_array_size_v3(handle, flow_in, name=...):
...
def tensor_array_split(handle, value, lengths, flow_in, name=...):
  r"""TODO: add doc.
...
def tensor_array_split_v2(handle, value, lengths, flow_in, name=...):
...
def tensor_array_split_v3(handle, value, lengths, flow_in, name=...):
...
def tensor_array_unpack(handle, value, flow_in, name=...):
  r"""TODO: add doc.
...
def tensor_array_v2(size, dtype, element_shape=..., dynamic_size=..., clear_after_read=..., tensor_array_name=..., name=...):
...
def tensor_array_v3(size, dtype, element_shape=..., dynamic_size=..., clear_after_read=..., identical_element_shapes=..., tensor_array_name=..., name=...): # -> TensorArrayV3:
...
TensorArrayV3 = ...
def tensor_array_v3_eager_fallback(size, dtype, element_shape, dynamic_size, clear_after_read, identical_element_shapes, tensor_array_name, name, ctx): # -> TensorArrayV3:
  ...

def tensor_array_write(handle, index, value, flow_in, name=...):
  r"""TODO: add doc.
...
def tensor_array_write_v2(handle, index, value, flow_in, name=...):
  r"""Deprecated. Use TensorArrayGradV3
...
def tensor_array_write_v3(handle, index, value, flow_in, name=...):
...
def unstage(dtypes, capacity=..., memory_limit=..., container=..., shared_name=..., name=...):
