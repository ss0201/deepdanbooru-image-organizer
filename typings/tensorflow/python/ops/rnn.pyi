...
def bidirectional_dynamic_rnn(cell_fw, cell_bw, inputs, sequence_length=..., initial_state_fw=..., initial_state_bw=..., dtype=..., parallel_iterations=..., swap_memory=..., time_major=..., scope=...): # -> tuple[tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, Unknown | _dispatcher_for_reverse_v2 | object], tuple[Any | Unknown, Any | Unknown]]:
...
@dispatch.add_dispatch_support
def dynamic_rnn(cell, inputs, sequence_length=..., initial_state=..., dtype=..., parallel_iterations=..., swap_memory=..., time_major=..., scope=...): # -> tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, Any | Unknown]:
...
@dispatch.add_dispatch_support
def raw_rnn(cell, loop_fn, parallel_iterations=..., swap_memory=..., scope=...): # -> tuple[Any | Unknown, Any | Unknown, Any | Unknown | None]:
...
@dispatch.add_dispatch_support
def static_rnn(cell, inputs, initial_state=..., dtype=..., sequence_length=..., scope=...): # -> tuple[list[Unknown], Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
  """Creates a recurrent neural network specified by RNNCell `cell`.
...
@dispatch.add_dispatch_support
def static_state_saving_rnn(cell, inputs, state_saver, state_name, sequence_length=..., scope=...): # -> tuple[list[Unknown], Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
...
@dispatch.add_dispatch_support
def static_bidirectional_rnn(cell_fw, cell_bw, inputs, initial_state_fw=..., initial_state_bw=..., dtype=..., sequence_length=..., scope=...): # -> tuple[Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy, Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
