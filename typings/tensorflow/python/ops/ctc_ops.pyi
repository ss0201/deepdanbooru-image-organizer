...
def ctc_loss(labels, inputs=..., sequence_length=..., preprocess_collapse_repeated=..., ctc_merge_repeated=..., ignore_longer_outputs_than_inputs=..., time_major=..., logits=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
@dispatch.add_dispatch_support
def ctc_greedy_decoder(inputs, sequence_length, merge_repeated=..., blank_index=...): # -> tuple[list[SparseTensor], Unknown]:
...
@dispatch.add_dispatch_support
def ctc_beam_search_decoder(inputs, sequence_length, beam_width=..., top_paths=..., merge_repeated=...): # -> tuple[list[SparseTensor], Unknown]:
...
@dispatch.add_dispatch_support
def ctc_beam_search_decoder_v2(inputs, sequence_length, beam_width=..., top_paths=...): # -> tuple[list[SparseTensor], Unknown]:
  """Performs beam search decoding on the logits given in input.
...
def ctc_state_log_probs(seq_lengths, max_seq_length): # -> tuple[Unknown, Unknown]:
...
def ctc_loss_and_grad(logits, labels, label_length, logit_length, unique=...): # -> tuple[Unknown | Any, Unknown]:
...
@dispatch.add_dispatch_support
def ctc_loss_v2(labels, logits, label_length, logit_length, logits_time_major=..., unique=..., blank_index=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any | tuple[Unknown | Any, (grad_loss: Unknown) -> list[Unknown]]:
...
@dispatch.add_dispatch_support
def ctc_loss_v3(labels, logits, label_length, logit_length, logits_time_major=..., unique=..., blank_index=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any | tuple[Unknown | Any, (grad_loss: Unknown) -> list[Unknown]]:
  """Computes CTC (Connectionist Temporal Classification) loss.
...
def ctc_loss_dense(labels, logits, label_length, logit_length, logits_time_major=..., unique=..., blank_index=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any | tuple[Unknown | Any, (grad_loss: Unknown) -> list[Unknown]]:
  """Computes CTC (Connectionist Temporal Classification) loss.
...
@dispatch.add_dispatch_support
def collapse_repeated(labels, seq_length, name=...): # -> tuple[Unknown, Unknown | SparseTensor | IndexedSlices | Tensor | Any]:
...
@dispatch.add_dispatch_support
def ctc_unique_labels(labels, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
