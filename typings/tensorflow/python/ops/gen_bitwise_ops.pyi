...
def bitwise_and(x, y, name=...): # -> _dispatcher_for_bitwise_and | object:
...
def bitwise_or(x, y, name=...): # -> _dispatcher_for_bitwise_or | object:
...
def bitwise_xor(x, y, name=...): # -> _dispatcher_for_bitwise_xor | object:
...
def invert(x, name=...): # -> _dispatcher_for_invert | object:
...
def left_shift(x, y, name=...): # -> _dispatcher_for_left_shift | object:
...
def right_shift(x, y, name=...): # -> _dispatcher_for_right_shift | object:
