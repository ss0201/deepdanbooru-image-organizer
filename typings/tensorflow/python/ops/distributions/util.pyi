...
def assert_integer_form(x, data=..., summarize=..., message=..., int_dtype=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
def assert_symmetric(matrix): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...

def embed_check_nonnegative_integer_form(x, name=...): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
  """Assert x is a non-negative tensor, and optionally of integers."""
  ...

def same_dynamic_shape(a, b): # -> Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy:
...
def maybe_get_static_value(x, dtype=...): # -> ndarray[Unknown, Unknown] | None:
...
def get_logits_and_probs(logits=..., probs=..., multidimensional=..., validate_args=..., name=..., dtype=...): # -> tuple[Unknown | Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy, Unknown | tuple[Unknown, ...]] | tuple[Unknown | Tensor | Any, Unknown] | tuple[Unknown | _dispatcher_for_log | object, Unknown | Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy] | tuple[Unknown, Unknown | Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy]:
...
def embed_check_categorical_event_shape(categorical_param, name=...): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
...
def embed_check_integer_casting_closed(x, target_dtype, assert_nonnegative=..., name=...): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
...
def matrix_diag_transform(matrix, transform=..., name=...): # -> Tensor | Any:
...
def rotate_transpose(x, shift, name=...): # -> Tensor | Any:
...
def prefer_static_broadcast_shape(shape1, shape2, name=...): # -> TensorShape:
...
def fill_triangular(x, upper=..., name=...): # -> _dispatcher_for_matrix_band_part | object:
...
def fill_triangular_inverse(x, upper=..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def reduce_weighted_logsumexp(logx, w=..., axis=..., keep_dims=..., return_sign=..., name=...): # -> tuple[Unknown, Unknown]:
...
def dimension_size(x, axis): # -> int:
  """Returns the size of a specific dimension."""
  ...

def process_quadrature_grid_and_probs(quadrature_grid_and_probs, dtype, validate_args, name=...): # -> tuple[Unknown | Tensor | Any, Unknown | Tensor | Any] | tuple[Unknown | Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy, Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy]:
...
def parent_frame_arguments(): # -> dict[Unknown, Unknown]:
