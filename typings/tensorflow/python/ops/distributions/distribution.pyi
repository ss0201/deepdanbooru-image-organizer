...
class _DistributionMeta(abc.ABCMeta):
  def __new__(mcs, classname, baseclasses, attrs): # -> Self@_DistributionMeta:
...
class Distribution(_BaseDistribution, metaclass=_DistributionMeta):
  ...
  @classmethod
  def param_static_shapes(cls, sample_shape): # -> dict[Unknown, Unknown]:
  ...
  @property
  def parameters(self): # -> dict[Unknown, Unknown]:
    """Dictionary of parameters used to instantiate this `Distribution`."""
    ...
  
  @property
  def reparameterization_type(self): # -> Unknown:
  ...
  @property
  def allow_nan_stats(self): # -> Unknown:
  ...
  @property
  def validate_args(self): # -> Unknown:
    """Python `bool` indicating possibly expensive checks are enabled."""
    ...
  
  def copy(self, **override_parameters_kwargs): # -> Self@Distribution:
  ...
  def batch_shape_tensor(self, name=...): # -> Tensor | Any:
  ...
  def event_shape_tensor(self, name=...): # -> Tensor | Any:
  ...
  def is_scalar_event(self, name=...): # -> Tensor | Any:
  ...
  def is_scalar_batch(self, name=...): # -> Tensor | Any:
  ...
  def log_prob(self, value, name=...): # -> _dispatcher_for_log | object:
  ...
  def log_cdf(self, value, name=...): # -> _dispatcher_for_log | object:
  ...
  def log_survival_function(self, value, name=...): # -> _dispatcher_for_log1p | object:
  ...
  def variance(self, name=...): # -> _dispatcher_for_square | object:
    """Variance.
  ...
  def kl_divergence(self, other, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
