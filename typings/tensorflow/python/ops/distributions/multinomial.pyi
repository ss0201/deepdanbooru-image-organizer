...
class Multinomial(distribution.Distribution):
  ...
  * `N!` denotes `N` factorial.
  ...
  @property
  def total_count(self): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
    """Number of trials used to construct a sample."""
    ...
  
  @property
  def logits(self): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy | object:
    """Vector of coordinatewise logits."""
    ...
  
  @property
  def probs(self): # -> tuple[Unknown, ...] | Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
