...
class Beta(distribution.Distribution):
  ...
  * `Gamma` is the [gamma function](
  ...
  @property
  def concentration1(self): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
    """Concentration parameter associated with a `1` outcome."""
    ...
  
  @property
  def concentration0(self): # -> Tensor | Any | IndexedSlices | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
