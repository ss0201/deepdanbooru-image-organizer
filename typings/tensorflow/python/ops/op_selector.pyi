...
def get_tensors(graph): # -> list[Unknown]:
...
def make_list_of_t(ts, check_graph=..., allow_graph=..., ignore_ops=...): # -> list[Tensor]:
...
def get_generating_ops(ts): # -> list[Unknown | Operation]:
...
def get_consuming_ops(ts): # -> list[Unknown]:
...
def make_list_of_op(tops, check_graph=..., allow_graph=..., ignore_ts=...): # -> list[Unknown] | list[Operation]:
...
def get_backward_walk_ops(seed_ops, inclusive=..., within_ops=..., within_ops_fn=..., stop_at_ts=..., control_inputs=..., only_differentiable=...): # -> list[Unknown]:
...
def graph_inputs(op): # -> list[Unknown]:
  ...
