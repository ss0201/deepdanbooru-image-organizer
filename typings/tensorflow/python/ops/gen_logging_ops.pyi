...
"""
Assert = ...
def audio_summary(tag, tensor, sample_rate, max_outputs=..., name=...):
...
def audio_summary_v2(tag, tensor, sample_rate, max_outputs=..., name=...):
  r"""Outputs a `Summary` protocol buffer with audio.
...
def histogram_summary(tag, values, name=...):
...
def image_summary(tag, tensor, max_images=..., bad_color=..., name=...):
...
Print = ...
def print_v2(input, output_stream=..., end=..., name=...): # -> None:
...
PrintV2 = ...
def print_v2_eager_fallback(input, output_stream, end, name, ctx): # -> None:
  ...

def scalar_summary(tags, values, name=...):
...
def tensor_summary(tensor, description=..., labels=..., display_name=..., name=...):
...
def tensor_summary_v2(tag, tensor, serialized_summary_metadata, name=...):
...
@tf_export('timestamp')
def timestamp(name=...): # -> _dispatcher_for_timestamp | object:
