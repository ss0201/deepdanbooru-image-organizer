...
def parse_example_v2(serialized, features, example_names=..., name=...): # -> dict[Unknown, Unknown]:
...
@dispatch.add_dispatch_support
def parse_example(serialized, features, name=..., example_names=...): # -> dict[Unknown, Unknown]:
  ...

@tf_export(v1=["io.parse_single_example", "parse_single_example"])
@dispatch.add_dispatch_support
def parse_single_example(serialized, features, name=..., example_names=...): # -> dict[Unknown, Unknown]:
...
@dispatch.add_dispatch_support
def parse_single_example_v2(serialized, features, example_names=..., name=...): # -> dict[Unknown, Unknown]:
  """Parses a single `Example` proto.
...
@dispatch.add_dispatch_support
def parse_sequence_example(serialized, context_features=..., sequence_features=..., example_names=..., name=...): # -> tuple[dict[Unknown, Unknown], dict[Unknown, Unknown], dict[Unknown, Unknown]]:
...
@dispatch.add_dispatch_support
def parse_single_sequence_example(serialized, context_features=..., sequence_features=..., example_name=..., name=...): # -> tuple[dict[Unknown, Unknown], dict[Unknown, Unknown]]:
...
@dispatch.add_dispatch_support
def decode_raw(input_bytes, out_type, little_endian=..., fixed_length=..., name=...):
...
def decode_raw_v1(input_bytes=..., out_type=..., little_endian=..., name=..., bytes=...):
...
def decode_csv(records, record_defaults, field_delim=..., use_quote_delim=..., name=..., na_value=..., select_cols=...):
...
@dispatch.add_dispatch_support
def decode_csv_v2(records, record_defaults, field_delim=..., use_quote_delim=..., na_value=..., select_cols=..., name=...):
  """Convert CSV records to tensors. Each column maps to one tensor.
