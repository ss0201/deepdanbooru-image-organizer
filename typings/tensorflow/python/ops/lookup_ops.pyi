...
def initialize_all_tables(name=...): # -> _dispatcher_for_no_op | object | None:
...
def tables_initializer(name=...): # -> _dispatcher_for_no_op | object | None:
  """Returns an Op that initializes all tables of the default graph.
...
class InitializableLookupTableBase(LookupInterface):
  ...
  @property
  def default_value(self): # -> Tensor | Any:
  ...
  def lookup(self, keys, name=...): # -> SparseTensor | RaggedTensor:
    """Looks up `keys` in a table, outputs the corresponding values.
...
class StaticHashTable(InitializableLookupTableBase):
  ...
  def export(self, name=...): # -> tuple[Unknown, Unknown]:
...
class IdTableWithHashBuckets(LookupInterface):
  ...
  * `<other term> -> bucket_id`, where bucket_id will be between `3` and
  ...
  def init(self): # -> _dispatcher_for_no_op | object | None:
    ...
  ...
  def lookup(self, keys, name=...): # -> SparseTensor | RaggedTensor | _dispatcher_for_string_to_hash_bucket_fast | object:
...
class MutableHashTable(LookupInterface):
  ...
  def lookup(self, keys, dynamic_default_values=..., name=...):
    """Looks up `keys` in a table, outputs the corresponding values.
