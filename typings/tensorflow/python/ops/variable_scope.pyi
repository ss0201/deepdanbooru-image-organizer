...
class _PartitionInfo:
  ...
  @property
  def full_shape(self): # -> list[Unknown] | tuple[Unknown, ...]:
    ...
  
  @property
  def var_offset(self): # -> list[Unknown] | tuple[Unknown, ...]:
    ...
...
class _VariableStore:
  ...
  def get_variable(self, name, shape=..., dtype=..., initializer=..., regularizer=..., reuse=..., trainable=..., collections=..., caching_device=..., partitioner=..., validate_shape=..., use_resource=..., custom_getter=..., constraint=..., synchronization=..., aggregation=...): # -> PartitionedVariable | VariableV1:
...
class VariableScope:
  ...
  @property
  def reuse(self): # -> Unknown | _ReuseMode | bool:
    ...
  ...
  def get_collection(self, name): # -> list[Unknown]:
  ...
  def global_variables(self): # -> list[Unknown]:
    """Get this scope's global variables."""
    ...
  
  def local_variables(self): # -> list[Unknown]:
...
class _VariableScopeStore(threading.local):
  ...
  def variable_scope_count(self, scope_name): # -> int:
    ...
  


def get_variable_scope_store(): # -> _VariableScopeStore:
...
def with_variable_store(store): # -> Generator[None, None, None]:
  ...
...
def get_variable(name, shape=..., dtype=..., initializer=..., regularizer=..., trainable=..., collections=..., caching_device=..., partitioner=..., validate_shape=..., use_resource=..., custom_getter=..., constraint=..., synchronization=..., aggregation=...):
  ...

get_variable_or_local_docstring = ...
@tf_export(v1=["get_local_variable"])
def get_local_variable(name, shape=..., dtype=..., initializer=..., regularizer=..., trainable=..., collections=..., caching_device=..., partitioner=..., validate_shape=..., use_resource=..., custom_getter=..., constraint=..., synchronization=..., aggregation=...):
  ...
...
@tf_contextlib.contextmanager
def variable_op_scope(values, name_or_scope, default_name=..., initializer=..., regularizer=..., caching_device=..., partitioner=..., custom_getter=..., reuse=..., dtype=..., use_resource=..., constraint=...): # -> Generator[VariableScope, None, None]:
...
@tf_contextlib.contextmanager
def variable_creator_scope_v1(variable_creator): # -> Generator[None, None, None]:
...
@tf_contextlib.contextmanager
def variable_creator_scope(variable_creator): # -> Generator[None, None, None]:
  """Scope which defines a variable creation function to be used by variable().
