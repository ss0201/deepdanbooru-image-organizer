...
@dispatch.add_dispatch_support
def sigmoid_cross_entropy_with_logits(_sentinel=..., labels=..., logits=..., name=...):
...
@dispatch.add_dispatch_support
def relu_layer(x, weights, biases, name=...): # -> _dispatcher_for_relu | object:
...
@dispatch.add_dispatch_support
def swish(features, beta=...): # -> tuple[Unknown, (dy: Unknown) -> Unknown]:
...
@dispatch.add_dispatch_support
def normalize(tensor, ord=..., axis=..., name=...): # -> tuple[Unknown, Unknown | SparseTensor | IndexedSlices | Tensor | Any]:
...
@dispatch.add_dispatch_support
def zero_fraction(value, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
@dispatch.add_dispatch_support
def depthwise_conv2d(input, filter, strides, padding, rate=..., name=..., data_format=..., dilations=...): # -> _dispatcher_for_batch_to_space_nd | object:
...
@dispatch.add_dispatch_support
def depthwise_conv2d_v2(input, filter, strides, padding, data_format=..., dilations=..., name=...): # -> _dispatcher_for_batch_to_space_nd | object:
  """Depthwise 2-D convolution.
...
@dispatch.add_dispatch_support
def separable_conv2d(input, depthwise_filter, pointwise_filter, strides, padding, rate=..., name=..., data_format=..., dilations=...):
...
@dispatch.add_dispatch_support
def separable_conv2d_v2(input, depthwise_filter, pointwise_filter, strides, padding, data_format=..., dilations=..., name=...):
  """2-D convolution with separable filters.
...
@dispatch.add_dispatch_support
def sufficient_statistics(x, axes, shift=..., keep_dims=..., name=..., keepdims=...): # -> tuple[Unknown, Unknown, Unknown, Unknown | Tensor | Any | None]:
...
@dispatch.add_dispatch_support
def sufficient_statistics_v2(x, axes, shift=..., keepdims=..., name=...): # -> tuple[Unknown, Unknown, Unknown, Unknown | Tensor | Any | None]:
  """Calculate the sufficient statistics for the mean and variance of `x`.
...
@dispatch.add_dispatch_support
def normalize_moments(counts, mean_ss, variance_ss, shift, name=...): # -> tuple[Unknown, Unknown]:
...
@dispatch.add_dispatch_support
def moments(x, axes, shift=..., name=..., keep_dims=..., keepdims=...): # -> tuple[Unknown | SparseTensor | IndexedSlices | Tensor | Any, Unknown | SparseTensor | IndexedSlices | Tensor | Any] | tuple[Unknown, Unknown]:
...
@dispatch.add_dispatch_support
def moments_v2(x, axes, shift=..., keepdims=..., name=...): # -> tuple[Unknown | SparseTensor | IndexedSlices | Tensor | Any, Unknown | SparseTensor | IndexedSlices | Tensor | Any] | tuple[Unknown, Unknown]:
...
@dispatch.add_dispatch_support
def weighted_moments(x, axes, frequency_weights, name=..., keep_dims=..., keepdims=...): # -> tuple[Unknown | SparseTensor | IndexedSlices | Tensor | Any, Unknown | SparseTensor | IndexedSlices | Tensor | Any]:
...
@dispatch.add_dispatch_support
def weighted_moments_v2(x, axes, frequency_weights, keepdims=..., name=...): # -> tuple[Unknown | SparseTensor | IndexedSlices | Tensor | Any, Unknown | SparseTensor | IndexedSlices | Tensor | Any]:
  """Returns the frequency-weighted mean and variance of `x`.
...
@dispatch.add_dispatch_support
def fused_batch_norm(x, scale, offset, mean=..., variance=..., epsilon=..., data_format=..., is_training=..., name=..., exponential_avg_factor=...): # -> tuple[Unknown, Unknown, Unknown]:
  r"""Batch normalization.
...
@dispatch.add_dispatch_support
def nce_loss_v2(weights, biases, labels, inputs, num_sampled, num_classes, num_true=..., sampled_values=..., remove_accidental_hits=..., name=...):
...
@dispatch.add_dispatch_support
def nce_loss(weights, biases, labels, inputs, num_sampled, num_classes, num_true=..., sampled_values=..., remove_accidental_hits=..., partition_strategy=..., name=...):
  """Computes and returns the noise-contrastive estimation training loss.
...
@dispatch.add_dispatch_support
def sampled_softmax_loss_v2(weights, biases, labels, inputs, num_sampled, num_classes, num_true=..., sampled_values=..., remove_accidental_hits=..., seed=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
@dispatch.add_dispatch_support
def sampled_softmax_loss(weights, biases, labels, inputs, num_sampled, num_classes, num_true=..., sampled_values=..., remove_accidental_hits=..., partition_strategy=..., name=..., seed=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """Computes and returns the sampled softmax training loss.
