...
def squeeze_or_expand_dimensions(y_pred, y_true=..., sample_weight=...): # -> tuple[Unknown | Tensor | Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy, Unknown | Tensor | Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy | None] | tuple[Unknown | Tensor | Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy, Unknown | Tensor | Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy | None, Unknown] | tuple[Unknown | Tensor | Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy, Unknown | Tensor | Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy | None, Any | Unknown | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy]:
...
def get_losses(scope=..., loss_collection=...): # -> list[Unknown]:
...
def get_regularization_losses(scope=...): # -> list[Unknown]:
...
def get_regularization_loss(scope=..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor:
...
def get_total_loss(add_regularization_losses=..., name=..., scope=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor:
