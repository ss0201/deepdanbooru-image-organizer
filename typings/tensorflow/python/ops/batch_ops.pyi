...
def batch_function(num_batch_threads, max_batch_size, batch_timeout_micros, allowed_batch_sizes=..., max_enqueued_batches=..., autograph=..., enable_large_batch_splitting=...): # -> (fn: Unknown) -> ((*args: Unknown) -> (Unknown | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy)):
