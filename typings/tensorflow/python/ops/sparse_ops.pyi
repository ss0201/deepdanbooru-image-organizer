...
def sparse_add(a, b, threshold=..., thresh=...): # -> SparseTensor:
...
def sparse_add_v2(a, b, threshold=...): # -> SparseTensor:
  """Adds two tensors, at least one of each is a `SparseTensor`.
...
def sparse_split(keyword_required=..., sp_input=..., num_split=..., axis=..., name=..., split_dim=...): # -> list[Unknown]:
...
def sparse_split_v2(sp_input=..., num_split=..., axis=..., name=...): # -> list[Unknown]:
  """Split a `SparseTensor` into `num_split` tensors along `axis`.
...
def sparse_reduce_max_v2(sp_input, axis=..., keepdims=..., output_is_sparse=..., name=...): # -> SparseTensor:
...
def sparse_reduce_max(sp_input, axis=..., keepdims=..., reduction_axes=..., keep_dims=...):
  """Computes `tf.sparse.maximum` of elements across dimensions of a SparseTensor.
...
def sparse_reduce_sum_v2(sp_input, axis=..., keepdims=..., output_is_sparse=..., name=...): # -> SparseTensor:
...
@deprecation.deprecated_args(None, "keep_dims is deprecated, use keepdims instead", "keep_dims")
@deprecation.deprecated_args(None, "reduction_axes is deprecated, use axis instead", "reduction_axes")
def sparse_reduce_sum(sp_input, axis=..., keepdims=..., reduction_axes=..., keep_dims=...):
  """Computes `tf.sparse.add` of elements across dimensions of a SparseTensor.
...
def sparse_tensor_to_dense(sp_input, default_value=..., validate_indices=..., name=...):
...
def sparse_to_indicator(sp_input, vocab_size, name=...):
...
def sparse_fill_empty_rows(sp_input, default_value, name=...): # -> tuple[SparseTensor, Unknown]:
...
def serialize_sparse(sp_input, name=..., out_type=...):
...
@dispatch.add_dispatch_support
def serialize_sparse_v2(sp_input, out_type=..., name=...):
  """Serialize a `SparseTensor` into a 3-vector (1-D `Tensor`) object.
...
def serialize_many_sparse(sp_input, name=..., out_type=...):
...
@dispatch.add_dispatch_support
def serialize_many_sparse_v2(sp_input, out_type=..., name=...):
  """Serialize `N`-minibatch `SparseTensor` into an `[N, 3]` `Tensor`.
...
def sparse_tensor_dense_matmul(sp_a, b, adjoint_a=..., adjoint_b=..., name=...):
