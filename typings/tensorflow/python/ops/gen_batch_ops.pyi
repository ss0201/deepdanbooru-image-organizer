...
"""
_BatchOutput = ...
def batch(in_tensors, num_batch_threads, max_batch_size, batch_timeout_micros, grad_timeout_micros, max_enqueued_batches=..., allowed_batch_sizes=..., container=..., shared_name=..., batching_queue=..., name=...): # -> Batch:
...
Batch = ...
def batch_eager_fallback(in_tensors, num_batch_threads, max_batch_size, batch_timeout_micros, grad_timeout_micros, max_enqueued_batches, allowed_batch_sizes, container, shared_name, batching_queue, name, ctx): # -> Batch:
  ...

def batch_function(in_tensors, captured_tensors, f, num_batch_threads, max_batch_size, batch_timeout_micros, Tout, max_enqueued_batches=..., allowed_batch_sizes=..., container=..., shared_name=..., batching_queue=..., enable_large_batch_splitting=..., name=...):
...
def unbatch(batched_tensor, batch_index, id, timeout_micros, container=..., shared_name=..., name=...):
...
def unbatch_grad(original_input, batch_index, grad, id, container=..., shared_name=..., name=...):
