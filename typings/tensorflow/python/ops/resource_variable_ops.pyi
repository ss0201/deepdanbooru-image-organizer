...
class BaseResourceVariable(variables.VariableV1, core.Tensor):
  ...
  def __copy__(self): # -> Self@BaseResourceVariable:
    ...
  ...
  def read_value_no_copy(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def gather_nd(self, indices, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def assign_sub(self, delta, use_locking=..., name=..., read_value=...): # -> _UnreadVariable | None:
  ...
  def assign_add(self, delta, use_locking=..., name=..., read_value=...): # -> _UnreadVariable | None:
  ...
  def assign(self, value, use_locking=..., name=..., read_value=...): # -> _UnreadVariable | None:
...
class ResourceVariable(BaseResourceVariable):
  ...
  ```
  """
  def __init__(self, initial_value=..., trainable=..., collections=..., validate_shape=..., caching_device=..., name=..., dtype=..., variable_def=..., import_scope=..., constraint=..., distribute_strategy=..., synchronization=..., aggregation=..., shape=...) -> None:
    """Creates a variable.
...
class VariableSpec(tensor_spec.DenseSpec):
  ...
  __slots__ = ...
  value_type = ...
  def __init__(self, shape, dtype=..., trainable=...) -> None:
    ...
  ...
  @classmethod
  def from_value(cls, value): # -> Self@VariableSpec:
    ...
