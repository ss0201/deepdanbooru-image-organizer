...
@tf_export(v1=["scan"])
@dispatch.add_dispatch_support
def scan(fn, elems, initializer=..., parallel_iterations=..., back_prop=..., swap_memory=..., infer_shape=..., reverse=..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def scan_v2(fn, elems, initializer=..., parallel_iterations=..., back_prop=..., swap_memory=..., infer_shape=..., reverse=..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  """scan on the list of tensors unpacked from `elems` on dimension 0.
...
def If(cond, inputs, then_branch, else_branch, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def While(input_, cond, body, name=..., hostmem=...):
...
def For(start, limit, delta, inputs, body, name=..., hostmem=..., rewrite_with_while=...): # -> list[Unknown]:
...
def partitioned_call(args, f, tout=..., executing_eagerly=..., config=..., executor_type=...): # -> Operation | list[Unknown] | None:
