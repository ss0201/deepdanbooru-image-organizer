...
def cholesky_solve(chol, rhs, name=...):
...
@dispatch.add_dispatch_support
def eye(num_rows, num_columns=..., batch_shape=..., dtype=..., name=...):
...
def matrix_solve_ls(matrix, rhs, l2_regularizer=..., fast=..., name=...): # -> Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy:
...
@dispatch.add_dispatch_support
def eig(tensor, name=...): # -> tuple[Unknown, Unknown]:
...
def self_adjoint_eig(tensor, name=...): # -> tuple[Unknown, Unknown]:
...
def svd(tensor, full_matrices=..., compute_uv=..., name=...): # -> tuple[Unknown | Tensor | Any, Unknown, Unknown] | Tensor | Any:
...
@dispatch.add_dispatch_support
def norm_v2(tensor, ord=..., axis=..., keepdims=..., name=...):
...
def norm(tensor, ord=..., axis=..., keepdims=..., name=..., keep_dims=...):
  r"""Computes the norm of vectors, matrices, and tensors.
