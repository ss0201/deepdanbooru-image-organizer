...
"""
def copy(input, tensor_name=..., debug_ops_spec=..., name=...):
...
def copy_host(input, tensor_name=..., debug_ops_spec=..., name=...):
...
def debug_identity(input, device_name=..., tensor_name=..., debug_urls=..., gated_grpc=..., name=...):
...
def debug_identity_v2(input, tfdbg_context_id=..., op_name=..., output_slot=..., tensor_debug_mode=..., debug_urls=..., circular_buffer_size=..., tfdbg_run_id=..., name=...):
...
def debug_nan_count(input, device_name=..., tensor_name=..., debug_urls=..., gated_grpc=..., name=...):
...
def debug_numeric_summary(input, device_name=..., tensor_name=..., debug_urls=..., lower_bound=..., upper_bound=..., mute_if_healthy=..., gated_grpc=..., name=...):
...
def debug_numeric_summary_v2(input, output_dtype=..., tensor_debug_mode=..., tensor_id=..., name=...):
