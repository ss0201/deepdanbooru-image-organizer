...
"""
def fixed_length_record_reader(record_bytes, header_bytes=..., footer_bytes=..., hop_bytes=..., container=..., shared_name=..., name=...):
...
def fixed_length_record_reader_v2(record_bytes, header_bytes=..., footer_bytes=..., hop_bytes=..., container=..., shared_name=..., encoding=..., name=...):
  r"""A Reader that outputs fixed-length records from a file.
...
def identity_reader(container=..., shared_name=..., name=...):
...
def identity_reader_v2(container=..., shared_name=..., name=...):
  r"""A Reader that outputs the queued work as both the key and value.
...
def lmdb_reader(container=..., shared_name=..., name=...):
...
def matching_files(pattern, name=...): # -> _dispatcher_for_matching_files | object:
...
def merge_v2_checkpoints(checkpoint_prefixes, destination_prefix, delete_old_dirs=..., allow_missing_files=..., name=...): # -> None:
...
MergeV2Checkpoints = ...
def merge_v2_checkpoints_eager_fallback(checkpoint_prefixes, destination_prefix, delete_old_dirs, allow_missing_files, name, ctx): # -> None:
  ...
...
def reader_num_records_produced(reader_handle, name=...):
...
def reader_num_records_produced_v2(reader_handle, name=...):
  r"""Returns the number of records this Reader has produced.
...
def reader_num_work_units_completed(reader_handle, name=...):
...
def reader_num_work_units_completed_v2(reader_handle, name=...):
  r"""Returns the number of work units this Reader has finished processing.
...
_ReaderReadOutput = ...
def reader_read(reader_handle, queue_handle, name=...): # -> ReaderRead:
...
def reader_read_up_to(reader_handle, queue_handle, num_records, name=...): # -> ReaderReadUpTo:
...
def reader_read_up_to_v2(reader_handle, queue_handle, num_records, name=...): # -> ReaderReadUpToV2:
  r"""Returns up to `num_records` (key, value) pairs produced by a Reader.
...
ReaderReadUpToV2 = ...
def reader_read_up_to_v2_eager_fallback(reader_handle, queue_handle, num_records, name, ctx): # -> ReaderReadUpToV2:
  ...

_ReaderReadV2Output = ...
def reader_read_v2(reader_handle, queue_handle, name=...): # -> ReaderReadV2:
  r"""Returns the next record (key, value pair) produced by a Reader.
...
ReaderReadV2 = ...
def reader_read_v2_eager_fallback(reader_handle, queue_handle, name, ctx): # -> ReaderReadV2:
  ...

def reader_reset(reader_handle, name=...):
...
ReaderResetV2 = ...
def reader_reset_v2_eager_fallback(reader_handle, name, ctx): # -> None:
  ...

def reader_restore_state(reader_handle, state, name=...):
...
def reader_restore_state_v2_eager_fallback(reader_handle, state, name, ctx): # -> None:
  ...

def reader_serialize_state(reader_handle, name=...):
...
def reader_serialize_state_v2(reader_handle, name=...):
  r"""Produce a string tensor that encodes the state of a Reader.
...
def restore(file_pattern, tensor_name, dt, preferred_shard=..., name=...):
...
def restore_slice(file_pattern, tensor_name, shape_and_slice, dt, preferred_shard=..., name=...):
  r"""Restores a tensor from checkpoint files.
...
def restore_v2(prefix, tensor_names, shape_and_slices, dtypes, name=...):
...
Save = ...
def save_eager_fallback(filename, tensor_names, data, name, ctx): # -> None:
  ...
...
SaveSlices = ...
def save_slices_eager_fallback(filename, tensor_names, shapes_and_slices, data, name, ctx): # -> None:
  ...
...
SaveV2 = ...
def save_v2_eager_fallback(prefix, tensor_names, shape_and_slices, tensors, name, ctx): # -> None:
  ...

def sharded_filename(basename, shard, num_shards, name=...):
...
def sharded_filespec(basename, num_shards, name=...):
...
def tf_record_reader(container=..., shared_name=..., compression_type=..., name=...):
...
def tf_record_reader_v2(container=..., shared_name=..., compression_type=..., name=...):
  r"""A Reader that outputs the records from a TensorFlow Records file.
...
def text_line_reader(skip_header_lines=..., container=..., shared_name=..., name=...):
...
def text_line_reader_v2(skip_header_lines=..., container=..., shared_name=..., name=...):
  r"""A Reader that outputs the lines of a file delimited by '\n'.
...
def whole_file_reader(container=..., shared_name=..., name=...):
...
def whole_file_reader_v2(container=..., shared_name=..., name=...):
  r"""A Reader that outputs the entire contents of a file as a value.
...
def write_file(filename, contents, name=...): # -> _dispatcher_for_write_file | object | None:
...
def write_file_eager_fallback(filename, contents, name, ctx): # -> None:
  ...
