...
"""
def add_many_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, container=..., shared_name=..., name=...):
...
def add_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, container=..., shared_name=..., name=...):
...
def deserialize_many_sparse(serialized_sparse, dtype, name=...): # -> DeserializeManySparse:
...
def deserialize_many_sparse_eager_fallback(serialized_sparse, dtype, name, ctx): # -> DeserializeManySparse:
  ...

_DeserializeSparseOutput = ...
def deserialize_sparse(serialized_sparse, dtype, name=...): # -> DeserializeSparse:
...
DeserializeSparse = ...
def deserialize_sparse_eager_fallback(serialized_sparse, dtype, name, ctx): # -> DeserializeSparse:
  ...

def serialize_many_sparse(sparse_indices, sparse_values, sparse_shape, out_type=..., name=...):
...
def serialize_sparse(sparse_indices, sparse_values, sparse_shape, out_type=..., name=...):
...
_SparseAddOutput = ...
def sparse_add(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, name=...): # -> SparseAdd:
...
SparseAdd = ...
def sparse_add_eager_fallback(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, name, ctx): # -> SparseAdd:
  ...

_SparseAddGradOutput = ...
def sparse_add_grad(backprop_val_grad, a_indices, b_indices, sum_indices, name=...): # -> SparseAddGrad:
...
SparseAddGrad = ...
def sparse_add_grad_eager_fallback(backprop_val_grad, a_indices, b_indices, sum_indices, name, ctx): # -> SparseAddGrad:
  ...

_SparseConcatOutput = ...
def sparse_concat(indices, values, shapes, concat_dim, name=...): # -> SparseConcat:
...
SparseConcat = ...
def sparse_concat_eager_fallback(indices, values, shapes, concat_dim, name, ctx): # -> SparseConcat:
  ...

_SparseCrossOutput = ...
def sparse_cross(indices, values, shapes, dense_inputs, hashed_output, num_buckets, hash_key, out_type, internal_type, name=...): # -> SparseCross:
...
SparseCross = ...
def sparse_cross_eager_fallback(indices, values, shapes, dense_inputs, hashed_output, num_buckets, hash_key, out_type, internal_type, name, ctx): # -> SparseCross:
  ...

_SparseCrossHashedOutput = ...
def sparse_cross_hashed(indices, values, shapes, dense_inputs, num_buckets, strong_hash, salt, name=...): # -> SparseCrossHashed:
  r"""Generates sparse cross from a list of sparse and dense tensors.
...
SparseCrossHashed = ...
def sparse_cross_hashed_eager_fallback(indices, values, shapes, dense_inputs, num_buckets, strong_hash, salt, name, ctx): # -> SparseCrossHashed:
  ...

_SparseCrossV2Output = ...
def sparse_cross_v2(indices, values, shapes, dense_inputs, sep, name=...): # -> SparseCrossV2:
  r"""Generates sparse cross from a list of sparse and dense tensors.
...
SparseCrossV2 = ...
def sparse_cross_v2_eager_fallback(indices, values, shapes, dense_inputs, sep, name, ctx): # -> SparseCrossV2:
  ...

def sparse_dense_cwise_add(sp_indices, sp_values, sp_shape, dense, name=...):
...
def sparse_dense_cwise_div(sp_indices, sp_values, sp_shape, dense, name=...):
...
def sparse_dense_cwise_mul(sp_indices, sp_values, sp_shape, dense, name=...):
...
def sparse_fill_empty_rows(indices, values, dense_shape, default_value, name=...): # -> SparseFillEmptyRows:
...
SparseFillEmptyRows = ...
def sparse_fill_empty_rows_eager_fallback(indices, values, dense_shape, default_value, name, ctx): # -> SparseFillEmptyRows:
  ...

_SparseFillEmptyRowsGradOutput = ...
def sparse_fill_empty_rows_grad(reverse_index_map, grad_values, name=...): # -> SparseFillEmptyRowsGrad:
...
def sparse_fill_empty_rows_grad_eager_fallback(reverse_index_map, grad_values, name, ctx): # -> SparseFillEmptyRowsGrad:
  ...

def sparse_reduce_max(input_indices, input_values, input_shape, reduction_axes, keep_dims=..., name=...):
...
def sparse_reduce_max_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims=..., name=...): # -> SparseReduceMaxSparse:
  r"""Computes the max of elements across dimensions of a SparseTensor.
...
def sparse_reduce_max_sparse_eager_fallback(input_indices, input_values, input_shape, reduction_axes, keep_dims, name, ctx): # -> SparseReduceMaxSparse:
  ...

def sparse_reduce_sum(input_indices, input_values, input_shape, reduction_axes, keep_dims=..., name=...):
...
def sparse_reduce_sum_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims=..., name=...): # -> SparseReduceSumSparse:
  r"""Computes the sum of elements across dimensions of a SparseTensor.
...
def sparse_reduce_sum_sparse_eager_fallback(input_indices, input_values, input_shape, reduction_axes, keep_dims, name, ctx): # -> SparseReduceSumSparse:
  ...

_SparseReorderOutput = ...
def sparse_reorder(input_indices, input_values, input_shape, name=...): # -> SparseReorder:
...
SparseReorder = ...
def sparse_reorder_eager_fallback(input_indices, input_values, input_shape, name, ctx): # -> SparseReorder:
  ...

_SparseReshapeOutput = ...
def sparse_reshape(input_indices, input_shape, new_shape, name=...): # -> SparseReshape:
...
SparseReshape = ...
def sparse_reshape_eager_fallback(input_indices, input_shape, new_shape, name, ctx): # -> SparseReshape:
  ...

_SparseSliceOutput = ...
def sparse_slice(indices, values, shape, start, size, name=...): # -> SparseSlice:
...
SparseSlice = ...
def sparse_slice_eager_fallback(indices, values, shape, start, size, name, ctx): # -> SparseSlice:
  ...

def sparse_slice_grad(backprop_val_grad, input_indices, input_start, output_indices, name=...):
...
def sparse_softmax(sp_indices, sp_values, sp_shape, name=...):
...
def sparse_sparse_maximum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name=...): # -> SparseSparseMaximum:
...
SparseSparseMaximum = ...
def sparse_sparse_maximum_eager_fallback(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name, ctx): # -> SparseSparseMaximum:
  ...

_SparseSparseMinimumOutput = ...
def sparse_sparse_minimum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name=...): # -> SparseSparseMinimum:
...
SparseSparseMinimum = ...
def sparse_sparse_minimum_eager_fallback(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name, ctx): # -> SparseSparseMinimum:
  ...

_SparseSplitOutput = ...
def sparse_split(split_dim, indices, values, shape, num_split, name=...): # -> SparseSplit:
...
SparseSplit = ...
def sparse_split_eager_fallback(split_dim, indices, values, shape, num_split, name, ctx): # -> SparseSplit:
  ...

def sparse_tensor_dense_add(a_indices, a_values, a_shape, b, name=...):
...
def sparse_tensor_dense_mat_mul(a_indices, a_values, a_shape, b, adjoint_a=..., adjoint_b=..., name=...):
...
def sparse_to_dense(sparse_indices, output_shape, sparse_values, default_value, validate_indices=..., name=...):
...
def take_many_sparse_from_tensors_map(sparse_handles, dtype, container=..., shared_name=..., name=...): # -> TakeManySparseFromTensorsMap:
...
def take_many_sparse_from_tensors_map_eager_fallback(sparse_handles, dtype, container, shared_name, name, ctx): # -> TakeManySparseFromTensorsMap:
  ...
