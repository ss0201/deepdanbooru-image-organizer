...
@dispatch.add_dispatch_support
def embedding_lookup_v2(params, ids, max_norm=..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | IndexedSlices:
  """Looks up embeddings for the given `ids` from a list of tensors.
...
@dispatch.add_dispatch_support
def embedding_lookup_sparse(params, sp_ids, sp_weights, partition_strategy=..., name=..., combiner=..., max_norm=...): # -> SparseTensor | IndexedSlices | Tensor | Any | object:
...
@dispatch.add_dispatch_support
def embedding_lookup_sparse_v2(params, sp_ids, sp_weights, combiner=..., max_norm=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any | object:
  """Looks up embeddings for the given ids and weights from a list of tensors.
...
@dispatch.add_dispatch_support
def safe_embedding_lookup_sparse_v2(embedding_weights, sparse_ids, sparse_weights=..., combiner=..., default_id=..., max_norm=..., name=...):
...
@dispatch.add_dispatch_support
def safe_embedding_lookup_sparse(embedding_weights, sparse_ids, sparse_weights=..., combiner=..., default_id=..., name=..., partition_strategy=..., max_norm=...):
  """Lookup embedding results, accounting for invalid IDs and empty features.
...
def embedding_lookup_ragged(embedding_weights, ragged_ids, partition_strategy=..., max_norm=..., name=...):
