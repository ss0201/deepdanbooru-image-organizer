...
@dispatch.add_dispatch_support
def matrix_exponential(input, name=...): # -> Tensor | Any:
...
def banded_triangular_solve(bands, rhs, lower=..., adjoint=..., name=...):
...
@dispatch.add_dispatch_support
def tridiagonal_solve(diagonals, rhs, diagonals_format=..., transpose_rhs=..., conjugate_rhs=..., name=..., partial_pivoting=..., perturb_singular=...):
...
@dispatch.add_dispatch_support
def tridiagonal_matmul(diagonals, rhs, diagonals_format=..., name=...):
...
def lu_reconstruct_assertions(lower_upper, perm, validate_args): # -> list[Unknown]:
  """Returns list of assertions related to `lu_reconstruct` assumptions."""
  ...

@tf_export('linalg.eigh_tridiagonal')
@dispatch.add_dispatch_support
def eigh_tridiagonal(alpha, beta, eigvals_only=..., select=..., select_range=..., tol=..., name=...): # -> Tensor | Any | tuple[Any | Unknown, Unknown]:
