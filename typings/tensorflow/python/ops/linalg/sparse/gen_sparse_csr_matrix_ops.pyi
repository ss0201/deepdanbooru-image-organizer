...
def csr_sparse_matrix_components(csr_sparse_matrix, index, type, name=...): # -> CSRSparseMatrixComponents:
...
def csr_sparse_matrix_components_eager_fallback(csr_sparse_matrix, index, type, name, ctx): # -> CSRSparseMatrixComponents:
  ...

def csr_sparse_matrix_to_dense(sparse_input, type, name=...):
...
def csr_sparse_matrix_to_sparse_tensor(sparse_matrix, type, name=...): # -> CSRSparseMatrixToSparseTensor:
...
def csr_sparse_matrix_to_sparse_tensor_eager_fallback(sparse_matrix, type, name, ctx): # -> CSRSparseMatrixToSparseTensor:
  ...

def dense_to_csr_sparse_matrix(dense_input, indices, name=...):
...
def sparse_matrix_add(a, b, alpha, beta, name=...):
...
def sparse_matrix_mat_mul(a, b, transpose_a=..., transpose_b=..., adjoint_a=..., adjoint_b=..., transpose_output=..., conjugate_output=..., name=...):
...
def sparse_matrix_mul(a, b, name=...):
...
def sparse_matrix_nnz(sparse_matrix, name=...):
...
def sparse_matrix_ordering_amd(input, name=...):
...
def sparse_matrix_softmax(logits, type, name=...):
...
def sparse_matrix_softmax_grad(softmax, grad_softmax, type, name=...):
...
def sparse_matrix_sparse_cholesky(input, permutation, type, name=...):
...
def sparse_matrix_sparse_mat_mul(a, b, type, transpose_a=..., transpose_b=..., adjoint_a=..., adjoint_b=..., name=...):
...
def sparse_matrix_transpose(input, type, conjugate=..., name=...):
...
def sparse_matrix_zeros(dense_shape, type, name=...):
...
def sparse_tensor_to_csr_sparse_matrix(indices, values, dense_shape, name=...):
