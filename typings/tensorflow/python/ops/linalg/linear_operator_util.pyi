...
def convert_nonref_to_tensor(value, dtype=..., dtype_hint=..., name=...): # -> Tensor | Any | None:
...
def assert_no_entries_with_modulus_zero(x, message=..., name=...): # -> Any | None:
...
def assert_zero_imag_part(x, message=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
def assert_compatible_matrix_dimensions(operator, x): # -> _dispatcher_for_no_op | object | None:
...
def shape_tensor(shape, name=...): # -> Tensor | Any:
  """Convert Tensor using default type, unless empty list or tuple."""
  ...

def broadcast_matrix_batch_dims(batch_matrices, name=...): # -> list[Unknown]:
...
def matrix_solve_with_broadcast(matrix, rhs, adjoint=..., name=...): # -> _dispatcher_for_matrix_solve | object:
...
def split_arg_into_blocks(block_dims, block_dims_fn, arg, axis=...):
