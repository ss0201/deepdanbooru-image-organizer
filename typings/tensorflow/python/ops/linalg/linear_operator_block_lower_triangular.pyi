...
class LinearOperatorBlockLowerTriangular(linear_operator.LinearOperator):
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  @property
  def operators(self): # -> list[list[Unknown]]:
    ...
  
  def matmul(self, x, adjoint=..., adjoint_arg=..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def matvec(self, x, adjoint=..., name=...): # -> list[Unknown]:
  ...
  def solve(self, rhs, adjoint=..., adjoint_arg=..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def solvevec(self, rhs, adjoint=..., name=...): # -> list[Unknown]:
