...
class LinearOperator(module.Module, composite_tensor.CompositeTensor, metaclass=abc.ABCMeta):
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  def graph_parents(self): # -> list[Unknown]:
  ...
  def shape_tensor(self, name=...): # -> Tensor | Any:
  ...
  def tensor_rank_tensor(self, name=...): # -> Tensor | Any:
    """Rank (in the sense of tensors) of matrix corresponding to this operator.
  ...
  def domain_dimension_tensor(self, name=...): # -> Tensor | Any:
    """Dimension (in the sense of vector spaces) of the domain of this operator.
  ...
  def range_dimension_tensor(self, name=...): # -> Tensor | Any:
    """Dimension (in the sense of vector spaces) of the range of this operator.
  ...
  def assert_non_singular(self, name=...): # -> Any | None:
  ...
  def assert_positive_definite(self, name=...): # -> Any | None:
  ...
  def assert_self_adjoint(self, name=...): # -> _dispatcher_for_no_op | object | None:
  ...
  def matmul(self, x, adjoint=..., adjoint_arg=..., name=...):
  ...
  def determinant(self, name=...): # -> _dispatcher_for_matrix_determinant | object:
  ...
  def solve(self, rhs, adjoint=..., adjoint_arg=..., name=...): # -> _dispatcher_for_matrix_solve | object:
  ...
  def adjoint(self, name=...): # -> Self@LinearOperator:
  ...
  def to_dense(self, name=...):
    """Return a dense (batch) matrix representing this operator."""
    ...
  
  def diag_part(self, name=...):
...
class _LinearOperatorSpec(type_spec.BatchableTypeSpec):
  ...
  @classmethod
  def from_operator(cls, operator): # -> Self@_LinearOperatorSpec:
