...
@dispatch.add_dispatch_support
def assert_negative_v2(x, message=..., summarize=..., name=...): # -> Any | None:
...
def assert_negative(x, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_positive', v1=[])
@dispatch.add_dispatch_support
def assert_positive_v2(x, message=..., summarize=..., name=...): # -> Any | None:
  """Assert the condition `x > 0` holds element-wise.
...
def assert_positive(x, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_non_negative', v1=[])
@dispatch.add_dispatch_support
def assert_non_negative_v2(x, message=..., summarize=..., name=...): # -> Any | None:
  """Assert the condition `x >= 0` holds element-wise.
...
def assert_non_negative(x, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_non_positive', v1=[])
@dispatch.add_dispatch_support
def assert_non_positive_v2(x, message=..., summarize=..., name=...): # -> Any | None:
  """Assert the condition `x <= 0` holds element-wise.
...
def assert_non_positive(x, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_equal', 'assert_equal', v1=[])
@dispatch.register_binary_elementwise_assert_api
@dispatch.add_dispatch_support
def assert_equal_v2(x, y, message=..., summarize=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
def assert_equal(x, y, data=..., summarize=..., message=..., name=...): # -> _dispatcher_for_no_op | object | None:
  ...

@tf_export('debugging.assert_none_equal', v1=[])
@dispatch.register_binary_elementwise_assert_api
@dispatch.add_dispatch_support
def assert_none_equal_v2(x, y, summarize=..., message=..., name=...): # -> Any | None:
...
def assert_none_equal(x, y, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_near', v1=[])
@dispatch.register_binary_elementwise_assert_api
@dispatch.add_dispatch_support
def assert_near_v2(x, y, rtol=..., atol=..., message=..., summarize=..., name=...): # -> Any | None:
...
def assert_near(x, y, rtol=..., atol=..., data=..., summarize=..., message=..., name=...): # -> Any | None:
  """Assert the condition `x` and `y` are close element-wise.
...
@dispatch.register_binary_elementwise_assert_api
@dispatch.add_dispatch_support
def assert_less_v2(x, y, message=..., summarize=..., name=...): # -> Any | None:
  """Assert the condition `x < y` holds element-wise.
...
def assert_less(x, y, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_less_equal', v1=[])
@dispatch.register_binary_elementwise_assert_api
@dispatch.add_dispatch_support
def assert_less_equal_v2(x, y, message=..., summarize=..., name=...): # -> Any | None:
  """Assert the condition `x <= y` holds element-wise.
...
def assert_less_equal(x, y, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_greater', 'assert_greater', v1=[])
@dispatch.register_binary_elementwise_assert_api
@dispatch.add_dispatch_support
def assert_greater_v2(x, y, message=..., summarize=..., name=...): # -> Any | None:
  """Assert the condition `x > y` holds element-wise.
...
def assert_greater(x, y, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_greater_equal', v1=[])
@dispatch.register_binary_elementwise_assert_api
@dispatch.add_dispatch_support
def assert_greater_equal_v2(x, y, message=..., summarize=..., name=...): # -> Any | None:
  """Assert the condition `x >= y` holds element-wise.
...
def assert_greater_equal(x, y, data=..., summarize=..., message=..., name=...): # -> Any | None:
  ...

@tf_export('debugging.assert_rank', 'assert_rank', v1=[])
@dispatch.add_dispatch_support
def assert_rank_v2(x, rank, message=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
@dispatch.add_dispatch_support
def assert_rank(x, rank, data=..., summarize=..., message=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
@dispatch.add_dispatch_support
def assert_rank_at_least_v2(x, rank, message=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
def assert_rank_at_least(x, rank, data=..., summarize=..., message=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
@dispatch.add_dispatch_support
def assert_rank_in_v2(x, ranks, message=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
def assert_rank_in(x, ranks, data=..., summarize=..., message=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
def assert_integer(x, message=..., name=...): # -> _dispatcher_for_no_op | object | None:
  """Assert that `x` is of integer dtype.
...
def assert_type(tensor, tf_type, message=..., name=...): # -> _dispatcher_for_no_op | object | None:
...
@dispatch.add_dispatch_support
def assert_shapes(shapes, data=..., summarize=..., message=..., name=...): # -> _dispatcher_for_no_op | object | None:
  """Assert tensor shapes and dimension size relationships between tensors.
...
def assert_scalar(tensor, name=..., message=...): # -> Tensor | Any:
