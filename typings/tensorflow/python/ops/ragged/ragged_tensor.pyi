...
class RaggedTensor(composite_tensor.CompositeTensor, internal_types.NativeObject):
  ...
  * `tf.RaggedTensor.from_nested_value_rowids`
  ...
  def from_value_rowids(cls, values, value_rowids, nrows=..., name=..., validate=...): # -> Self@RaggedTensor:
  ...
  @classmethod
  @dispatch.add_dispatch_support
  def from_row_lengths(cls, values, row_lengths, name=..., validate=...): # -> Self@RaggedTensor:
  ...
  @classmethod
  @dispatch.add_dispatch_support
  def from_row_starts(cls, values, row_starts, name=..., validate=...): # -> Self@RaggedTensor:
  ...
  @classmethod
  @dispatch.add_dispatch_support
  def from_row_limits(cls, values, row_limits, name=..., validate=...): # -> Self@RaggedTensor:
  ...
  @classmethod
  @dispatch.add_dispatch_support
  def from_uniform_row_length(cls, values, uniform_row_length, nrows=..., validate=..., name=...): # -> Self@RaggedTensor:
  ...
  @classmethod
  @dispatch.add_dispatch_support
  def from_nested_value_rowids(cls, flat_values, nested_value_rowids, nested_nrows=..., name=..., validate=...): # -> Self@RaggedTensor:
  ...
  @classmethod
  @dispatch.add_dispatch_support
  def from_nested_row_lengths(cls, flat_values, nested_row_lengths, name=..., validate=...): # -> Self@RaggedTensor:
  ...
  @property
  def ragged_rank(self): # -> Literal[1]:
  ...
  @property
  def values(self): # -> RaggedTensor | Unknown:
  ...
  def nested_value_rowids(self, name=...): # -> tuple[Unknown | Any, ...]:
  ...
  def nrows(self, out_type=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  ...
  def row_lengths(self, axis=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any | RaggedTensor:
  ...
  def nested_row_lengths(self, name=...): # -> tuple[Unknown, ...]:
  ...
  def bounding_shape(self, axis=..., name=..., out_type=...): # -> SparseTensor | IndexedSlices | Tensor | Any | object | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
  ...
  def with_row_splits_dtype(self, dtype): # -> Self@RaggedTensor | RaggedTensor:
  ...
  def merge_dims(self, outer_axis, inner_axis): # -> RaggedTensor | Unknown:
  ...
  @classmethod
  @dispatch.add_dispatch_support
  def from_tensor(cls, tensor, lengths=..., padding=..., ragged_rank=..., name=..., row_splits_dtype=...): # -> Self@RaggedTensor | RaggedTensor:
  ...
  def to_tensor(self, default_value=..., name=..., shape=...):
  ...
  @classmethod
  @dispatch.add_dispatch_support
  def from_sparse(cls, st_input, name=..., row_splits_dtype=...): # -> Self@RaggedTensor:
...
def match_row_splits_dtypes(*tensors, **kwargs): # -> tuple[DType, tuple[RaggedTensor | Unknown, ...] | tuple[Unknown, ...]] | tuple[RaggedTensor | Unknown, ...] | tuple[Unknown, ...]:
...
class RaggedTensorSpec(type_spec.BatchableTypeSpec):
  ...
  @classmethod
  def from_value(cls, value): # -> Self@RaggedTensorSpec:
    ...
  


def convert_to_tensor_or_ragged_tensor(value, dtype=..., preferred_dtype=..., name=...): # -> RaggedTensor | Tensor | Any:
...
def merge_dims(value, outer_axis, inner_axis): # -> RaggedTensor | Unknown:
