...
from tensorflow.python.framework import dtypes, extension_type, ops, tensor_shape, tensor_spec
...
class _DynamicRaggedShapeBatchEncoder(extension_type.ExtensionTypeBatchEncoder):
  ...
  def encode(self, spec: DynamicRaggedShape.Spec, value, minimum_rank=...) -> Union[ragged_tensor.RaggedTensor, ops.Tensor]:
    ...
...
class DynamicRaggedShape(extension_type.BatchableExtensionType):
  ...
  * `row_partitions`: A list of `RowPartition` objects, describing how
  ...
  def static_lengths(self, ragged_lengths=...): # -> list[ellipsis] | list[int | None] | list[int | Unknown | None]:
  ...
  def __getitem__(self, index): # -> DynamicRaggedShape | Self@DynamicRaggedShape | None:
  ...
  def with_dtype(self, dtype): # -> Self@DynamicRaggedShape | DynamicRaggedShape:
...
def broadcast_to(rt_input, shape: DynamicRaggedShape): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor | object:
...
def ragged_binary_elementwise_op_impl(op, x, y): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor | bool | RaggedTensor:
...
class _LayerBroadcaster(abc.ABC):
  ...
  def dest_nrows(self): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
class _GatherLayerBroadcaster(_LayerBroadcaster):
  ...
  @property
  def gather_index(self): # -> Tensor | Any:
    ...
...
class _Broadcaster:
  ...
  def broadcast_flat_values(self, rt, inner_dimensions=...): # -> _dispatcher_for_broadcast_to | object:
  ...
  def broadcast(self, rt): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor | object:
