...
def string_bytes_split(input, name=...): # -> RaggedTensor | Any:
...
@dispatch.add_dispatch_support
def unicode_decode(input, input_encoding, errors=..., replacement_char=..., replace_control_characters=..., name=...): # -> tuple[Unknown | RaggedTensor | Any, Unknown | Unbound | RaggedTensor | Any] | RaggedTensor | Any:
...
@dispatch.add_dispatch_support
def unicode_decode_with_offsets(input, input_encoding, errors=..., replacement_char=..., replace_control_characters=..., name=...): # -> tuple[Unknown | RaggedTensor | Any, Unknown | Unbound | RaggedTensor | Any] | RaggedTensor | Any:
...
@dispatch.add_dispatch_support
def unicode_split_with_offsets(input, input_encoding, errors=..., replacement_char=..., name=...): # -> tuple[Unknown | RaggedTensor | Any, Unknown | RaggedTensor | Any]:
...
@dispatch.add_dispatch_support
def string_split_v2(input, sep=..., maxsplit=..., name=...): # -> RaggedTensor | Any:
...
def string_split(source, sep=..., skip_empty=..., delimiter=..., result_type=..., name=...): # -> SparseTensor | RaggedTensor:
...
@dispatch.add_dispatch_support
def strings_split_v1(input=..., sep=..., maxsplit=..., result_type=..., source=..., name=...): # -> SparseTensor | Any | RaggedTensor:
...
def reduce_join(inputs: ragged_tensor.Ragged, axis=..., keepdims=..., separator=..., name=...): # -> RaggedTensor | Any:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...

@tf_export("strings.ngrams")
@dispatch.add_dispatch_support
def ngrams(data, ngram_width, separator=..., pad_values=..., padding_width=..., preserve_short_sequences=..., name=...): # -> RaggedTensor | Any:
...
def string_format(template: str, inputs: typing.Union[ragged_tensor.Ragged, typing.List[ragged_tensor.RaggedOrDense]], placeholder=..., summarize=..., name=...):
  """Version of tf.strings.format that handles RaggedTensors."""
  ...

def ragged_tensor_to_string(rt, summarize=...):
