...
def boolean_mask(data, mask, name=...): # -> RaggedTensor:
...
def tile(input: ragged_tensor.Ragged, multiples, name=...): # -> _dispatcher_for_tile | object:
...
def expand_dims(input: ragged_tensor.Ragged, axis, name=...): # -> RaggedTensor:
...
def size(input: ragged_tensor.Ragged, out_type=..., name=...): # -> Tensor | Any:
...
def rank(input: ragged_tensor.Ragged, name=...):
...
@dispatch.add_dispatch_support
def stack_dynamic_partitions(data, partitions, num_partitions, name=...): # -> RaggedTensor:
...
def dynamic_partition(data: ragged_tensor.RaggedOrDense, partitions: ragged_tensor.RaggedOrDense, num_partitions, name=...): # -> list[Unknown]:
  """RaggedTensor dispatch override for tf.dynamic_partition."""
  ...

@dispatch.dispatch_for_api(array_ops.split)
def split(value: ragged_tensor.Ragged, num_or_size_splits, axis=..., num=..., name=...): # -> list[Ragged]:
...
def ones(shape: dynamic_ragged_shape.DynamicRaggedShape, dtype=..., name=...) -> ragged_tensor.RaggedOrDense:
  """Returns ones shaped like x."""
  ...

@dispatch.dispatch_for_api(array_ops.zeros)
def zeros(shape: dynamic_ragged_shape.DynamicRaggedShape, dtype=..., name=...) -> ragged_tensor.RaggedOrDense:
  """Returns ones shaped like x."""
  ...

@dispatch.dispatch_for_api(array_ops.fill)
def fill(dims: dynamic_ragged_shape.DynamicRaggedShape, value: core_types.TensorLike, name: Optional[str] = ...) -> ragged_tensor.RaggedOrDense:
