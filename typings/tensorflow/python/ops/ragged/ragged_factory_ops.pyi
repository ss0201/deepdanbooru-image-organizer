...
def constant(pylist, dtype=..., ragged_rank=..., inner_shape=..., name=..., row_splits_dtype=...):
...
@dispatch.add_dispatch_support
def constant_value(pylist, dtype=..., ragged_rank=..., inner_shape=..., row_splits_dtype=...):
...
@dispatch.add_dispatch_support
def placeholder(dtype, ragged_rank, value_shape=..., name=...):
