...
def concat(values: typing.List[ragged_tensor.RaggedOrDense], axis, name=...): # -> RaggedTensor | Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
...
def stack(values: typing.List[ragged_tensor.RaggedOrDense], axis=..., name=...): # -> RaggedTensor | Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy:
