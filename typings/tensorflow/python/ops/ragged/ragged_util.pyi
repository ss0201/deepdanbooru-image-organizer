...
"""
def assert_splits_match(nested_splits_lists): # -> list[Unknown | _dispatcher_for_no_op | object | None]:
...
repeat = ...
def lengths_to_splits(lengths): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
