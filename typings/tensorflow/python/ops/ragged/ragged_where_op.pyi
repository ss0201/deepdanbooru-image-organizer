...
def where_v2(condition: ragged_tensor.RaggedOrDense, x: typing.Optional[ragged_tensor.RaggedOrDense] = ..., y: typing.Optional[ragged_tensor.RaggedOrDense] = ..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def where(condition: ragged_tensor.RaggedOrDense, x: typing.Optional[ragged_tensor.RaggedOrDense] = ..., y: typing.Optional[ragged_tensor.RaggedOrDense] = ..., name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | RaggedTensor:
