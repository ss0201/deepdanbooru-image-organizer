...
class RaggedTensorDynamicShape:
  ...
  @classmethod
  def from_tensor(cls, rt_input, dim_size_dtype=...): # -> Self@RaggedTensorDynamicShape | RaggedTensorDynamicShape:
    """Constructs a ragged shape for a potentially ragged tensor."""
    ...
  
  def dimension_size(self, axis): # -> SparseTensor | IndexedSlices | Tensor | Any:
    """Returns the size of slices across the specified dimension."""
    ...
  
  def is_ragged(self, axis): # -> bool | Any:
    """Returns true if the indicated dimension is ragged."""
    ...
  
  @property
  def rank(self): # -> int | TensorShape | None:
    """The number of dimensions in this shape, or None if unknown."""
    ...
  
  @property
  def partitioned_dim_sizes(self): # -> tuple[Unknown | SparseTensor | IndexedSlices | Tensor | Any, ...]:
  ...
  @property
  def inner_dim_sizes(self): # -> SparseTensor | IndexedSlices | Tensor | Any:
  ...
  @property
  def num_inner_dimensions(self): # -> int | TensorShape | None:
    """The number of inner dimensions, or `None` if not statically known."""
    ...
  
  @property
  def dim_size_dtype(self): # -> DType | Any:
    """DType used by this shape for dimension sizes."""
    ...
  
  def broadcast_to_rank(self, rank): # -> Self@RaggedTensorDynamicShape | RaggedTensorDynamicShape:
  ...
  def with_dim_size_dtype(self, dtype): # -> Self@RaggedTensorDynamicShape | RaggedTensorDynamicShape:
    ...
...
def broadcast_to(rt_input, shape, broadcast_inner_dimensions=...): # -> _dispatcher_for_broadcast_to | object | Tensor | RaggedTensor:
