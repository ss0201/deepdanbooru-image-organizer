...
def ragged_reduce_aggregate(reduce_op, unsorted_segment_op, rt_input, axis, keepdims, separator=..., name=...): # -> RaggedTensor | Any:
...
def reduce_sum(input_tensor: ragged_tensor.Ragged, axis=..., keepdims=..., name=...): # -> RaggedTensor | Any:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...

@dispatch.dispatch_for_api(math_ops.reduce_prod)
def reduce_prod(input_tensor: ragged_tensor.Ragged, axis=..., keepdims=..., name=...): # -> RaggedTensor | Any:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...

@dispatch.dispatch_for_api(math_ops.reduce_min)
def reduce_min(input_tensor: ragged_tensor.Ragged, axis=..., keepdims=..., name=...): # -> RaggedTensor | Any:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...

@dispatch.dispatch_for_api(math_ops.reduce_max)
def reduce_max(input_tensor: ragged_tensor.Ragged, axis=..., keepdims=..., name=...): # -> RaggedTensor | Any:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...
...
def reduce_variance(input_tensor: ragged_tensor.Ragged, axis=..., keepdims=..., name=...): # -> _dispatcher_for_maximum | object:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...
...
def reduce_all(input_tensor: ragged_tensor.Ragged, axis=..., keepdims=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...

@dispatch.dispatch_for_api(math_ops.reduce_any)
def reduce_any(input_tensor: ragged_tensor.Ragged, axis=..., keepdims=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """For docs, see: _RAGGED_REDUCE_DOCSTRING."""
  ...

@dispatch.dispatch_for_api(math_ops.matmul)
def matmul(a: ragged_tensor.RaggedOrDense, b: ragged_tensor.RaggedOrDense, transpose_a=..., transpose_b=..., adjoint_a=..., adjoint_b=..., a_is_sparse=..., b_is_sparse=..., output_type=..., name=...): # -> RaggedTensor | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def softmax(logits: ragged_tensor.Ragged, axis=..., name=...): # -> _dispatcher_for_real_div | object:
...
def add_n(inputs: typing.List[ragged_tensor.RaggedOrDense], name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor:
