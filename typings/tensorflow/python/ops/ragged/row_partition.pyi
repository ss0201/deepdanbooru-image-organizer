...
class RowPartition(composite_tensor.CompositeTensor):
  ...
  @classmethod
  def from_value_rowids(cls, value_rowids, nrows=..., validate=..., dtype=..., dtype_hint=...): # -> Self@RowPartition:
  ...
  @classmethod
  def from_row_splits(cls, row_splits, validate=..., dtype=..., dtype_hint=...): # -> Self@RowPartition:
  ...
  @classmethod
  def from_row_lengths(cls, row_lengths, validate=..., dtype=..., dtype_hint=...): # -> Self@RowPartition:
  ...
  @classmethod
  def from_row_starts(cls, row_starts, nvals, validate=..., dtype=..., dtype_hint=...): # -> Self@RowPartition:
  ...
  @classmethod
  def from_row_limits(cls, row_limits, validate=..., dtype=..., dtype_hint=...): # -> Self@RowPartition:
  ...
  @classmethod
  def from_uniform_row_length(cls, uniform_row_length, nvals=..., nrows=..., validate=..., dtype=..., dtype_hint=...):
  ...
  def with_dtype(self, dtype): # -> Self@RowPartition | RowPartition:
...
class RowPartitionSpec(type_spec.TypeSpec):
  ...
  @property
  def nrows(self): # -> int | TensorShape | None:
    ...
  
  @property
  def nvals(self): # -> int | TensorShape | None:
    ...
  
  @property
  def uniform_row_length(self): # -> int | TensorShape | None:
    ...
  ...
  @classmethod
  def from_value(cls, value): # -> Self@RowPartitionSpec:
    ...
