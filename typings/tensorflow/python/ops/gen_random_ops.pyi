...
"""
def multinomial(logits, num_samples, seed=..., seed2=..., output_dtype=..., name=...):
...
def parameterized_truncated_normal(shape, means, stdevs, minvals, maxvals, seed=..., seed2=..., name=...):
...
def random_gamma(shape, alpha, seed=..., seed2=..., name=...):
...
def random_gamma_grad(alpha, sample, name=...):
...
def random_poisson(shape, rate, seed=..., seed2=..., name=...):
...
def random_poisson_v2(shape, rate, seed=..., seed2=..., dtype=..., name=...):
...
def random_shuffle(value, seed=..., seed2=..., name=...):
...
def random_standard_normal(shape, dtype, seed=..., seed2=..., name=...):
...
def random_uniform(shape, dtype, seed=..., seed2=..., name=...):
...
def random_uniform_int(shape, minval, maxval, seed=..., seed2=..., name=...):
...
def truncated_normal(shape, dtype, seed=..., seed2=..., name=...):
