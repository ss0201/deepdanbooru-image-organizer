...
"""
def case(branch_index, input, Tout, branches, output_shapes=..., name=...):
...
def device_index(device_names, name=...):
...
def fake_param(dtype, shape, name=...):
...
For = ...
If = ...
def partitioned_call(args, Tout, f, config=..., config_proto=..., executor_type=..., name=...):
...
def remote_call(target, args, Tout, f, name=...):
...
def stateful_partitioned_call(args, Tout, f, config=..., config_proto=..., executor_type=..., name=...):
  r"""returns `f(inputs)`, where `f`'s body is placed and partitioned.
...
def stateless_case(branch_index, input, Tout, branches, output_shapes=..., name=...):
  r"""An n-way switch statement which calls a single branch function.
...
def stateless_if(cond, input, Tout, then_branch, else_branch, output_shapes=..., name=...):
...
def stateless_while(input, cond, body, output_shapes=..., parallel_iterations=..., name=...):
...
def symbolic_gradient(input, Tout, f, name=...):
