...
def unique_fn_name(scope, name): # -> LiteralString:
...
def unique_grad_fn_name(forward_name): # -> LiteralString:
  ...
...
def get_op_and_outputs(op_or_outputs): # -> tuple[Operation, list[Unknown]] | tuple[None, list[Unknown]] | tuple[Unknown, Unknown]:
  ...
