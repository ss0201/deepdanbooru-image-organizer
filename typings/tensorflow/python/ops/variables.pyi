...
def validate_synchronization_aggregation_trainable(synchronization, aggregation, trainable, name): # -> tuple[VariableSynchronization, VariableAggregationV2 | VariableAggregation, bool | Unknown]:
...
class Variable(trackable.Trackable, metaclass=VariableMetaclass):
  ...
  class SaveSliceInfo:
    ...
    * var_shape
    ...
    def to_proto(self, export_scope=...): # -> SaveSliceInfoDef | None:
...
class RefVariable(VariableV1, core.Tensor):
  ...
  def value(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | Tensor | Operation | None:
    """Returns the last snapshot of this variable.
  ...
  @property
  def initial_value(self): # -> Tensor | Any | Operation | None:
    """Returns the Tensor used as the initial value for the variable.
  ...
  def scatter_nd_max(self, indices, updates, name=...):
    """Updates this variable with the max of `tf.IndexedSlices` and itself.
  ...
  def scatter_nd_min(self, indices, updates, name=...):
    """Updates this variable with the min of `tf.IndexedSlices` and itself.
  ...
  @property
  def initializer(self): # -> Tensor | Operation | None:
    """The initializer operation for this variable."""
    ...
  ...
  def to_proto(self, export_scope=...): # -> VariableDef | None:
    """Converts a `Variable` to a `VariableDef` protocol buffer.
...
class PartitionedVariable:
  ...
  def as_tensor(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  @property
  def shape(self): # -> Unknown:
    ...
  
  def get_shape(self): # -> Unknown:
    ...
  
  def assign(self, value, use_locking=..., name=..., read_value=...): # -> list[Unknown]:
    ...
  
  def assign_add(self, value, use_locking=..., name=..., read_value=...): # -> list[Unknown]:
    ...
  
  def assign_sub(self, value, use_locking=..., name=..., read_value=...): # -> list[Unknown]:
    ...
  


@tf_export(v1=["global_variables"])
def global_variables(scope=...): # -> list[Unknown]:
...
def model_variables(scope=...): # -> list[Unknown]:
...
def trainable_variables(scope=...): # -> list[Unknown]:
...
def moving_average_variables(scope=...): # -> list[Unknown]:
...
def variables_initializer(var_list, name=...): # -> _dispatcher_for_no_op | object | None:
...
def initialize_variables(var_list, name=...): # -> _dispatcher_for_no_op | object | None:
  """See `tf.compat.v1.variables_initializer`."""
  ...

@tf_export(v1=["initializers.global_variables", "global_variables_initializer"])
def global_variables_initializer(): # -> _dispatcher_for_no_op | object | None:
...
def initialize_all_variables(): # -> _dispatcher_for_no_op | object | None:
  """See `tf.compat.v1.global_variables_initializer`."""
  ...

@tf_export(v1=["initializers.local_variables", "local_variables_initializer"])
def local_variables_initializer(): # -> _dispatcher_for_no_op | object | None:
...
def initialize_local_variables(): # -> _dispatcher_for_no_op | object | None:
...
@tf_should_use.should_use_result
def assert_variables_initialized(var_list=...): # -> Tensor | Any | None:
...
@tf_should_use.should_use_result
def report_uninitialized_variables(var_list=..., name=...):
