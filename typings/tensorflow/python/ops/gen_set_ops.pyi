...
def dense_to_dense_set_operation(set1, set2, set_operation, validate_indices=..., name=...): # -> DenseToDenseSetOperation:
...
def dense_to_dense_set_operation_eager_fallback(set1, set2, set_operation, validate_indices, name, ctx): # -> DenseToDenseSetOperation:
  ...

_DenseToSparseSetOperationOutput = ...
def dense_to_sparse_set_operation(set1, set2_indices, set2_values, set2_shape, set_operation, validate_indices=..., name=...): # -> DenseToSparseSetOperation:
...
def dense_to_sparse_set_operation_eager_fallback(set1, set2_indices, set2_values, set2_shape, set_operation, validate_indices, name, ctx): # -> DenseToSparseSetOperation:
  ...

def set_size(set_indices, set_values, set_shape, validate_indices=..., name=...):
...
def sparse_to_sparse_set_operation(set1_indices, set1_values, set1_shape, set2_indices, set2_values, set2_shape, set_operation, validate_indices=..., name=...): # -> SparseToSparseSetOperation:
...
def sparse_to_sparse_set_operation_eager_fallback(set1_indices, set1_values, set1_shape, set2_indices, set2_values, set2_shape, set_operation, validate_indices, name, ctx): # -> SparseToSparseSetOperation:
  ...
