...
"""
def banded_triangular_solve(matrix, rhs, lower=..., adjoint=..., name=...):
  r"""TODO: add doc.
...
def batch_cholesky_grad(l, grad, name=...):
  r"""TODO: add doc.
...
def batch_matrix_determinant(input, name=...):
  r"""TODO: add doc.
...
def batch_matrix_inverse(input, adjoint=..., name=...):
  r"""TODO: add doc.
...
def batch_matrix_solve(matrix, rhs, adjoint=..., name=...):
  r"""TODO: add doc.
...
def batch_matrix_solve_ls(matrix, rhs, l2_regularizer, fast=..., name=...):
  r"""TODO: add doc.
...
def batch_matrix_triangular_solve(matrix, rhs, lower=..., adjoint=..., name=...):
  r"""TODO: add doc.
...
def batch_self_adjoint_eig(input, name=...):
  r"""TODO: add doc.
...
def batch_self_adjoint_eig_v2(input, compute_v=..., name=...): # -> BatchSelfAdjointEigV2:
  r"""TODO: add doc.
...
def batch_self_adjoint_eig_v2_eager_fallback(input, compute_v, name, ctx): # -> BatchSelfAdjointEigV2:
  ...

_BatchSvdOutput = ...
def batch_svd(input, compute_uv=..., full_matrices=..., name=...): # -> BatchSvd:
  r"""TODO: add doc.
...
BatchSvd = ...
def batch_svd_eager_fallback(input, compute_uv, full_matrices, name, ctx): # -> BatchSvd:
  ...
...
def cholesky(input, name=...): # -> _dispatcher_for_cholesky | object:
...
_EigOutput = ...
def eig(input, Tout, compute_v=..., name=...): # -> Eig:
...
Eig = ...
def eig_eager_fallback(input, Tout, compute_v, name, ctx): # -> Eig:
  ...

def einsum(inputs, equation, name=...):
...
def log_matrix_determinant(input, name=...): # -> LogMatrixDeterminant:
...
def log_matrix_determinant_eager_fallback(input, name, ctx): # -> LogMatrixDeterminant:
  ...
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('linalg.lu')
def lu(input, output_idx_type=..., name=...): # -> Lu | _dispatcher_for_lu | object:
...
def lu_eager_fallback(input, output_idx_type, name, ctx): # -> Lu:
  ...
...
def matrix_determinant(input, name=...): # -> _dispatcher_for_matrix_determinant | object:
...
def matrix_exponential(input, name=...):
...
def matrix_inverse(input, adjoint=..., name=...): # -> _dispatcher_for_matrix_inverse | object:
...
def matrix_logarithm(input, name=...):
...
def matrix_solve(matrix, rhs, adjoint=..., name=...): # -> _dispatcher_for_matrix_solve | object:
...
def matrix_solve_ls(matrix, rhs, l2_regularizer, fast=..., name=...):
...
def matrix_square_root(input, name=...): # -> _dispatcher_for_matrix_square_root | object:
...
def matrix_triangular_solve(matrix, rhs, lower=..., adjoint=..., name=...):
...
def qr(input, full_matrices=..., name=...): # -> Qr | _dispatcher_for_qr | object:
...
def qr_eager_fallback(input, full_matrices, name, ctx): # -> Qr:
  ...

def self_adjoint_eig(input, name=...):
...
def self_adjoint_eig_v2(input, compute_v=..., name=...): # -> SelfAdjointEigV2:
...
SelfAdjointEigV2 = ...
def self_adjoint_eig_v2_eager_fallback(input, compute_v, name, ctx): # -> SelfAdjointEigV2:
  ...

_SvdOutput = ...
def svd(input, compute_uv=..., full_matrices=..., name=...): # -> Svd:
...
Svd = ...
def svd_eager_fallback(input, compute_uv, full_matrices, name, ctx): # -> Svd:
  ...

def tridiagonal_mat_mul(superdiag, maindiag, subdiag, rhs, name=...):
...
def tridiagonal_solve(diagonals, rhs, partial_pivoting=..., perturb_singular=..., name=...):
