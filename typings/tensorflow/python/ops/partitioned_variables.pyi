...
def variable_axis_size_partitioner(max_shard_bytes, axis=..., bytes_per_string_element=..., max_shards=...): # -> (shape: Unknown, dtype: Unknown) -> Unknown:
...
def min_max_variable_partitioner(max_partitions=..., axis=..., min_slice_size=..., bytes_per_string_element=...): # -> (shape: Unknown, dtype: Unknown) -> list[int]:
...
def fixed_size_partitioner(num_shards, axis=...): # -> (shape: Unknown, **unused_args: Unknown) -> list[int]:
...
def create_partitioned_variables(shape, slicing, initializer, dtype=..., trainable=..., collections=..., name=..., reuse=...): # -> list[Unknown]:
