...
def custom_gradient(f=...): # -> (f: Unknown) -> Unknown:
...
class Bind:
  ...
  """
  @classmethod
  def decorator(cls, d): # -> (f: Unknown) -> Bind:
    ...
  
  def __init__(self, f, d) -> None:
    ...
  
  def __get__(self, instance, owner): # -> Self@Bind:
    ...
...
def get_variable_by_name(var_name): # -> None:
