...
def squeeze_batch_dims(inp, op, inner_rank, name=...):
...
def dilation2d_v2(input, filters, strides, padding, data_format, dilations, name=...):
...
@dispatch.add_dispatch_support
def dilation2d_v1(input, filter=..., strides=..., rates=..., padding=..., name=..., filters=..., dilations=...):
  ...

@tf_export("nn.with_space_to_batch")
@dispatch.add_dispatch_support
def with_space_to_batch(input, dilation_rate, padding, op, filter_shape=..., spatial_dims=..., data_format=...): # -> _dispatcher_for_batch_to_space_nd | object:
...
class _WithSpaceToBatch:
  ...
  def __call__(self, inp, filter): # -> _dispatcher_for_batch_to_space_nd | object:
    ...
...
@dispatch.add_dispatch_support
def convolution(input, filter, padding, strides=..., dilation_rate=..., name=..., data_format=..., filters=..., dilations=...):
...
@dispatch.add_dispatch_support
def convolution_v2(input, filters, strides=..., padding=..., data_format=..., dilations=..., name=...):
  ...

def convolution_internal(input, filters, strides=..., padding=..., data_format=..., dilations=..., name=..., call_from_convolution=..., num_spatial_dims=...):
...
@dispatch.add_dispatch_support
def pool(input, window_shape, pooling_type, padding, dilation_rate=..., strides=..., name=..., data_format=..., dilations=...): # -> _dispatcher_for_batch_to_space_nd | object:
...
@dispatch.add_dispatch_support
def pool_v2(input, window_shape, pooling_type, strides=..., padding=..., data_format=..., dilations=..., name=...): # -> _dispatcher_for_batch_to_space_nd | object:
  """Performs an N-D pooling operation.
...
@dispatch.add_dispatch_support
def atrous_conv2d(value, filters, rate, padding, name=...):
...
def convert_padding(padding, expected_length=...): # -> tuple[Unknown | Literal['EXPLICIT'], list[Unknown]]:
...
def conv1d(value=..., filters=..., stride=..., padding=..., use_cudnn_on_gpu=..., data_format=..., name=..., input=..., dilations=...):
...
@dispatch.add_dispatch_support
def conv1d_v2(input, filters, stride, padding, data_format=..., dilations=..., name=...):
...
@dispatch.add_dispatch_support
def conv1d_transpose(input, filters, output_shape, strides, padding=..., data_format=..., dilations=..., name=...):
...
@dispatch.add_dispatch_support
def conv2d_v2(input, filters, strides, padding, data_format=..., dilations=..., name=...):
...
@dispatch.add_dispatch_support
def conv2d(input, filter=..., strides=..., padding=..., use_cudnn_on_gpu=..., data_format=..., dilations=..., name=..., filters=...):
...
@dispatch.add_dispatch_support
def conv2d_backprop_filter(input, filter_sizes, out_backprop, strides, padding, use_cudnn_on_gpu=..., data_format=..., dilations=..., name=...):
...
@dispatch.add_dispatch_support
def conv2d_backprop_input(input_sizes, filter=..., out_backprop=..., strides=..., padding=..., use_cudnn_on_gpu=..., data_format=..., dilations=..., name=..., filters=...):
...
@dispatch.add_dispatch_support
def conv2d_transpose(value=..., filter=..., output_shape=..., strides=..., padding=..., data_format=..., name=..., input=..., filters=..., dilations=...):
...
@dispatch.add_dispatch_support
def conv2d_transpose_v2(input, filters, output_shape, strides, padding=..., data_format=..., dilations=..., name=...):
  """The transpose of `conv2d`.
...
@dispatch.add_dispatch_support
def atrous_conv2d_transpose(value, filters, output_shape, rate, padding, name=...): # -> _dispatcher_for_batch_to_space_nd | object:
...
def depthwise_conv2d_native(input, filter, strides, padding, data_format=..., dilations=..., name=...):
...
def depthwise_conv2d_native_backprop_input(input_sizes, filter, out_backprop, strides, padding, data_format=..., dilations=..., name=...):
...
def depthwise_conv2d_native_backprop_filter(input, filter_sizes, out_backprop, strides, padding, data_format=..., dilations=..., name=...):
...
@dispatch.add_dispatch_support
def conv3d_v2(input, filters, strides, padding, data_format=..., dilations=..., name=...):
  ...

@tf_export(v1=["nn.conv3d"])
@dispatch.add_dispatch_support
def conv3d_v1(input, filter=..., strides=..., padding=..., data_format=..., dilations=..., name=..., filters=...):
  ...

@tf_export(v1=["nn.conv3d_transpose"])
@dispatch.add_dispatch_support
def conv3d_transpose(value, filter=..., output_shape=..., strides=..., padding=..., data_format=..., name=..., input=..., filters=..., dilations=...):
...
@dispatch.add_dispatch_support
def conv3d_transpose_v2(input, filters, output_shape, strides, padding=..., data_format=..., dilations=..., name=...):
  """The transpose of `conv3d`.
...
@dispatch.add_dispatch_support
def conv_transpose(input, filters, output_shape, strides, padding=..., data_format=..., dilations=..., name=...):
...
@dispatch.add_dispatch_support
def crelu(features, name=..., axis=...): # -> _dispatcher_for_relu | object:
...
@dispatch.add_dispatch_support
def crelu_v2(features, axis=..., name=...): # -> _dispatcher_for_relu | object:
  ...
...
@dispatch.add_dispatch_support
def softmax_v2(logits, axis=..., name=...): # -> tuple[Unknown, ...]:
...
def softmax(logits, axis=..., name=..., dim=...): # -> tuple[Unknown, ...]:
  ...
...
@dispatch.add_dispatch_support
@deprecation.deprecated_args(None, "dim is deprecated, use axis instead", "dim")
def log_softmax(logits, axis=..., name=..., dim=...): # -> tuple[Unknown, ...]:
...
@dispatch.add_dispatch_support
def log_softmax_v2(logits, axis=..., name=...): # -> tuple[Unknown, ...]:
  """Computes log softmax activations.
...
@dispatch.add_dispatch_support
def softmax_cross_entropy_with_logits_v2(labels, logits, axis=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
def softmax_cross_entropy_with_logits_v2_helper(labels, logits, axis=..., name=..., dim=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """Computes softmax cross entropy between `logits` and `labels`.
...
def softmax_cross_entropy_with_logits(_sentinel=..., labels=..., logits=..., dim=..., name=..., axis=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """Computes softmax cross entropy between `logits` and `labels`.
...
@dispatch.add_dispatch_support
def sparse_softmax_cross_entropy_with_logits(_sentinel=..., labels=..., logits=..., name=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
@dispatch.add_dispatch_support
def sparse_softmax_cross_entropy_with_logits_v2(labels, logits, name=...): # -> SparseTensor | IndexedSlices | Tensor | Any:
  """Computes sparse softmax cross entropy between `logits` and `labels`.
...
@dispatch.add_dispatch_support
def avg_pool(value, ksize, strides, padding, data_format=..., name=..., input=...):
...
@dispatch.add_dispatch_support
def avg_pool2d(input, ksize, strides, padding, data_format=..., name=...):
  """Performs the average pooling on the input.
...
@dispatch.add_dispatch_support
def avg_pool1d(input, ksize, strides, padding, data_format=..., name=...):
  """Performs the average pooling on the input.
...
@dispatch.add_dispatch_support
def max_pool(value, ksize, strides, padding, data_format=..., name=..., input=...):
...
@dispatch.add_dispatch_support
def max_pool1d(input, ksize, strides, padding, data_format=..., name=...):
  """Performs the max pooling on the input.
...
@dispatch.add_dispatch_support
def max_pool2d(input, ksize, strides, padding, data_format=..., name=...):
...
@dispatch.add_dispatch_support
def xw_plus_b(x, weights, biases, name=...):
...
def xw_plus_b_v1(x, weights, biases, name=...):
  """Computes matmul(x, weights) + biases.
...
def dropout(x, keep_prob=..., noise_shape=..., seed=..., name=..., rate=...): # -> Tensor | Any:
  """Computes dropout.
...
@dispatch.add_dispatch_support
def dropout_v2(x, rate, noise_shape=..., seed=..., name=...): # -> Tensor | Any:
...
@dispatch.add_dispatch_support
def stateless_dropout(x, rate, seed, rng_alg=..., noise_shape=..., name=...): # -> Tensor | Any:
  """Computes dropout: randomly sets elements to zero to prevent overfitting.
...
@dispatch.add_dispatch_support
def top_k(input, k=..., sorted=..., name=...): # -> TopKV2:
...
@dispatch.add_dispatch_support
def approx_max_k(operand, k, reduction_dimension=..., recall_target=..., reduction_input_size_override=..., aggregate_to_topk=..., name=...):
...
@dispatch.add_dispatch_support
def approx_min_k(operand, k, reduction_dimension=..., recall_target=..., reduction_input_size_override=..., aggregate_to_topk=..., name=...):
...
@dispatch.add_dispatch_support
def erosion2d(value, kernel, strides, rates, padding, name=...): # -> _dispatcher_for_neg | object:
...
@dispatch.add_dispatch_support
def erosion2d_v2(value, filters, strides, padding, data_format, dilations, name=...): # -> _dispatcher_for_neg | object:
...
@dispatch.add_dispatch_support
def in_top_k_v2(targets, predictions, k, name=...):
  ...

@tf_export("nn.isotonic_regression", v1=[])
@dispatch.add_dispatch_support
def isotonic_regression(inputs, decreasing=..., axis=...): # -> tuple[Unknown, ...]:
