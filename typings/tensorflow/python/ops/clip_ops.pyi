...
def clip_by_value(t, clip_value_min, clip_value_max, name=...): # -> IndexedSlices | _dispatcher_for_maximum | object:
...
@dispatch.add_dispatch_support
def clip_by_norm(t, clip_norm, axes=..., name=...): # -> IndexedSlices | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
@dispatch.add_dispatch_support
def clip_by_global_norm(t_list, clip_norm, use_norm=..., name=...): # -> tuple[list[IndexedSlices | Unknown], Unknown]:
...
@dispatch.add_dispatch_support
def clip_by_average_norm(t, clip_norm, name=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
