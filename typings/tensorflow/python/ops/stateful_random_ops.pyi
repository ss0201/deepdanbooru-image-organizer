...
def create_rng_state(seed, alg): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class Generator(autotrackable.AutoTrackable):
  ...
  """
  @classmethod
  def from_state(cls, state, alg): # -> Self@Generator:
  ...
  @classmethod
  def from_seed(cls, seed, alg=...): # -> Self@Generator:
  ...
  @classmethod
  def from_non_deterministic_state(cls, alg=...): # -> Self@Generator:
  ...
  @classmethod
  def from_key_counter(cls, key, counter, alg): # -> Self@Generator:
  ...
  @property
  def algorithm(self): # -> int | Any | Tensor:
  ...
  def uniform(self, shape, minval=..., maxval=..., dtype=..., name=...):
  ...
  def uniform_full_int(self, shape, dtype=..., name=...):
  ...
  def binomial(self, shape, counts, probs, dtype=..., name=...):
  ...
  def make_seeds(self, count=...): # -> Tensor | Any:
