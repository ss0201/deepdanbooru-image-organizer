...
class ObjectGraphProtoPrettyPrinter:
  ...
  @property
  def node_names(self): # -> dict[Unknown, Unknown]:
...
class _CheckpointRestoreCoordinator:
  ...
  def restore_saveables(self, tensor_saveables, python_positions, registered_savers=...): # -> list[Unknown]:
...
class _NameBasedRestoreCoordinator:
  ...
  def globally_named_object_attributes(self, trackable): # -> Generator[SaveableObject | ReferenceVariableSaveable | ResourceVariableSaveable | Unknown, None, None]:
...
def object_metadata(save_path): # -> TrackableObjectGraph:
...
def gather_initializers(root_trackable): # -> list[Unknown]:
...
def capture_dependencies(template): # -> Generator[None, None, None]:
...
class _LoadStatus:
  ...
  def expect_partial(self): # -> Self@_LoadStatus:
...
class CheckpointLoadStatus(_LoadStatus):
  ...
  def assert_consumed(self): # -> Self@CheckpointLoadStatus:
  ...
  def assert_existing_objects_matched(self): # -> Self@CheckpointLoadStatus:
  ...
  def assert_nontrivial_match(self): # -> Self@CheckpointLoadStatus:
    """Raises an exception if only the root object matched."""
    ...
  ...
  def expect_partial(self): # -> Self@CheckpointLoadStatus:
    """Silence warnings about incomplete checkpoint restores."""
    ...
...
class NameBasedSaverStatus(_LoadStatus):
  ...
  def assert_consumed(self): # -> Self@NameBasedSaverStatus:
    """Raises an exception if any variables are unmatched."""
    ...
  
  def assert_existing_objects_matched(self): # -> Self@NameBasedSaverStatus:
    """Raises an exception if currently created objects are unmatched."""
    ...
  
  def assert_nontrivial_match(self): # -> Self@NameBasedSaverStatus:
    """Raises an exception if currently created objects are unmatched."""
    ...
...
class TrackableSaver:
  ...
  def save(self, file_prefix, checkpoint_number=..., session=..., options=..., update_ckpt_state=...): # -> Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy | None:
...
class CheckpointV1(autotrackable.AutoTrackable):
  ...
  def write(self, file_prefix, session=...): # -> text_type | Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy | None:
  ...
  def save(self, file_prefix, session=...): # -> text_type | Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy | None:
...
class Checkpoint(autotrackable.AutoTrackable):
  ...
  def write(self, file_prefix, options=...): # -> text_type | Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy | None:
    """Writes a training checkpoint.
  ...
  def save(self, file_prefix, options=...): # -> text_type | Tensor | Any | defaultdict[Unknown, Unknown] | list[Unknown] | ObjectProxy | None:
    """Saves a training checkpoint and provides basic checkpoint management.
