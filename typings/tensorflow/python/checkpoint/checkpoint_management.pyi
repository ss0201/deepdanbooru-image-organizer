...
def generate_checkpoint_state_proto(save_dir, model_checkpoint_path, all_model_checkpoint_paths=..., all_model_checkpoint_timestamps=..., last_preserved_timestamp=...): # -> CheckpointState:
...
def get_checkpoint_mtimes(checkpoint_prefixes): # -> list[Unknown]:
...
class CheckpointManager:
  ...
  @property
  def checkpoints(self): # -> list[Unknown]:
