...
def sequence_length_from_sparse_tensor(sp_tensor, num_elements=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def check_default_value(shape, default_value, dtype, key): # -> tuple[Unknown, ...] | float | None:
