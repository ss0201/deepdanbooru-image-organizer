...
def make_parse_example_spec_v2(feature_columns): # -> dict[Unknown, Unknown]:
...
def shared_embedding_columns(categorical_columns, dimension, combiner=..., initializer=..., shared_embedding_collection_name=..., ckpt_to_load_from=..., tensor_name_in_ckpt=..., max_norm=..., trainable=..., use_safe_embedding_lookup=...): # -> list[Unknown]:
...
def shared_embedding_columns_v2(categorical_columns, dimension, combiner=..., initializer=..., shared_embedding_collection_name=..., ckpt_to_load_from=..., tensor_name_in_ckpt=..., max_norm=..., trainable=..., use_safe_embedding_lookup=...): # -> list[Unknown]:
  """List of dense columns that convert from sparse, categorical input.
...
class FeatureTransformationCache:
  ...
  def get(self, key, state_manager, training=...): # -> SparseTensor | Tensor | Any | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy:
...
class NumericColumn(DenseColumn, fc_old._DenseColumn, collections.namedtuple('NumericColumn', ('key', 'shape', 'default_value', 'dtype', 'normalizer_fn'))):
  ...
  @property
  def parse_example_spec(self): # -> dict[Unknown, FixedLenFeature]:
    """See `FeatureColumn` base class."""
    ...
  
  def transform_feature(self, transformation_cache, state_manager): # -> SparseTensor | IndexedSlices | Tensor | Any:
    """See `FeatureColumn` base class.
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@NumericColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class BucketizedColumn(DenseColumn, CategoricalColumn, fc_old._DenseColumn, fc_old._CategoricalColumn, collections.namedtuple('BucketizedColumn', ('source_column', 'boundaries'))):
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@BucketizedColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class EmbeddingColumn(DenseColumn, SequenceDenseColumn, fc_old._DenseColumn, fc_old._SequenceDenseColumn, collections.namedtuple('EmbeddingColumn', ('categorical_column', 'dimension', 'combiner', 'initializer', 'ckpt_to_load_from', 'tensor_name_in_ckpt', 'max_norm', 'trainable', 'use_safe_embedding_lookup'))):
  ...
  def __new__(cls, categorical_column, dimension, combiner, initializer, ckpt_to_load_from, tensor_name_in_ckpt, max_norm, trainable, use_safe_embedding_lookup=...): # -> Self@EmbeddingColumn:
    ...
  ...
  def get_dense_tensor(self, transformation_cache, state_manager): # -> SparseTensor | IndexedSlices | Tensor | Any | object:
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@EmbeddingColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class SharedEmbeddingColumn(DenseColumn, SequenceDenseColumn, fc_old._DenseColumn, fc_old._SequenceDenseColumn, collections.namedtuple('SharedEmbeddingColumn', ('categorical_column', 'shared_embedding_column_creator', 'combiner', 'max_norm', 'use_safe_embedding_lookup'))):
  """See `embedding_column`."""
  def __new__(cls, categorical_column, shared_embedding_column_creator, combiner, max_norm, use_safe_embedding_lookup=...): # -> Self@SharedEmbeddingColumn:
    ...
...
class HashedCategoricalColumn(CategoricalColumn, fc_old._CategoricalColumn, collections.namedtuple('HashedCategoricalColumn', ('key', 'hash_bucket_size', 'dtype'))):
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@HashedCategoricalColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class VocabularyFileCategoricalColumn(CategoricalColumn, fc_old._CategoricalColumn, collections.namedtuple('VocabularyFileCategoricalColumn', ('key', 'vocabulary_file', 'vocabulary_size', 'num_oov_buckets', 'dtype', 'default_value', 'file_format'))):
  ...
  def __new__(cls, key, vocabulary_file, vocabulary_size, num_oov_buckets, dtype, default_value, file_format=...): # -> Self@VocabularyFileCategoricalColumn:
    ...
  ...
  def transform_feature(self, transformation_cache, state_manager): # -> SparseTensor | RaggedTensor | _dispatcher_for_string_to_hash_bucket_fast | object:
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@VocabularyFileCategoricalColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class VocabularyListCategoricalColumn(CategoricalColumn, fc_old._CategoricalColumn, collections.namedtuple('VocabularyListCategoricalColumn', ('key', 'vocabulary_list', 'dtype', 'default_value', 'num_oov_buckets'))):
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@VocabularyListCategoricalColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class IdentityCategoricalColumn(CategoricalColumn, fc_old._CategoricalColumn, collections.namedtuple('IdentityCategoricalColumn', ('key', 'number_buckets', 'default_value'))):
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@IdentityCategoricalColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class WeightedCategoricalColumn(CategoricalColumn, fc_old._CategoricalColumn, collections.namedtuple('WeightedCategoricalColumn', ('categorical_column', 'weight_feature_key', 'dtype'))):
  ...
  def transform_feature(self, transformation_cache, state_manager): # -> tuple[SparseTensor | Unknown | Any, Unknown | SparseTensor | IndexedSlices | Tensor | Any]:
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@WeightedCategoricalColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class CrossedColumn(CategoricalColumn, fc_old._CategoricalColumn, collections.namedtuple('CrossedColumn', ('keys', 'hash_bucket_size', 'hash_key'))):
  ...
  @property
  def parse_example_spec(self): # -> dict[Unknown, Unknown]:
    """See `FeatureColumn` base class."""
    ...
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@CrossedColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class IndicatorColumn(DenseColumn, SequenceDenseColumn, fc_old._DenseColumn, fc_old._SequenceDenseColumn, collections.namedtuple('IndicatorColumn', 'categorical_column')):
  ...
  def transform_feature(self, transformation_cache, state_manager): # -> _dispatcher_for_scatter_nd | object:
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@IndicatorColumn:
    """See 'FeatureColumn` base class."""
    ...
...
class SequenceCategoricalColumn(CategoricalColumn, fc_old._SequenceCategoricalColumn, collections.namedtuple('SequenceCategoricalColumn', 'categorical_column')):
  ...
  @classmethod
  def from_config(cls, config, custom_objects=..., columns_by_name=...): # -> Self@SequenceCategoricalColumn:
    """See 'FeatureColumn` base class."""
    ...
