...
def parse_message(message): # -> tuple[LiteralString, list[Unknown], list[Unknown]]:
...
def create_graph_debug_info_def(func_named_operations): # -> GraphDebugInfo:
...
def interpolate(message, graph): # -> str:
