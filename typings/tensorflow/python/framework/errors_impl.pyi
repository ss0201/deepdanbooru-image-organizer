...
class OpError(Exception):
  ...
  def __reduce__(self): # -> tuple[Type[Self@OpError], tuple[Any, ...]]:
    ...
  
  @property
  def message(self): # -> Unknown:
  ...
  @property
  def error_code(self): # -> Unknown:
    """The integer error code that describes the error."""
    ...
  
  @property
  def node_def(self): # -> Unknown:
    """The `NodeDef` proto representing the op that failed."""
    ...
  
  @property
  def experimental_payloads(self): # -> dict[Unknown, Unknown]:
...
def error_code_from_exception_type(cls): # -> int | UnknownError:
  ...
