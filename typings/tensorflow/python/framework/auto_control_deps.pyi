...
def collective_manager_ids_from_op(op): # -> list[Unknown]:
...
class AutomaticControlDependencies:
  ...
  NOT THREAD SAFE
  """
  def __init__(self, record_initial_resource_uses=..., record_uses_of_resource_ids=...) -> None:
    ...
  
  def mark_as_return(self, tensor): # -> IndexedSlices | SparseTensor | TensorArray | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  ...
  def __enter__(self): # -> Self@AutomaticControlDependencies:
    ...
