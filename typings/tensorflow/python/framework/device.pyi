...
def canonical_name(device): # -> str | LiteralString:
...
class MergeDevice:
  ...
  def __call__(self, node_def): # -> DeviceSpecV2 | DeviceSpecV1:
    ...
  
  def shortcut_string_merge(self, node_def): # -> str | LiteralString:
