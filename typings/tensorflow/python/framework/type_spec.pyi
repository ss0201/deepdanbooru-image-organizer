...
class TypeSpec(trace.TraceType, trace_type.Serializable, metaclass=abc.ABCMeta):
  ...
  def __reduce__(self): # -> tuple[Type[Self@TypeSpec], Unknown]:
    ...
...
class LegacyTypeSpecBatchEncoder(TypeSpecBatchEncoder):
  ...
  def encode(self, type_spec, value, minimum_rank=...): # -> List[Unknown]:
    ...
...
def get_batchable_flat_tensor_specs(spec, context_spec=...): # -> list[Unknown] | list[None]:
  """Returns the flat tensor specs for `spec`."""
  ...

def batchable_to_tensor_list(spec, value, minimum_rank=...): # -> list[Unknown] | list[None]:
...
_NAME_TO_TYPE_SPEC = ...
_REGISTERED_NAME_RE = ...
def register(name): # -> (cls: Unknown) -> Type[TypeSpec]:
