...
def dimension_value(dimension): # -> int | None:
...
class TensorShape(trace.TraceType, trace_type.Serializable):
  ...
  * *Unknown shape:* has an unknown number of dimensions, and an unknown
  ...
  __nonzero__ = ...
  def __iter__(self): # -> Generator[int | Unknown | None, None, None] | Generator[Dimension, None, None]:
    """Returns `self.dims` if the rank is known, otherwise raises ValueError."""
    ...
  
  def __getitem__(self, key): # -> TensorShape | int | Dimension | None:
  ...
  def merge_with(self, other): # -> TensorShape | Self@TensorShape:
  ...
  def with_rank(self, rank): # -> TensorShape | Self@TensorShape:
  ...
  def with_rank_at_least(self, rank): # -> Self@TensorShape:
  ...
  def with_rank_at_most(self, rank): # -> Self@TensorShape:
  ...
  def as_proto(self): # -> TensorShapeProto:
