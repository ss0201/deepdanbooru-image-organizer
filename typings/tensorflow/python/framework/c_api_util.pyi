...
class ApiDefMap:
  ...
  def get_api_def(self, op_name): # -> ApiDef:
    ...
  
  def get_op_def(self, op_name):
    ...
  
  def op_names(self): # -> dict_keys[Unknown, Unknown]:
    ...
  


@tf_contextlib.contextmanager
def tf_buffer(data=...): # -> Generator[Unknown, None, None]:
...
def tf_operations(graph): # -> Generator[Unknown, None, None]:
...
def new_tf_operations(graph): # -> Generator[Unknown, None, None]:
