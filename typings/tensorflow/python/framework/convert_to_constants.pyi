...
class _Convertible:
  ...
  @property
  def outgoing_edges(self): # -> list[Unknown]:
...
class _Function(_Convertible):
  ...
  @property
  def function(self): # -> Unknown:
    ...
  
  @property
  def nodes(self): # -> dict[Unknown, _VarHandle | _Case | _Merge | _PartitionedCall | _ReadVariable | _ResourceGather | _ResourceGatherNd | _If | _While | _Intermediate | _Node]:
    ...
...
class _GraphDef(_Convertible):
  ...
  @property
  def functions(self): # -> dict[Unknown, _Function]:
    ...
  
  @property
  def converted_function_names(self): # -> dict[Unknown, str]:
...
class _ConverterData:
  ...
  @property
  def node_defs(self): # -> dict[Unknown, Unknown]:
  ...
  @property
  def tensor_data(self): # -> dict[Unknown, Unknown]:
...
def disable_lower_using_switch_merge(graph_def): # -> GraphDef:
...
def convert_variables_to_constants_v2(func, lower_control_flow=..., aggressive_inlining=...): # -> Any:
...
def convert_var_to_const_function_in_v1(func, lower_control_flow=..., aggressive_inlining=...): # -> Any:
  """Replaces all the variables in a graph with constants of the same values.
...
def convert_variables_to_constants_v2_as_graph(func, lower_control_flow=..., aggressive_inlining=...): # -> tuple[Any, GraphDef]:
  """Replaces all the variables in a graph with constants of the same values.
...
def convert_variables_to_constants_from_session_graph(session, graph_def, output_node_names, variable_names_allowlist=..., variable_names_denylist=...): # -> GraphDef:
  """Replaces all the variables in a graph with constants of the same values.
