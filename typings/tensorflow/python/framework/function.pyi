...
class _DefinedFunction:
  ...
  @property
  def definition(self): # -> FunctionDef | None:
  ...
  @property
  def declared_input_types(self): # -> Unknown:
    """Returns the list of data types of explicit declared inputs."""
    ...
  
  @property
  def captured_inputs(self): # -> list[Unknown]:
    """Returns the list of implicitly captured inputs."""
    ...
  
  @property
  def stateful_ops(self): # -> list[tuple[Unknown, Unknown]]:
  ...
  def __call__(self, *args, **kwargs): # -> tuple[Unknown, ...] | Operation:
    ...
...
class _FuncGraph(ops.Graph):
  ...
  def getvar(self, getter, name, shape=..., dtype=..., initializer=..., reuse=..., trainable=..., collections=..., use_resource=..., **kwargs): # -> BaseResourceVariable:
  ...
  @property
  def captures(self): # -> list[tuple[Unknown, Unknown]]:
...
def from_library(lib): # -> dict_values[Unknown, Unknown] | list[Unknown]:
...
def get_extra_vars(): # -> list[Unknown]:
...
def get_extra_inputs(): # -> list[Unknown]:
...
def get_extra_args(): # -> list[Unknown]:
