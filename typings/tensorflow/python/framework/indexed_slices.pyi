...
class IndexedSlices(internal.NativeObject, composite_tensor.CompositeTensor):
  ...
  * `indices`: A 1-D integer `Tensor` with shape `[D0]`.
  ...
  @property
  def values(self): # -> Unknown:
    """A `Tensor` containing the values of the slices."""
    ...
  
  @property
  def indices(self): # -> Unknown:
...
def convert_to_tensor_or_indexed_slices(value, dtype=..., name=...): # -> Any | NativeObject:
...
def internal_convert_to_tensor_or_indexed_slices(value, dtype=..., name=..., as_ref=...): # -> Any | NativeObject:
  """Converts the given object to a `Tensor` or an `IndexedSlices`.
...
def internal_convert_n_to_tensor_or_indexed_slices(values, dtype=..., name=..., as_ref=...): # -> list[Unknown]:
...
def convert_n_to_tensor_or_indexed_slices(values, dtype=..., name=...): # -> list[Unknown]:
