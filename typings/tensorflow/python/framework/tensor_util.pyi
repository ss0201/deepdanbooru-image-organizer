...
def GetNumpyAppendFn(dtype): # -> ((tensor_proto: Unknown, proto_values: Unknown) -> None) | None:
  ...

def TensorShapeProtoToList(shape): # -> list[Unknown]:
...
def MakeNdarray(tensor): # -> ndarray[Any, Unknown] | ndarray[Unknown, Unknown]:
...
is_tensor = ...
def shape_tensor(shape): # -> Tensor | Any:
