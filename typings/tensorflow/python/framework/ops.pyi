...
from tensorflow.python.util import decorator_utils, deprecation, dispatch, tf_contextlib, traceback_utils
...
_tf_function_api_guage = ...
_DTYPES_INTERN_TABLE = ...
...
class _UserDeviceSpec:
  ...
  def string_merge(self, node_def): # -> str | LiteralString:
    ...
...
def value_text(tensor, is_repr=...): # -> str:
...
class Tensor(internal.NativeObject, core_tf_types.Tensor):
  ...
  * a shape
  ...
  @property
  def value_index(self): # -> Unknown:
    """The index of this tensor in the outputs of its `Operation`."""
    ...
  
  def consumers(self): # -> list[Unknown]:
  ...
  def __tf_tracing_type__(self, signature_context): # -> Any:
    ...
...
class _EagerTensorBase(Tensor):
  ...
  def __reduce__(self): # -> tuple[(value: Unknown, dtype: Unknown | None = None, name: Unknown | None = None, as_ref: bool = False, preferred_dtype: Unknown | None = None, dtype_hint: Unknown | None = None, ctx: Unknown | None = None, accepted_result_types: Unknown = (Tensor, )) -> (Unknown | Tensor | Any), tuple[Unknown]]:
    ...
  
  def __copy__(self): # -> Self@_EagerTensorBase:
    ...
  
  def __deepcopy__(self, memo): # -> Self@_EagerTensorBase:
    ...
  ...
  def numpy(self): # -> ndarray[Unknown, Unknown]:
...
def convert_to_tensor_v1_with_dispatch(value, dtype=..., name=..., preferred_dtype=..., dtype_hint=...): # -> Tensor | Any:
...
def convert_to_tensor_v1(value, dtype=..., name=..., preferred_dtype=..., dtype_hint=...): # -> Tensor | Any:
  """Converts the given `value` to a `Tensor` (with the TF1 API)."""
  ...

@tf_export("convert_to_tensor", v1=[])
@dispatch.add_dispatch_support
def convert_to_tensor_v2_with_dispatch(value, dtype=..., dtype_hint=..., name=...): # -> Tensor | Any:
  """Converts the given `value` to a `Tensor`.
...
def convert_to_tensor_v2(value, dtype=..., dtype_hint=..., name=...): # -> Tensor | Any:
  """Converts the given `value` to a `Tensor`."""
  ...

def pack_eager_tensors(tensors, ctx=...):
...
def convert_to_tensor(value, dtype=..., name=..., as_ref=..., preferred_dtype=..., dtype_hint=..., ctx=..., accepted_result_types=...): # -> Tensor | Any:
  """Implementation of the public convert_to_tensor."""
  ...

internal_convert_to_tensor = ...
def internal_convert_n_to_tensor(values, dtype=..., name=..., as_ref=..., preferred_dtype=..., ctx=...): # -> list[Unknown]:
...
def convert_n_to_tensor(values, dtype=..., name=..., preferred_dtype=...): # -> list[Unknown]:
  """Converts `values` to a list of `Tensor` objects.
...
def convert_to_tensor_or_composite(value, dtype=..., name=...): # -> CompositeTensor | Tensor | Any:
...
def internal_convert_to_tensor_or_composite(value, dtype=..., name=..., as_ref=...): # -> CompositeTensor | Tensor | Any:
  """Converts the given object to a `Tensor` or `CompositeTensor`.
...
def internal_convert_n_to_tensor_or_composite(values, dtype=..., name=..., as_ref=...): # -> list[Unknown]:
...
def convert_n_to_tensor_or_composite(values, dtype=..., name=...): # -> list[Unknown]:
...
class Operation:
  ...
  def colocation_groups(self): # -> list[bytes] | list[DType | Unknown | Any]:
  ...
  @property
  def control_inputs(self): # -> list[Unknown]:
  ...
  def get_attr(self, name): # -> list[DType | Unknown] | list[Any] | DType | Any:
...
class OpStats:
  ...
  def __iadd__(self, other): # -> Self@OpStats:
    ...
...
def get_stats_for_node_def(graph, node, statistic_type): # -> OpStats:
...
_MUTATION_LOCK_GROUP = ...
_SESSION_RUN_LOCK_GROUP = ...
...
class Graph:
  ...
  @property
  def graph_def_versions(self): # -> VersionDef:
  ...
  def as_graph_def(self, from_version=..., add_shapes=...): # -> GraphDef:
  ...
  def as_graph_element(self, obj, allow_tensor=..., allow_operation=...): # -> Tensor | Operation | None:
  ...
  def get_operations(self): # -> list[Unknown]:
  ...
  def get_operation_by_name(self, name): # -> Tensor | Operation | None:
  ...
  def get_tensor_by_name(self, name): # -> Tensor | Operation | None:
  ...
  def as_default(self): # -> Generator[Unknown, None, None]:
  ...
  def get_collection_ref(self, name): # -> list[Unknown]:
  ...
  def get_collection(self, name, scope=...): # -> list[Unknown]:
    """Returns a list of values in the collection with the given `name`.
  ...
  @tf_contextlib.contextmanager
  def name_scope(self, name): # -> Generator[Unknown | str, None, None]:
  ...
  def get_name_scope(self): # -> Any | Literal['']:
  ...
  @tf_contextlib.contextmanager
  def colocate_with(self, op, ignore_existing=...): # -> Generator[None, None, None]:
  ...
  @tf_contextlib.contextmanager
  def container(self, container_name): # -> Generator[Unknown, None, None]:
...
@tf_export(v1=["device"])
def device(device_name_or_function): # -> Generator[None, None, None]:
...
@tf_export("device", v1=[])
def device_v2(device_name): # -> Generator[None, None, None]:
...
def container(container_name): # -> Generator[Unknown, None, None]:
...
def colocate_with(op, ignore_existing=...): # -> Generator[None, None, None] | NullContextmanager:
  ...

@tf_export("control_dependencies")
def control_dependencies(control_inputs): # -> NullContextmanager | _ControlDependenciesController:
...
class _DefaultStack(threading.local):
  ...
  @tf_contextlib.contextmanager
  def get_controller(self, default): # -> Generator[Unknown, None, None]:
...
def default_session(session): # -> Generator[Unknown, None, None]:
...
def get_name_scope(): # -> Any | Literal['']:
...
def get_collection_ref(key): # -> list[Unknown]:
...
def get_collection(key, scope=...): # -> list[Unknown]:
...
def name_scope(name, default_name=..., values=..., skip_on_eager=...): # -> internal_name_scope_v1 | NullContextmanager | name_scope_v2:
...
class name_scope_v1:
  ...
  def __exit__(self, *exc_info): # -> Literal[False] | None:
    ...
  


@tf_export("get_current_name_scope", v1=[])
def get_current_name_scope(): # -> Any | Literal['']:
...
class name_scope_v2:
  ...
  def __getstate__(self): # -> tuple[str | Unknown, Unknown | list[Unknown]]:
    ...
...
def strip_name_scope(name, export_scope): # -> str:
...
def prepend_name_scope(name, import_scope): # -> str:
...
@tf_contextlib.contextmanager
def op_scope(values, name, default_name=...): # -> Generator[Unknown | str | None, None, None]:
...
def get_collection_proto_type(collection_name): # -> None:
  """Returns the proto_type for collection_name."""
  ...

def get_to_proto_function(collection_name): # -> None:
  """Returns the to_proto function for collection_name."""
  ...

def get_from_proto_function(collection_name): # -> None:
...
class _TensorIterator:
  ...
  def __iter__(self): # -> Self@_TensorIterator:
    ...
