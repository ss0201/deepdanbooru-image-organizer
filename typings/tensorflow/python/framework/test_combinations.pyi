...
class TestCombination:
  ...
  def context_managers(self, kwargs): # -> list[Unknown]:
...
class OptionalParameter(ParameterModifier):
  ...
  """
  def modified_arguments(self, kwargs, requested_parameters): # -> dict[Unknown | None, object]:
    ...
...
def combine(**kwargs): # -> list[OrderedDict[Unknown, Unknown]]:
...
def times(*combined): # -> list[Unknown]:
