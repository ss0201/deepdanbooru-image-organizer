...
def convert_structure_to_signature(structure, arg_names=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
class CapturesContainer:
  """A container class to store captures with a dict."""
  def __init__(self) -> None:
    ...
  
  def add_capture(self, identifier: Hashable, func: Callable[[], Any]): # -> None:
    ...
  
  def update(self, container: CapturesContainer): # -> None:
    ...
...
class FuncGraph(ops.Graph):
  ...
  @property
  def output_types(self): # -> list[Unknown]:
    ...
  
  @property
  def output_shapes(self): # -> list[Unknown]:
    ...
  ...
  def capture(self, tensor, name=..., shape=...):
  ...
  @property
  def captures(self): # -> _odict_values[Unknown, Unknown]:
  ...
  def pop_capture(self, tensor): # -> None:
  ...
  def capture_distributed_variable(self, variable, placeholder): # -> None:
  ...
  def captured(self, tensor): # -> bool:
    """Check if the specified tensor has been captured."""
    ...
  
  @property
  def external_captures(self): # -> list[Unknown]:
    """External tensors captured by this function."""
    ...
  
  @property
  def internal_captures(self): # -> list[Unknown]:
    """Placeholders in this function corresponding captured tensors."""
    ...
  
  @property
  def deferred_external_captures(self): # -> list[Unknown]:
    """Ordered nest of tensors whose placeholders will be fed at call time."""
    ...
  
  @property
  def deferred_internal_captures(self): # -> list[Unknown]:
    """List of nest of placeholders which at call time will be fed."""
    ...
  
  @property
  def variable_captures(self): # -> dict[int, Unknown]:
  ...
  @property
  def saving_errors(self): # -> set[Unknown]:
    """Returns set of errors preventing this FuncGraph from being saved."""
    ...
  


def func_graph_from_py_func(name, python_func, args, kwargs, signature=..., func_graph=..., autograph=..., autograph_options=..., add_control_dependencies=..., arg_names=..., op_return_value=..., collections=..., capture_by_value=..., acd_record_initial_resource_uses=...): # -> FuncGraph:
...
def flatten(sequence): # -> list[Unknown | Tensor | None]:
...
def pack_sequence_as(structure, flat_sequence): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
