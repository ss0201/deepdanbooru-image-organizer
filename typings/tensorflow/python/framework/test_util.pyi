...
def is_xla_enabled(): # -> Literal[False]:
  ...
...
def assert_ops_in_graph(expected_ops, graph): # -> dict[Unknown, Unknown]:
...
def assert_equal_graph_def_v1(actual, expected, checkpoint_v2=..., hash_table_shared_name=...): # -> None:
  """Asserts that two `GraphDef`s are (mostly) the same.
...
def assert_equal_graph_def(actual, expected, checkpoint_v2=..., hash_table_shared_name=...): # -> None:
  ...
...
def NHWCToNCHW(input_tensor): # -> list[Unknown]:
...
def NHWCToNCHW_VECT_C(input_shape_or_tensor): # -> list[Unknown]:
...
def NCHW_VECT_CToNHWC(input_shape_or_tensor): # -> list[Unknown]:
...
def NCHWToNHWC(input_tensor): # -> list[Unknown]:
...
def skip_if(condition): # -> (fn: Unknown) -> ((*args: Unknown, **kwargs: Unknown) -> (Unknown | None)):
...
def skip_if_error(test_obj, error_type, messages=...): # -> Generator[None, None, None]:
...
def enable_control_flow_v2(fn): # -> (*args: Unknown, **kwargs: Unknown) -> Unknown:
...
def disable_control_flow_v2(unused_msg): # -> (func: Unknown) -> Unknown:
...
def enable_output_all_intermediates(fn): # -> (*args: Unknown, **kwargs: Unknown) -> Unknown:
...
def assert_no_new_pyobjects_executing_eagerly(func=..., warmup_iters=...): # -> ((f: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> None)) | ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> None):
...
def assert_no_new_tensors(f): # -> (self: Unknown, **kwargs: Unknown) -> Unknown:
...
def assert_no_garbage_created(f): # -> (self: Unknown, **kwargs: Unknown) -> Unknown:
...
def enable_eager_op_as_function(fn): # -> (*args: Unknown, **kwargs: Unknown) -> Unknown:
...
def with_eager_op_as_function(cls=..., only_as_function=...): # -> (cls: Unknown) -> Unknown:
...
def enable_graph_building_optimization(fn): # -> (*args: Unknown, **kwargs: Unknown) -> Unknown:
...
def add_graph_building_optimization_tests(cls=...): # -> (cls: Unknown) -> Unknown:
...
def disable_eager_op_as_function(unused_msg): # -> (func: Unknown) -> (Unknown | ((func: Unknown) -> Unknown)):
...
def set_xla_env_flag(func=..., flag=...): # -> ((*args: Unknown, **kwargs: Unknown) -> Unknown) | ((f: Unknown) -> ((*args: Unknown, **kwargs: Unknown) -> Unknown)):
...
def build_as_function_and_v1_graph(func=...): # -> type | _ParameterizedTestIter | ((f: Unknown) -> (type | _ParameterizedTestIter)):
...
def run_in_async_and_sync_mode(f): # -> type | _ParameterizedTestIter:
  """Execute the test in async mode and sync mode."""
  ...

def run_in_graph_and_eager_modes(func=..., config=..., use_gpu=..., assert_no_eager_garbage=...): # -> (f: Unknown) -> Unknown:
...
def also_run_as_tf_function(f): # -> (*args: Unknown, **kwds: Unknown) -> None:
...
def deprecated_graph_mode_only(func=...): # -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown) | ((f: Unknown) -> (Unknown | ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown))):
...
def run_v1_only(reason, func=...): # -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown) | ((f: Unknown) -> (Unknown | ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown))):
...
def run_v2_only(func=...): # -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown) | ((f: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown)):
...
def run_gpu_only(func=...): # -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown) | ((f: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown)):
...
def run_cuda_only(func=...): # -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown) | ((f: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown)):
  """Execute the decorated test only if a GPU is available.
...
def run_gpu_or_tpu(func=...): # -> ((f: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> (Unknown | None))) | ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> (Unknown | None)):
...
def with_forward_compatibility_horizons(*horizons): # -> (f: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> None):
...
def is_gpu_available(cuda_only=..., min_cuda_compute_capability=...): # -> bool:
...
class ErrorLoggingSession(session.Session):
  ...
  def run(self, *args, **kwargs): # -> tuple[Unknown, ...] | Any | defaultdict[Unknown, Unknown] | list[Unknown] | None:
    ...
  


def disable_cudnn_autotune(func): # -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown) | ((f: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown)):
...
def enable_tf_xla_constant_folding(description): # -> (func: Unknown) -> (((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown) | ((f: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown))):
  ...

def disable_xla(description): # -> (func: Unknown) -> (Unknown | ((func: Unknown) -> Unknown)):
  """Execute the test method only if xla is not enabled."""
  ...

def disable_mlir_bridge(description): # -> (func: Unknown) -> (Unknown | ((func: Unknown) -> Unknown)):
  """Execute the test method only if MLIR bridge is not enabled."""
  ...

def disable_asan(description): # -> (func: Unknown) -> (Unknown | ((func: Unknown) -> Unknown)):
  """Execute the test method only if ASAN is not enabled."""
  ...

def disable_msan(description): # -> (func: Unknown) -> (Unknown | ((func: Unknown) -> Unknown)):
  """Execute the test method only if MSAN is not enabled."""
  ...

def disable_tsan(description): # -> (func: Unknown) -> (Unknown | ((func: Unknown) -> Unknown)):
  """Execute the test method only if TSAN is not enabled."""
  ...

def disable_ubsan(description): # -> (func: Unknown) -> (Unknown | ((func: Unknown) -> Unknown)):
  """Execute the test method only if UBSAN is not enabled."""
  ...

def disable_tfrt(unused_description): # -> (cls_or_func: Unknown) -> (Unknown | ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> (Unknown | None)) | ((func: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> (Unknown | None))) | None):
  ...
...
def no_xla_auto_jit(description): # -> (func: Unknown) -> (Unknown | ((func: Unknown) -> Unknown)):
  """This test is not intended to be run with XLA auto jit enabled."""
  ...

def xla_allow_fallback(description): # -> (func: Unknown) -> (((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown) | ((func: Unknown) -> ((self: Unknown, *args: Unknown, **kwargs: Unknown) -> Unknown))):
  ...
...
def matmul_without_tf32(a, b, *args, **kwargs): # -> SparseTensor | IndexedSlices | Tensor | Any:
...
class TensorFlowTestCase(googletest.TestCase):
  ...
  @contextlib.contextmanager
  def captureWritesToStream(self, stream): # -> Generator[CapturedWrites, None, None]:
  ...
  def evaluate(self, tensors): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | None:
  ...
  @contextlib.contextmanager
  def session(self, graph=..., config=..., use_gpu=..., force_gpu=...): # -> Generator[EagerSessionWarner | Unknown, None, None]:
  ...
  @contextlib.contextmanager
  def cached_session(self, graph=..., config=..., use_gpu=..., force_gpu=...): # -> Generator[FakeEagerSession | Unknown | None, None, None]:
  ...
  def test_session(self, graph=..., config=..., use_gpu=..., force_gpu=...): # -> Generator[Unknown | EagerSessionWarner | None, None, None]:
  ...
  class _CheckedThread:
    ...
    method.
    """
    def __init__(self, testcase, target, args=..., kwargs=...) -> None:
  ...
  def checkedThread(self, target, args=..., kwargs=...): # -> _CheckedThread:
  ...
  def evaluate_if_both_tensors(self, a, b): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | tuple[Unknown | _EagerTensorBase, Unknown | _EagerTensorBase] | None:
    ...
  ...
  @contextlib.contextmanager
  def assertRaisesWithPredicateMatch(self, exception_type, expected_err_re_or_predicate): # -> Generator[None, None, None]:
  ...
  def assertRaisesOpError(self, expected_err_re_or_predicate): # -> _GeneratorContextManager[None]:
    ...
  
  def assertRaisesIncompatibleShapesError(self, exception_type=...): # -> _GeneratorContextManager[None]:
    ...
...
def create_local_cluster(num_workers, num_ps, protocol=..., worker_config=..., ps_config=...): # -> tuple[list[Server], list[Server]]:
...
def get_node_def_from_graph(node_name, graph_def): # -> None:
...
class AbstractGradientTape:
  ...
  def __enter__(self): # -> GradientTape | FakeGradientTape:
    ...
