...
class Module(autotrackable.AutoTrackable):
  ...
  @property
  def name_scope(self): # -> name_scope_v2 | internal_name_scope_v1 | NullContextmanager:
    """Returns a `tf.name_scope` instance for this class."""
    ...
  
  @property
  def variables(self): # -> tuple[tuple[Unknown, None] | Unknown | None, ...]:
  ...
  @property
  def trainable_variables(self): # -> tuple[tuple[Unknown, None] | Unknown | None, ...]:
  ...
  @property
  def non_trainable_variables(self): # -> tuple[tuple[Unknown, None] | Unknown | None, ...]:
  ...
  @property
  def submodules(self): # -> tuple[tuple[Unknown, None] | Unknown | None, ...]:
