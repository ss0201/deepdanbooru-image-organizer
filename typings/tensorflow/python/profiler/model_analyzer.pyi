...
class Profiler:
  ...
  def profile_python(self, options): # -> MultiGraphNodeProto:
  ...
  def profile_operations(self, options): # -> MultiGraphNodeProto:
  ...
  def profile_name_scope(self, options): # -> GraphNodeProto:
  ...
  def profile_graph(self, options): # -> GraphNodeProto:
  ...
  def advise(self, options): # -> AdviceProto:
...
def profile(graph=..., run_meta=..., op_log=..., cmd=..., options=...): # -> MultiGraphNodeProto | GraphNodeProto:
  """Profile model.
...
def advise(graph=..., run_meta=..., options=...): # -> AdviceProto:
