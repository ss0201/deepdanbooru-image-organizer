...
class ProfileOptionBuilder:
  ...
  @staticmethod
  def trainable_variables_parameter(): # -> dict[str, Unknown]:
  ...
  @staticmethod
  def float_operation(): # -> dict[str, Unknown]:
  ...
  @staticmethod
  def time_and_memory(min_micros=..., min_bytes=..., min_accelerator_micros=..., min_cpu_micros=..., min_peak_bytes=..., min_residual_bytes=..., min_output_bytes=...): # -> dict[str, Unknown]:
  ...
  def build(self): # -> dict[str, Unknown]:
  ...
  def with_max_depth(self, max_depth): # -> Self@ProfileOptionBuilder:
  ...
  def with_min_memory(self, min_bytes=..., min_peak_bytes=..., min_residual_bytes=..., min_output_bytes=...): # -> Self@ProfileOptionBuilder:
  ...
  def with_min_execution_time(self, min_micros=..., min_accelerator_micros=..., min_cpu_micros=...): # -> Self@ProfileOptionBuilder:
  ...
  def with_min_parameters(self, min_params): # -> Self@ProfileOptionBuilder:
  ...
  def with_min_occurrence(self, min_occurrence): # -> Self@ProfileOptionBuilder:
  ...
  def with_min_float_operations(self, min_float_ops): # -> Self@ProfileOptionBuilder:
  ...
  def with_accounted_types(self, account_type_regexes): # -> Self@ProfileOptionBuilder:
  ...
  def with_node_names(self, start_name_regexes=..., show_name_regexes=..., hide_name_regexes=..., trim_name_regexes=...): # -> Self@ProfileOptionBuilder:
  ...
  def account_displayed_op_only(self, is_true): # -> Self@ProfileOptionBuilder:
  ...
  def with_empty_output(self): # -> Self@ProfileOptionBuilder:
    """Do not generate side-effect outputs."""
    ...
  
  def with_stdout_output(self): # -> Self@ProfileOptionBuilder:
    """Print the result to stdout."""
    ...
  
  def with_file_output(self, outfile): # -> Self@ProfileOptionBuilder:
    """Print the result to a file."""
    ...
  
  def with_timeline_output(self, timeline_file): # -> Self@ProfileOptionBuilder:
    """Generate a timeline json file."""
    ...
  
  def with_pprof_output(self, pprof_file): # -> Self@ProfileOptionBuilder:
  ...
  def order_by(self, attribute): # -> Self@ProfileOptionBuilder:
  ...
  def select(self, attributes): # -> Self@ProfileOptionBuilder:
  ...
  def with_step(self, step): # -> Self@ProfileOptionBuilder:
