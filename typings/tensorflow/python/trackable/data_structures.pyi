...
def wrap_or_unwrap(value): # -> Unknown | Trackable | _DictWrapper | ListWrapper | _TupleWrapper | tuple[Unknown, ...]:
...
def sticky_attribute_assignment(trackable, name, value): # -> Unknown | Trackable | _DictWrapper | ListWrapper | _TupleWrapper | tuple[Unknown, ...]:
...
class List(TrackableDataStructure, collections_abc.Sequence):
  ...
  def __copy__(self): # -> Self@List:
    ...
  
  def __deepcopy__(self, memo): # -> Self@List:
    ...
  ...
  def __iadd__(self, values): # -> Self@List:
    ...
  
  def __add__(self, other):
    ...
  
  def __imul__(self, y): # -> Self@List:
    ...
...
class ListWrapper(List, collections_abc.MutableSequence, list):
  ...
  def __copy__(self): # -> ListWrapper:
    ...
  
  def __deepcopy__(self, memo): # -> ListWrapper:
    ...
  
  def __reduce_ex__(self, protocol): # -> tuple[Type[Self@ListWrapper], tuple[list[Unknown]]]:
    ...
  ...
  def __imul__(self, y): # -> Self@ListWrapper | ListWrapper:
    ...
...
class Mapping(TrackableDataStructure, collections_abc.Mapping):
  ...
  def __copy__(self): # -> Self@Mapping:
    ...
  
  def __deepcopy__(self, memo): # -> Self@Mapping:
    ...
...
class _DictWrapper(TrackableDataStructure, wrapt.ObjectProxy):
  ...
  def __reduce_ex__(self, protocol): # -> tuple[Type[Self@_DictWrapper], tuple[Unknown]]:
    ...
  
  def __getattribute__(self, name): # -> Any:
    ...
  
  def copy(self): # -> Self@_DictWrapper:
    ...
...
class _TupleWrapper(TrackableDataStructure, wrapt.ObjectProxy):
  ...
  def __reduce_ex__(self, protocol): # -> tuple[Type[Self@_TupleWrapper], tuple[Unknown]]:
    ...
