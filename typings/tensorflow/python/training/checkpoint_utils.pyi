...
def list_variables(ckpt_dir_or_file): # -> list[Unknown]:
...
def checkpoints_iterator(checkpoint_dir, min_interval_secs=..., timeout=..., timeout_fn=...): # -> Generator[Unknown, None, None]:
