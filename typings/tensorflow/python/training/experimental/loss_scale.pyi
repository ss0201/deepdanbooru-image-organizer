...
class LossScale(trackable.Trackable):
  ...
  @classmethod
  def from_config(cls, config): # -> Self@LossScale:
...
class FixedLossScale(LossScale):
  ...
  def update(self, grads): # -> tuple[Unknown | _dispatcher_for_no_op | object | None, Literal[True]]:
    ...
...
class DynamicLossScale(LossScale):
  ...
  def update(self, grads): # -> tuple[Any | Unknown | list[Unknown] | _basetuple | defaultdict[Unknown, Unknown] | ObjectProxy, Unknown]:
