...
def is_mixed_precision_graph_rewrite_enabled(): # -> Literal[False]:
  ...

def set_mixed_precision_graph_rewrite_enabled(enabled): # -> None:
  ...

def non_mixed_precision_session_created(): # -> Literal[False]:
  ...

def set_non_mixed_precision_session_created(created): # -> None:
  ...

def is_using_mixed_precision_policy(): # -> Literal[False]:
  ...
