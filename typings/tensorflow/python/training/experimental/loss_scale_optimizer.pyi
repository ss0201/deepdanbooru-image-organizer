...
class MixedPrecisionLossScaleOptimizer(optimizer.Optimizer):
  ...
  def compute_gradients(self, loss, var_list=..., gate_gradients=..., aggregation_method=..., colocate_gradients_with_ops=..., grad_loss=...): # -> list[tuple[IndexedSlices | Unknown | None, Any | None]]:
