...
class Scaffold:
  ...
  * `init_fn`: A callable to run after the init op to perform additional
  ...
  def finalize(self): # -> Self@Scaffold:
    """Creates operations if needed and finalizes the graph."""
    ...
  
  @property
  def init_fn(self): # -> ((sess: Unknown) -> Unknown) | None:
    ...
  
  @property
  def init_op(self): # -> _dispatcher_for_no_op | object | None:
    ...
  
  @property
  def ready_op(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | None:
    ...
  
  @property
  def ready_for_local_init_op(self): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy | None:
    ...
  
  @property
  def local_init_op(self): # -> _dispatcher_for_no_op | object | None:
    ...
  ...
  @staticmethod
  def default_local_init_op(): # -> _dispatcher_for_no_op | object | None:
...
class _MonitoredSession:
  ...
  def __enter__(self): # -> Self@_MonitoredSession:
    ...
