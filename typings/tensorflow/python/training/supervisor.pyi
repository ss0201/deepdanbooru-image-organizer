...
class Supervisor:
  ...
  * Specifying `'grpc://hostname:port'` requests a session that uses
  ...
  @property
  def init_op(self): # -> _dispatcher_for_no_op | object | int | None:
  ...
  @property
  def ready_for_local_init_op(self): # -> int | None:
    ...
  ...
  @property
  def global_step(self): # -> Tensor | Operation | int | None:
  ...
  def start_standard_services(self, sess): # -> list[Unknown] | None:
  ...
  def prepare_or_wait_for_session(self, master=..., config=..., wait_for_checkpoint=..., max_wait_secs=..., start_standard_services=...): # -> Session:
  ...
  def start_queue_runners(self, sess, queue_runners=...): # -> list[Unknown]:
  ...
  def stop_on_exception(self): # -> _GeneratorContextManager[None]:
  ...
  def managed_session(self, master=..., config=..., start_standard_services=..., close_summary_writer=...): # -> Generator[Session | Unknown, None, None]:
