...
def weighted_moving_average(value, decay, weight, truediv=..., collections=..., name=...): # -> _dispatcher_for_real_div | object:
...
class ExponentialMovingAverage:
  ...
  def apply(self, var_list=...): # -> _dispatcher_for_no_op | object | None:
  ...
  @doc_controls.do_not_generate_docs
  def variables_to_restore(self, moving_avg_variables=...): # -> dict[Unknown, Unknown]:
