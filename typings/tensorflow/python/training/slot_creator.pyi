...
```
"""
def create_slot(primary, val, name, colocate_with_primary=..., *, copy_xla_sharding=...): # -> _dispatcher_for_xla_sharding | object:
...
def create_slot_with_initializer(primary, initializer, shape, dtype, name, colocate_with_primary=..., *, copy_xla_sharding=...): # -> _dispatcher_for_xla_sharding | object:
...
def create_zeros_slot(primary, name, dtype=..., colocate_with_primary=..., *, copy_xla_sharding=...): # -> _dispatcher_for_xla_sharding | object:
