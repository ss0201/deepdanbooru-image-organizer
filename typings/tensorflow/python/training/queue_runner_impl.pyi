...
class QueueRunner:
  ...
  @property
  def queue(self): # -> Tensor | Operation | None:
    ...
  
  @property
  def enqueue_ops(self): # -> list[Unknown | Tensor | Operation | None]:
    ...
  ...
  @property
  def queue_closed_exception_types(self): # -> tuple[Unknown, ...] | tuple[Type[OutOfRangeError]] | None:
    ...
  
  @property
  def exceptions_raised(self): # -> list[Unknown]:
  ...
  def create_threads(self, sess, coord=..., daemon=..., start=...): # -> list[Unknown]:
  ...
  def to_proto(self, export_scope=...): # -> QueueRunnerDef | None:
...
@deprecation.deprecated(None, _DEPRECATION_INSTRUCTION)
def start_queue_runners(sess=..., coord=..., daemon=..., start=..., collection=...): # -> list[Unknown]:
