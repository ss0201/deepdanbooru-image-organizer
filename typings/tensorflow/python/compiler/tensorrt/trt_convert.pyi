...
class TrtConversionParams(collections.namedtuple("TrtConversionParams", ["max_workspace_size_bytes", "precision_mode", "minimum_segment_size", "maximum_cached_engines", "use_calibration", "allow_build_at_runtime"])):
  ...
  """
  def __new__(cls, max_workspace_size_bytes=..., precision_mode=..., minimum_segment_size=..., maximum_cached_engines=..., use_calibration=..., allow_build_at_runtime=...): # -> Self@TrtConversionParams:
    ...
...
def get_tensorrt_rewriter_config(conversion_params, is_dynamic_op=..., max_batch_size=..., is_v2=..., disable_non_trt_optimizers=...): # -> RewriterConfig:
  ...
...
class TrtGraphConverter:
  ...
  def calibrate(self, fetch_names, num_runs, feed_dict_fn=..., input_map_fn=...):
...
def create_inference_graph(input_graph_def, outputs, max_batch_size=..., max_workspace_size_bytes=..., precision_mode=..., minimum_segment_size=..., is_dynamic_op=..., maximum_cached_engines=..., input_saved_model_dir=..., input_saved_model_tags=..., input_saved_model_signature_key=..., output_saved_model_dir=...):
