...
def convert_variables_to_tensors(values): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def replace_variables_with_atoms(values): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
