...
def is_namedtuple(instance, strict=...):
...
def flatten(structure, expand_composites=...): # -> list[None]:
...
def pack_sequence_as(structure, flat_sequence, expand_composites=...): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def map_structure(func, *structure, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def map_structure_with_paths(func, *structure, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def map_structure_with_tuple_paths(func, *structure, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  """Applies `func` to each entry in `structure` and returns a new structure.
...
def assert_shallow_structure(shallow_tree, input_tree, check_types=..., expand_composites=...):
...
def flatten_up_to(shallow_tree, input_tree, check_types=..., expand_composites=...): # -> list[Unknown]:
...
def flatten_with_tuple_paths_up_to(shallow_tree, input_tree, check_types=..., expand_composites=...): # -> list[tuple[tuple[()], Unknown] | tuple[Unknown, Unknown]]:
  """Flattens `input_tree` up to `shallow_tree`.
...
def map_structure_up_to(shallow_tree, func, *inputs, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def map_structure_with_tuple_paths_up_to(shallow_tree, func, *inputs, **kwargs): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
  """Applies a function or op to a number of partially flattened inputs.
...
def get_traverse_shallow_structure(traverse_fn, structure, expand_composites=...): # -> bool | defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
...
def yield_flat_paths(nest, expand_composites=...): # -> Generator[tuple[()] | Unknown, None, None]:
...
def flatten_with_joined_string_paths(structure, separator=..., expand_composites=...): # -> list[tuple[str, None]]:
...
def flatten_with_tuple_paths(structure, expand_composites=...): # -> list[tuple[tuple[()] | Unknown, None]]:
...
def list_to_tuple(structure): # -> defaultdict[Unknown, Unknown] | Any | list[Unknown] | ObjectProxy:
