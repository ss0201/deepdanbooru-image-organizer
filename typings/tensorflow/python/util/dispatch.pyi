...
def dispatch_for_types(op, *types): # -> (func: Unknown) -> Unknown:
...
def dispatch_for_api(api, *signatures): # -> (dispatch_target: Unknown) -> (Unknown | ((*args: Unknown, **kwargs: Unknown) -> Unknown)):
...
def apis_with_type_based_dispatch(): # -> list[Unknown]:
  """Returns a list of TensorFlow APIs that support type-based dispatch."""
  ...

def type_based_dispatch_signatures_for(cls): # -> dict[Unknown, Unknown]:
...
def dispatch_for_unary_elementwise_apis(x_type): # -> (handler: Unknown) -> Unknown:
...
def dispatch_for_binary_elementwise_apis(x_type, y_type): # -> (handler: Unknown) -> Unknown:
...
def dispatch_for_binary_elementwise_assert_apis(x_type, y_type): # -> (handler: Unknown) -> Unknown:
...
def unary_elementwise_apis(): # -> tuple[Unknown, ...]:
  """Returns a list of APIs that have been registered as unary elementwise."""
  ...

def binary_elementwise_apis(): # -> tuple[Unknown, ...]:
...
def add_dispatch_support(target=..., iterable_parameters=...): # -> ((dispatch_target: Unknown) -> ((*args: Unknown, **kwargs: Unknown) -> (Any | Unknown | object))) | ((*args: Unknown, **kwargs: Unknown) -> (Any | Unknown | object)):
...
def replace_iterable_params(args, kwargs, iterable_params): # -> tuple[tuple[Unknown, ...], Unknown]:
