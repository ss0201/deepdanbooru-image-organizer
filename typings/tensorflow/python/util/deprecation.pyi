...
def deprecated_endpoints(*args): # -> (func: Unknown) -> Unknown:
...
def deprecated(date, instructions, warn_once=...): # -> (func_or_class: Unknown) -> (((*args: Unknown, **kwargs: Unknown) -> (type | Unknown | None)) | type):
...
DeprecatedArgSpec = ...
def deprecated_args(date, instructions, *deprecated_arg_names_or_tuples, **kwargs): # -> (func: Unknown) -> Unknown:
...
def deprecated_arg_values(date, instructions, warn_once=..., **deprecated_kwargs): # -> (func: Unknown) -> Unknown:
...
def deprecate_moved_module(deprecated_name, new_module, deletion_version): # -> (name: Unknown) -> Any:
