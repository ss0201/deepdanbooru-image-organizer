...
from tensorflow.python.checkpoint import checkpoint as util, checkpoint_options, functional_saver, restore as restore_lib
...
"""DTensor Checkpoint."""
class _DSaver(functional_saver._SingleDeviceSaver):
...
class _DCheckpointRestoreCoordinator(util._CheckpointRestoreCoordinator):
  ...
  def restore_saveables(self, tensor_saveables: Dict[str, saveable_object.SaveableObject], python_positions: List[restore_lib.CheckpointPosition], registered_savers: Optional[Dict[str, Dict[str, base.Trackable]]] = ...) -> Optional[List[ops.Operation]]:
