...
class Sharding:
  ...
  def apply_to_tensor(self, tensor, assign_tuple_sharding=..., use_sharding_op=..., unspecified_dims=...): # -> _dispatcher_for_xla_sharding | object:
...
def copy_sharding(from_tensor, to_tensor, use_sharding_op=...): # -> _dispatcher_for_xla_sharding | object:
...
def replicate(tensor, assign_tuple_sharding=..., use_sharding_op=...): # -> _dispatcher_for_xla_sharding | object:
  ...

def assign_device(tensor, device, assign_tuple_sharding=..., use_sharding_op=...): # -> _dispatcher_for_xla_sharding | object:
  """Returns a tensor that has AssignDevice sharding attribute."""
  ...

def tile(tensor, tile_assignment, assign_tuple_sharding=..., use_sharding_op=..., unspecified_dims=...): # -> _dispatcher_for_xla_sharding | object:
...
def split(tensor, split_dimension, num_devices, assign_tuple_sharding=..., use_sharding_op=..., input_shape=...): # -> _dispatcher_for_xla_sharding | object:
...
def partial_tile(tensor, tile_assignment, use_sharding_op=..., unspecified_dims=...): # -> _dispatcher_for_xla_sharding | object:
  """Returns a tensor that has tiled sharding.
...
def get_tensor_sharding(tensor): # -> None:
...
def auto_to_manual_spmd_partition(tensor, manual_sharding, single_dim=..., unspecified_dims=...): # -> _dispatcher_for_xla_spmd_full_to_shard_shape | object:
...
def manual_to_auto_spmd_partition(tensor, manual_sharding, full_shape, single_dim=..., unspecified_dims=...): # -> _dispatcher_for_xla_spmd_shard_to_full_shape | object:
...
def mesh_split(tensor, device_mesh, tensor_split_dims_mapping, use_sharding_op=..., manual_mesh_dims=..., unspecified_dims=...): # -> _dispatcher_for_xla_sharding | object:
