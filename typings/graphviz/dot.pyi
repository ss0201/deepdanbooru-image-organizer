...
class Dot(quoting.Quote, base.Base):
    ...
    @_tools.deprecate_positional_args(supported_number=2)
    def subgraph(self, graph=..., name: typing.Optional[str] = ..., comment: typing.Optional[str] = ..., graph_attr=..., node_attr=..., edge_attr=..., body=...): # -> _GeneratorContextManager[Self@Dot] | None:
