...
def mapping_items(mapping): # -> Iterator[Unknown]:
...
def deprecate_positional_args(*, supported_number: int, category: typing.Type[Warning] = ..., stacklevel: int = ...): # -> (func: Unknown) -> Unknown:
