...
class _BaseRidge(LinearModel, metaclass=ABCMeta):
    @abstractmethod
    def __init__(self, alpha=..., *, fit_intercept=..., normalize=..., copy_X=..., max_iter=..., tol=..., solver=..., positive=..., random_state=...) -> None:
        ...
    
    def fit(self, X, y, sample_weight=...): # -> Self@_BaseRidge:
        ...
...
class Ridge(MultiOutputMixin, RegressorMixin, _BaseRidge):
    ...
    def fit(self, X, y, sample_weight=...): # -> Ridge:
...
class _RidgeClassifierMixin(LinearClassifierMixin):
    def predict(self, X): # -> csr_matrix | Any | ndarray[Unknown, Unknown]:
    ...
    @property
    def classes_(self): # -> ndarray[Unknown, Unknown]:
        """Classes labels."""
        ...
...
class RidgeClassifier(_RidgeClassifierMixin, _BaseRidge):
    ...
    0.9595...
    """
    def __init__(self, alpha=..., *, fit_intercept=..., normalize=..., copy_X=..., max_iter=..., tol=..., class_weight=..., solver=..., positive=..., random_state=...) -> None:
        ...
    
    def fit(self, X, y, sample_weight=...): # -> Self@RidgeClassifier:
...
class _BaseRidgeCV(LinearModel):
    ...
    def fit(self, X, y, sample_weight=...): # -> Self@_BaseRidgeCV:
...
class RidgeClassifierCV(_RidgeClassifierMixin, _BaseRidgeCV):
    ...
    def fit(self, X, y, sample_weight=...): # -> Self@RidgeClassifierCV:
