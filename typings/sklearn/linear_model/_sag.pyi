...
def sag_solver(X, y, sample_weight=..., loss=..., alpha=..., beta=..., max_iter=..., tol=..., verbose=..., random_state=..., check_input=..., max_squared_sum=..., warm_start_mem=..., is_saga=...): # -> tuple[ndarray[Unknown, Unknown] | Unknown | Any, Unknown, dict[str, Unknown]]:
