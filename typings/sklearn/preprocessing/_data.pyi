...
from ..base import BaseEstimator, TransformerMixin, _ClassNamePrefixFeaturesOutMixin, _OneToOneFeatureMixin
...
def scale(X, *, axis=..., with_mean=..., with_std=..., copy=...): # -> Any | ndarray[Unknown, Unknown]:
...
class MinMaxScaler(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=...): # -> Self@MinMaxScaler:
    ...
    def partial_fit(self, X, y=...): # -> Self@MinMaxScaler:
...
class StandardScaler(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=..., sample_weight=...): # -> Self@StandardScaler:
    ...
    def partial_fit(self, X, y=..., sample_weight=...): # -> Self@StandardScaler:
    ...
    def transform(self, X, copy=...): # -> tuple[Unknown | Any, Unknown | Any]:
...
class MaxAbsScaler(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=...): # -> Self@MaxAbsScaler:
    ...
    def partial_fit(self, X, y=...): # -> Self@MaxAbsScaler:
    ...
    def transform(self, X): # -> tuple[Unknown | Any, Unknown | Any]:
        """Scale the data.
...
class RobustScaler(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=...): # -> Self@RobustScaler:
...
def normalize(X, norm=..., *, axis=..., copy=..., return_norm=...): # -> tuple[Any | Unknown, Unbound | Any | float | Unknown | ndarray[Unknown, Unknown] | None] | Any:
...
class Normalizer(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=...): # -> Self@Normalizer:
    ...
    def transform(self, X, copy=...): # -> tuple[Any | Unknown, Unbound | Any | float | Unknown | ndarray[Unknown, Unknown] | None] | Any:
...
def binarize(X, *, threshold=..., copy=...): # -> Any:
...
class Binarizer(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=...): # -> Self@Binarizer:
        """Do nothing and return the estimator unchanged.
...
class KernelCenterer(_ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, K, y=...): # -> Self@KernelCenterer:
        """Fit KernelCenterer.
...
def add_dummy_feature(X, value=...): # -> coo_matrix | csc_matrix | Any | ndarray[Unknown, Unknown]:
...
class QuantileTransformer(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=...): # -> Self@QuantileTransformer:
    ...
    def inverse_transform(self, X): # -> tuple[Unknown | Any, Unknown | Any]:
...
class PowerTransformer(_OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=...): # -> Self@PowerTransformer:
    ...
    def fit_transform(self, X, y=...): # -> tuple[Unknown | Any, Unknown | Any]:
    ...
    def inverse_transform(self, X): # -> Any | tuple[Unknown | Any, Unknown | Any]:
...
def power_transform(X, method=..., *, standardize=..., copy=...): # -> tuple[Unknown | Any, Unknown | Any]:
