...
"""
def c_step(X, n_support, remaining_iterations=..., initial_estimates=..., verbose=..., cov_computation_method=..., random_state=...): # -> tuple[Unknown, ndarray[Unknown, Unknown] | Unknown, float | Unknown, ndarray[Unknown, Unknown], Unknown] | tuple[Unbound | Unknown, Unbound | ndarray[Unknown, Unknown] | Unknown, float | Unknown, Unbound | ndarray[Unknown, Unknown], float | Unknown]:
...
def select_candidates(X, n_support, n_trials, select=..., n_iter=..., verbose=..., cov_computation_method=..., random_state=...): # -> tuple[Any, Any, Any, Any]:
...
def fast_mcd(X, support_fraction=..., cov_computation_method=..., random_state=...): # -> tuple[Any | ndarray[Unknown, Unknown] | Unbound, Any | ndarray[Unknown, Unknown] | Unbound, ndarray[Unknown, Unknown] | Any | Unbound, ndarray[Unknown, Unknown] | Any | Unknown | Unbound]:
...
class MinCovDet(EmpiricalCovariance):
    ...
    def fit(self, X, y=...): # -> Self@MinCovDet:
    ...
    def reweight_covariance(self, data): # -> tuple[ndarray[Unknown, Unknown] | Unknown, ndarray[Unknown, Unknown] | Unknown, ndarray[Unknown, Unknown]]:
