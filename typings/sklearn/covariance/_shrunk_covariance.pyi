...
"""
def shrunk_covariance(emp_cov, shrinkage=...): # -> Any:
...
class ShrunkCovariance(EmpiricalCovariance):
    ...
    def fit(self, X, y=...): # -> Self@ShrunkCovariance:
...
def ledoit_wolf_shrinkage(X, assume_centered=..., block_size=...): # -> float | Any | Literal[0]:
...
def ledoit_wolf(X, *, assume_centered=..., block_size=...): # -> tuple[ndarray[Unknown, Unknown], float] | tuple[NDArray[floating[Any]] | Unknown | Any, float | Any | Literal[0]]:
    """Estimate the shrunk Ledoit-Wolf covariance matrix.
...
class LedoitWolf(EmpiricalCovariance):
    ...
    def fit(self, X, y=...): # -> Self@LedoitWolf:
...
def oas(X, *, assume_centered=...): # -> tuple[ndarray[Unknown, Unknown], float] | tuple[NDArray[floating[Any]] | Unknown | Any, float | Any]:
