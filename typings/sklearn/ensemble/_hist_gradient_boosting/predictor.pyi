...
class TreePredictor:
    ...
    def predict(self, X, known_cat_bitsets, f_idx_map, n_threads): # -> ndarray[Unknown, Unknown]:
    ...
    def predict_binned(self, X, missing_values_bin_idx, n_threads): # -> ndarray[Unknown, Unknown]:
