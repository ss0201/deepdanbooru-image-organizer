...
class TreeGrower:
    ...
    n_threads : int, default=None
        ...
        for details.
    """
    def __init__(self, X_binned, gradients, hessians, max_leaf_nodes=..., max_depth=..., min_samples_leaf=..., min_gain_to_split=..., n_bins=..., n_bins_non_missing=..., has_missing_values=..., is_categorical=..., monotonic_cst=..., l2_regularization=..., min_hessian_to_split=..., shrinkage=..., n_threads=...) -> None:
        ...
