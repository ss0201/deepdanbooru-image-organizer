...
class LossFunction(metaclass=ABCMeta):
    ...
    @abstractmethod
    def negative_gradient(self, y, raw_predictions, **kargs): # -> None:
    ...
    def update_terminal_regions(self, tree, X, y, residual, raw_predictions, sample_weight, sample_mask, learning_rate=..., k=...): # -> None:
    ...
    @abstractmethod
    def get_init_raw_predictions(self, X, estimator): # -> None:
...
class LeastSquaresError(RegressionLossFunction):
    ...
    def __call__(self, y, raw_predictions, sample_weight=...): # -> Any:
...
class HuberLossFunction(RegressionLossFunction):
    ...
    def negative_gradient(self, y, raw_predictions, sample_weight=..., **kargs): # -> ndarray[Unknown, Unknown]:
        """Compute the negative gradient.
...
class BinomialDeviance(ClassificationLossFunction):
    ...
    def get_init_raw_predictions(self, X, estimator): # -> Any:
        ...
