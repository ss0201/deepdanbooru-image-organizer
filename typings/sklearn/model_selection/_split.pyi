...
class BaseCrossValidator(metaclass=ABCMeta):
    ...
    """
    def split(self, X, y=..., groups=...): # -> Generator[tuple[Unknown, Unknown], None, None]:
...
def train_test_split(*arrays, test_size=..., train_size=..., random_state=..., shuffle=..., stratify=...): # -> list[Unknown | list[Unknown]]:
