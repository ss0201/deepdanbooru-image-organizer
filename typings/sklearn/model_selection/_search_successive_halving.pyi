...
class _SubsampleMetaSplitter:
    ...
    def split(self, X, y, groups=...): # -> Generator[tuple[Unknown | list[Unknown] | list[Unknown | list[Unknown]] | None, Unknown | list[Unknown] | list[Unknown | list[Unknown]] | None], None, None]:
        ...
...
class BaseSuccessiveHalving(BaseSearchCV):
    ...
    def fit(self, X, y=..., groups=..., **fit_params): # -> Self@BaseSuccessiveHalving:
