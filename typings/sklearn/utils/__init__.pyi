...
def axis0_safe_slice(X, mask, len_mask): # -> ndarray[Unknown, Unknown]:
    """
...
def resample(*arrays, replace=..., n_samples=..., random_state=..., stratify=...): # -> list[Unknown] | list[Unknown | list[Unknown]] | None:
...
def shuffle(*arrays, random_state=..., n_samples=...): # -> list[Unknown] | list[Unknown | list[Unknown]] | None:
...
def gen_batches(n, batch_size, *, min_batch_size=...): # -> Generator[slice, None, None]:
...
def gen_even_slices(n, n_packs, *, n_samples=...): # -> Generator[slice, None, None]:
...
def tosequence(x): # -> ndarray[Unknown, Unknown] | Sequence[Unknown] | list[Unknown]:
...
def indices_to_mask(indices, mask_length): # -> ndarray[Unknown, Unknown]:
...
def check_pandas_support(caller_name): # -> Module("pandas"):
...
def all_estimators(type_filter=...): # -> list[Unknown]:
