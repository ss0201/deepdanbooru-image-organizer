...
def min_max_axis(X, axis, ignore_nan=...): # -> tuple[Unknown | Any, Unknown | Any]:
...
def count_nonzero(X, axis=..., sample_weight=...): # -> tuple[Unknown, Unknown | None]:
...
def csc_median_axis_0(X): # -> ndarray[Unknown, Unknown]:
