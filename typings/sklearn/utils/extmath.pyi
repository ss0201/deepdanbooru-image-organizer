...
def density(w, **kwargs): # -> Literal[0]:
...
def randomized_svd(M, n_components, *, n_oversamples=..., n_iter=..., power_iteration_normalizer=..., transpose=..., flip_sign=..., random_state=...): # -> tuple[Unknown, Unknown, Unknown]:
...
def weighted_mode(a, w, *, axis=...): # -> tuple[Unbound | Unknown, ndarray[Unknown, Unknown] | NDArray[Any]]:
...
def svd_flip(u, v, u_based_decision=...): # -> tuple[Unknown, Unknown]:
...
def stable_cumsum(arr, axis=..., rtol=..., atol=...): # -> ndarray[Unknown, Unknown]:
