...
def strip_newsgroup_footer(text): # -> LiteralString:
    """
...
def fetch_20newsgroups(*, data_home=..., subset=..., categories=..., shuffle=..., random_state=..., remove=..., download_if_missing=..., return_X_y=...): # -> tuple[Any | list[str] | list[str | Unknown | Any] | list[Unknown | Any] | Unknown | list[Unknown], Any | Unknown | intp | ndarray[Unknown, Unknown]] | Bunch | Any:
...
def fetch_20newsgroups_vectorized(*, subset=..., remove=..., data_home=..., download_if_missing=..., return_X_y=..., normalize=..., as_frame=...): # -> tuple[DataFrame | Any | Unknown | Self@_data_matrix | csr_matrix, Series[Unknown] | DataFrame | Unknown | Any] | Bunch:
