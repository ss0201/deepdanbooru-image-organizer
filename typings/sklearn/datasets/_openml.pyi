...
def fetch_openml(name: Optional[str] = ..., *, version: Union[str, int] = ..., data_id: Optional[int] = ..., data_home: Optional[str] = ..., target_column: Optional[Union[str, List]] = ..., cache: bool = ..., return_X_y: bool = ..., as_frame: Union[str, bool] = ..., n_retries: int = ..., delay: float = ...): # -> tuple[Unknown, Unknown] | Bunch:
