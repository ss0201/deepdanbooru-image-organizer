...
TARGETS = ...
def fetch_lfw_people(*, data_home=..., funneled=..., resize=..., min_faces_per_person=..., color=..., slice_=..., download_if_missing=..., return_X_y=...): # -> tuple[Unknown | Any, Unknown | Any] | Bunch:
...
def fetch_lfw_pairs(*, subset=..., data_home=..., funneled=..., resize=..., color=..., slice_=..., download_if_missing=...): # -> Bunch:
