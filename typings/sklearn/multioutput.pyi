...
class _MultiOutputEstimator(MetaEstimatorMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def partial_fit(self, X, y, classes=..., sample_weight=...): # -> Self@_MultiOutputEstimator:
    ...
    def fit(self, X, y, sample_weight=..., **fit_params): # -> Self@_MultiOutputEstimator:
...
class MultiOutputClassifier(ClassifierMixin, _MultiOutputEstimator):
    ...
    def fit(self, X, Y, sample_weight=..., **fit_params): # -> Self@MultiOutputClassifier:
...
class _BaseChain(BaseEstimator, metaclass=ABCMeta):
    ...
    @abstractmethod
    def fit(self, X, Y, **fit_params): # -> Self@_BaseChain:
        """Fit the model to data matrix X and targets Y.
...
class ClassifierChain(MetaEstimatorMixin, ClassifierMixin, _BaseChain):
    ...
    """
    def fit(self, X, Y): # -> Self@ClassifierChain:
        """Fit the model to data matrix X and targets Y.
...
class RegressorChain(MetaEstimatorMixin, RegressorMixin, _BaseChain):
    ...
    array([[0., 2.],
           ...
           [2., 0.]])
    """
    def fit(self, X, Y, **fit_params): # -> Self@RegressorChain:
        """Fit the model to data matrix X and targets Y.
