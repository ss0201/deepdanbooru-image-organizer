...
def mean_pinball_loss(y_true, y_pred, *, sample_weight=..., alpha=..., multioutput=...):
...
def mean_squared_error(y_true, y_pred, *, sample_weight=..., multioutput=..., squared=...): # -> Any:
...
def mean_squared_log_error(y_true, y_pred, *, sample_weight=..., multioutput=..., squared=...): # -> Any:
...
def explained_variance_score(y_true, y_pred, *, sample_weight=..., multioutput=..., force_finite=...): # -> ndarray[Unknown, Unknown]:
...
def r2_score(y_true, y_pred, *, sample_weight=..., multioutput=..., force_finite=...): # -> float | ndarray[Unknown, Unknown]:
...
def d2_pinball_score(y_true, y_pred, *, sample_weight=..., alpha=..., multioutput=...): # -> float | ndarray[Unknown, Unknown]:
    """
...
def d2_absolute_error_score(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> float | ndarray[Unknown, Unknown]:
    """
