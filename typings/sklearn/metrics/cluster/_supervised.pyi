...
def contingency_matrix(labels_true, labels_pred, *, eps=..., sparse=..., dtype=...): # -> csr_matrix | ndarray[Unknown, Unknown]:
...
def pair_confusion_matrix(labels_true, labels_pred): # -> ndarray[Unknown, Unknown]:
...
def normalized_mutual_info_score(labels_true, labels_pred, *, average_method=...): # -> float | Any:
