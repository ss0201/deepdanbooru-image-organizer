...
def check_pairwise_arrays(X, Y, *, precomputed=..., dtype=..., accept_sparse=..., force_all_finite=..., copy=...): # -> tuple[Any, Any]:
...
def euclidean_distances(X, Y=..., *, Y_norm_squared=..., squared=..., X_norm_squared=...): # -> ndarray[Unknown, Unknown] | NDArray[Any]:
    """
...
def pairwise_distances_argmin_min(X, Y, *, axis=..., metric=..., metric_kwargs=...): # -> tuple[Unknown, Unknown]:
...
def manhattan_distances(X, Y=..., *, sum_over_features=...): # -> ndarray[Unknown, Unknown] | Any:
...
def paired_manhattan_distances(X, Y): # -> ndarray[Unknown, Unknown] | Any:
...
PAIRED_DISTANCES = ...
def paired_distances(X, Y, *, metric=..., **kwds): # -> ndarray[Unknown, Unknown]:
    """
...
def laplacian_kernel(X, Y=..., gamma=...): # -> Any:
...
def additive_chi2_kernel(X, Y=...): # -> ndarray[Unknown, Unknown]:
...
def chi2_kernel(X, Y=..., gamma=...): # -> NDArray[Any]:
...
def distance_metrics(): # -> dict[str, Unknown]:
...
_VALID_METRICS = ...
_NAN_METRICS = ...
def pairwise_distances_chunked(X, Y=..., *, reduce_func=..., metric=..., n_jobs=..., working_memory=..., **kwds): # -> Generator[Unknown | Any | ndarray[Unknown, Unknown], None, None]:
...
def pairwise_distances(X, Y=..., metric=..., *, n_jobs=..., force_all_finite=..., **kwds): # -> Any | ndarray[Unknown, Unknown]:
...
def kernel_metrics(): # -> dict[str, Unknown]:
...
KERNEL_PARAMS = ...
def pairwise_kernels(X, Y=..., metric=..., *, filter_params=..., n_jobs=..., **kwds): # -> Any | ndarray[Unknown, Unknown]:
