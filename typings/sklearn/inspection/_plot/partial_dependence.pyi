...
def plot_partial_dependence(estimator, X, features, *, feature_names=..., target=..., response_method=..., n_cols=..., grid_resolution=..., percentiles=..., method=..., n_jobs=..., verbose=..., line_kw=..., ice_lines_kw=..., pd_line_kw=..., contour_kw=..., ax=..., kind=..., subsample=..., random_state=..., centered=...):
...
class PartialDependenceDisplay:
    ...
    PartialDependenceDisplay.from_estimator : Plot Partial Dependence.
    """
    def __init__(self, pd_results, *, features, feature_names, target_idx, deciles, pdp_lim=..., kind=..., subsample=..., random_state=...) -> None:
        ...
    
    @classmethod
    def from_estimator(cls, estimator, X, features, *, feature_names=..., target=..., response_method=..., n_cols=..., grid_resolution=..., percentiles=..., method=..., n_jobs=..., verbose=..., line_kw=..., ice_lines_kw=..., pd_line_kw=..., contour_kw=..., ax=..., kind=..., centered=..., subsample=..., random_state=...):
    ...
    def plot(self, *, ax=..., n_cols=..., line_kw=..., ice_lines_kw=..., pd_line_kw=..., contour_kw=..., pdp_lim=..., centered=...):
