...
def load_images(dir: str, verbose: bool) -> list[str]:
    ...
    paths = dd_io.get_image_file_paths_recursive(
        dir, file_pattern)
...
def load_project_and_images(project_dir: str, image_dir: str, verbose: bool) -> tuple[Any, list[str], list[str]]:
